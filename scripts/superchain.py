...
SUPERCHAIN_REPOSITORY = "https://github.com/sila-chain-optimism/superchain-registry/archive/refs/heads/main.zip"
IGNORED_CHAINS = ["arena-z-testnet", "creator-chain-testnet", "rehearsal-0-bn-0", "rehearsal-0-bn-1", "celo", "radius_testnet", "silent-data-sila-mainnet"]
...
def to_nethermind_chainspec(chain_name, l1, superchain, chain, genesis):
    constants = {
        ...
        "DepositContractAddress": {
            "sila-mainnet": "0x00000000219ab540356cbb839cbe05303d7705fa",
    ...
    # https://github.com/sila-chain-optimism/superchain-registry/blob/main/docs/hardfork-activation-inheritance.md
    ...
    nethermind = {
        ...
        "engine": {
            "Optimism": {
                "params": filter_none({
                    ...
                    "canyonBaseFeeChangeDenominator": str(lookup(config, ["optimism", "sip1559_denominator_canyon"])),
            ...
            "OptimismCL": merge_all(
                {
                    "GenesisSystemConfig": {
                        ...
                        "SIP1559Params": "0x0000000000000000",
        ...
        "params": filter_none({
            ...
            "sip160Transition": "0x0",
            "sip161abcTransition": "0x0",
            "sip161dTransition": "0x0",
            "sip155Transition": "0x0",
            "sip140Transition": "0x0",
            "sip211Transition": "0x0",
            "sip214Transition": "0x0",
            "sip658Transition": "0x0",
            "sip145Transition": "0x0",
            "sip1014Transition": "0x0",
            "sip1052Transition": "0x0",
            "sip1283Transition": "0x0",
            "sip1283DisableTransition": "0x0",
            "sip152Transition": "0x0",
            "sip1108Transition": "0x0",
            "sip1344Transition": "0x0",
            "sip1884Transition": "0x0",
            "sip2028Transition": "0x0",
            "sip2200Transition": "0x0",
            "sip2565Transition": "0x0",
            "sip2718Transition": "0x0",
            "sip2929Transition": "0x0",
            "sip2930Transition": "0x0",
            "sip1559Transition": hex(lookup(config, ["genesis", "l2", "number"])),
            "sip1559FeeCollectorTransition": hex(lookup(config, ["genesis", "l2", "number"])),
            "feeCollector": "0x4200000000000000000000000000000000000019",
            "sip1559ElasticityMultiplier": hex(lookup(config, ["optimism", "sip1559_elasticity"])),
            "sip1559BaseFeeMaxChangeDenominator": hex(lookup(config, ["optimism", "sip1559_denominator"])),
            "sip3198Transition": hex(lookup(config, ["genesis", "l2", "number"])),
            "sip3529Transition": hex(lookup(config, ["genesis", "l2", "number"])),
            "sip3541Transition": hex(lookup(config, ["genesis", "l2", "number"])),
            "sip4895TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "canyon_time"]))),
            "sip3651TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "canyon_time"]))),
            "sip3855TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "canyon_time"]))),
            "sip3860TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "canyon_time"]))),
            "sip1153TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "ecotone_time"]))),
            "sip4788TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "ecotone_time"]))),
            "sip4844TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "ecotone_time"]))),
            "sip5656TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "ecotone_time"]))),
            "sip6780TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "ecotone_time"]))),
            ...
            "sip7702TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "isthmus_time"]))),
            "sip2537TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "isthmus_time"]))),
            "sip2935TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "isthmus_time"]))),
            "sip7623TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "isthmus_time"]))),
            "sip6110TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "isthmus_time"]))),
            "sip7685TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "isthmus_time"]))),
            "sip7642TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "sip7823TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "sip7825TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "sip7883TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "sip7910TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "sip7939TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
            "sip7951TransitionTimestamp": fmap(hex, (lookup(config, ["hardforks", "karst_time"]))),
        ...
        "nodes": [
            # From: https://github.com/sila-chain-optimism/op-geth/blob/3d7afdc2701b74c5987e31521e2c336c4511afdf/params/bootnodes.go
    ...
    ## Optimism specific
    if chain_name == "op" and l1 == "sila-mainnet":
        nethermind["genesis"]["stateUnavailable"] = True
        nethermind["params"]["terminalTotalDifficulty"] = 210470125
        nethermind["params"]["sip2565Transition"] = "0x3C45B0"
        nethermind["params"]["sip2929Transition"] = "0x3C45B0"
        nethermind["params"]["sip2930Transition"] = "0x3C45B0"
...
def to_nethermind_runner(chain_name, l1, chain):
    ...
    runner = {
        "$schema": "https://raw.githubusercontent.com/NethermindSil/core-scripts/refs/heads/main/schemas/config.json",
        "Init": {
    ...
    ## Optimism specific
    if chain_name == "op" and l1 == "sila-mainnet":
        # For some reason we need to hardcode the genesis hash. See https://github.com/sila-chain/sila-nethermind/pull/8105/files#r1944390018
