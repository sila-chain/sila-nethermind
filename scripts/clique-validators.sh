...
wget -q https://raw.githubusercontent.com/sila-chain/sila-nethermind/0758dc22da3df805ca9f280eccdff715328a23e5/src/Nethermind/Chains/goerli.json

# Remove all post merge SIPs
