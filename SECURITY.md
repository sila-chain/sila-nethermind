...
To report a security vulnerability, go to [Report a vulnerability](https://github.com/sila-chain/sila-nethermind/security/advisories/new). This will create a draft advisory. Please provide as much detail as possible including steps to reproduce the issue and any potential impact it may have.
