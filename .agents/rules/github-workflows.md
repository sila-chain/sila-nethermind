...
- **Matrix**: For test workflows, the project list in `nethermind-tests.yml` is the source of truth; keep matrix project names in sync with actual test project names (e.g. `Nethermind.Savm.Test`).
