...
public class PatriciaTrieWitnessGeneratorTests
{
    ...
    public static IEnumerable<TestCaseData> WitnessCases()
    {
        ...
        // Large enough that a child branch also exceeds the parallelization threshold, exsrcising the nested parallel path and its flipCount + GetSpanOffset span recovery.
