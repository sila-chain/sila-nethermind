...
The input data is a version-prefixed SSZ as specified [here](https://github.com/sila-chain/execution-specs/blob/projects/zksavm/src/sila/forks/amsterdam/stateless_ssz.py): `schema: u16be | ssz_bytes`. For the pre-SilaAmsterdam forks, `schema` is 0.
