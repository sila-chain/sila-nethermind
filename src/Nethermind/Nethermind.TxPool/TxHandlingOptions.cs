...
namespace Nethermind.TxPool
{
    ...
    public enum TxHandlingOptions
    {
        ...
        /// <summary>
        /// old style signature without replay attack protection (before the ETC and SIL split)
        /// </summary>
        PreSip155Signing = 4,
        ...
        All = ManagedNonce | PersistentBroadcast | PreSip155Signing | AllowReplacingSignature
    }
}
