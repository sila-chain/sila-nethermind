        ...
        ImmutableArray<ImmutableArray<string>> methodNameGroups)
    {
        ...
        if (sortedTypes.Length != 0)
        {
            ...
            builder
                ...
                .AppendLine("        SilaJsonSerializer.JsonOptions.TryGetTypeInfo(type, out JsonTypeInfo? typeInfo) ? typeInfo : null;")
                .AppendLine()
                .AppendLine("    private static void RegisterGeneric<T>() =>")
                .AppendLine("        RpcGeneratedTypeInfoRegistry.Register(static () =>")
                .AppendLine("            (JsonTypeInfo<T>)SilaJsonSerializer.JsonOptions.GetTypeInfo(typeof(T)));")
                .AppendLine("}");
