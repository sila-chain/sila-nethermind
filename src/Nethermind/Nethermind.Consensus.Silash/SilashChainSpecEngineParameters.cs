...
public class SilashChainSpecEngineParameters : IChainSpecEngineParameters
{
    ...
    public ulong? Sip100bTransition { get; set; }
    ...
    public void AddTransitions(SortedSet<ulong> blockNumbers, SortedSet<ulong> timestamps)
    {
        ...
        if (Sip100bTransition is not null) blockNumbers.Add(Sip100bTransition.Value);
    }
