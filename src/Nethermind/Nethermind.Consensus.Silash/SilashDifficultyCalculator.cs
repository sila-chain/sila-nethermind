...
[assembly: InternalsVisibleTo("Sila.Difficulty.Test")]
[assembly: InternalsVisibleTo("Savm")]

namespace Nethermind.Consensus.Silash
{
    internal class SilashDifficultyCalculator(ISpecProvider specProvider) : IDifficultyCalculator
    {
        ...
        {
            {
                ...
                return spec switch
                {
                    { IsSip100Enabled: true } => BigInteger.Max((parentHasUncles ? 2 : 1) - BigInteger.Divide(timeDiff, 9), -99),
                    { IsSip2Enabled: true } => BigInteger.Max(1 - BigInteger.Divide(timeDiff, 10), -99),
