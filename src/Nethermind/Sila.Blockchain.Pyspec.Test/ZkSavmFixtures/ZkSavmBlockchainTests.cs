...
public class ZkSavmBlockchainTests : ZkSavmBlockchainTestFixture;

public abstract class ZkSavmBlockchainTestFixture : PyspecLinuxX64BlockchainFixture
{
    protected ZkSavmBlockchainTestFixture() : base(parallel: false, batchRead: false) { }

    private static readonly Lazy<IReadOnlyList<BlockchainTest>> _tests = new(() =>
        ZkSavmMutatedWitnessIndex.StampMutatedBlocks(
