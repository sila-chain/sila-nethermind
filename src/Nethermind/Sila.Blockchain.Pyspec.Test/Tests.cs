...
// Blockchain tests - directory derived from class name by convention (strip "BlockchainTests", lowsrcase)
...
// SilaAmsterdam parallel-execution / batch-read prewarm variants - Linux x64 only.
...
// State tests - directory derived from class name by convention (strip "StateTests", lowsrcase)
