...
{
    [TestCase("all.sila-mainnet.ethdisco.net")]
    [TestCase("enrtree://AKA3AM6LPBYEUDMVNU3BSVQJ5AD45Y7YPOHJLEF6W26QOE4VTUDPE@all.sila-mainnet.ethdisco.net")]
    ...
    public async Task Test_enr_discovery2()
    {
        ...
        int verified = 0;
        await foreach (string record in crawler.SearchTree("all.sila-mainnet.ethdisco.net", default))
        {
