...
public class TxBroadcasterTests
{
    ...
    public void should_not_broadcast_persisted_tx_to_peer_too_quickly()
    {
        ...
        Parallel.For(0, addedTxsCount, i =>
        {
            transactions[i] = Build.A.Transaction
                .WithGasPrice(i.GWei)
                .SignedAndResolved(_silaEcdsa, TestItem.PrivateKeys[i])
                .TestObject;
        ...
        [Values(true, false)] bool useBlobTxs)
    {
        ...
        Parallel.For(0, addedTxsCount, i =>
        {
            ...
            {
                builder.WithType(TxType.SIP1559)
    ...
    public void should_broadcast_full_local_tx_immediately_after_receiving_it()
    {
        ...
        ITxPoolPeer sil68Handler = new Sil68ProtocolHandler(session,
        ...
        _broadcaster.AddPeer(sil68Handler);
    ...
    public void should_broadcast_hash_of_blob_local_tx_to_eth68_peers_immediately_after_receiving_it()
    {
        ...
        ITxPoolPeer sil67Handler = new Sil67ProtocolHandler(session67,
            Substitute.For<IMessageSerializationService>(),
            Substitute.For<INodeStatsManager>(),
            Substitute.For<ISyncServer>(),
            RunImmediatelyScheduler.Instance,
        ...
        ITxPoolPeer sil68Handler = new Sil68ProtocolHandler(session68,
            Substitute.For<IMessageSerializationService>(),
            Substitute.For<INodeStatsManager>(),
            Substitute.For<ISyncServer>(),
            RunImmediatelyScheduler.Instance,
        ...
        _broadcaster.AddPeer(sil67Handler);
        _broadcaster.AddPeer(sil68Handler);
    ...
    public void can_correctly_broadcast_light_transactions_without_wrappers([Values] ProofVersion proofVersion, [Values] bool versionMatches)
    {
        ...
        spec.IsSip7594Enabled.Returns(versionMatches ? proofVersion == ProofVersion.V1 : proofVersion == ProofVersion.V0);
