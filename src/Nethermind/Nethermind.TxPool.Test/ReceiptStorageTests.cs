...
namespace Nethermind.TxPool.Test
{
    ...
    public class ReceiptStorageTests(bool useSip2718)
    {
        private readonly bool _useSip2718 = useSip2718;
        ...
        public void Setup()
        {
            ...
            ReceiptsRecovery receiptsRecovery = new(_silaEcdsa, _specProvider);
        ...
        [Test]
        public void should_add_and_fetch_receipt_from_persistent_storage_with_sip_658()
        ...
        private Transaction GetSignedTransaction(Address to = null)
            => Build.A.Transaction.SignedAndResolved(_silaEcdsa, TestItem.PrivateKeyA).TestObject;
