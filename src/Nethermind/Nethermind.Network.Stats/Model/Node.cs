...
namespace Nethermind.Stats.Model
{
    ...
    public sealed class Node : IFormattable, IEquatable<Node>
    {
        ...
        public string SilDetails { get; set; }
        ...
        /// <summary>
        /// Tries to create an RLPx peer candidate from an Sila Node Record with a secp256k1 key and TCP endpoint.
        /// </summary>
        /// <param name="enr">The Sila Node Record to read.</param>
        ...
        /// <summary>
        /// Tries to create a discovery-routing node from an Sila Node Record with a secp256k1 key and UDP endpoint.
        /// </summary>
        /// <param name="enr">The Sila Node Record to read.</param>
        ...
        public string ToString(string format, IFormatProvider formatProvider) => format switch
        {
            ...
            Format.Console => $"[Node|{Host}:{Port}|{SilDetails}|{ClientId}]",
        ...
        private static readonly Regex _clientTypeRegex = new(
            string.Join("|",
                ...
                new[]
                {
                    ...
                    nameof(NodeClientType.SilaJS),
                    nameof(NodeClientType.OpenSila),
