...
/// <summary>
/// Initial version of Reputation calculation mostly based on SilaJ impl
/// </summary>
public class NodeStatsLight(Node node, float latestSpeedWeight = 0.25f) : INodeStats
{
    ...
    public SyncPeerNodeDetails SilNodeDetails { get; private set; }
    ...
    {
        SilNodeDetails = nodeDetails;
        Increment(NodeStatsEventType.Sil62Initialized);
    }
