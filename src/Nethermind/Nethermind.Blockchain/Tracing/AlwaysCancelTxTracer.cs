...
public class AlwaysCancelTxTracer : ITxTracer
{
    ...
    public void ReportOperationError(SavmExceptionType error) => throw new OperationCanceledException(ErrorMessage);
    ...
    public void ReportActionError(SavmExceptionType exceptionType) => throw new OperationCanceledException(ErrorMessage);
