    ...
    IBlocksConfig blocksConfig)
{
    ...
    // SIP-150: each CALL site reserves 1/64 for the caller, so the optimistic guess must use 64/63, not the search-stop margin.
    ...
    {
        // Short-circuit: simple SIL transfers need exactly the intrinsic gas.
