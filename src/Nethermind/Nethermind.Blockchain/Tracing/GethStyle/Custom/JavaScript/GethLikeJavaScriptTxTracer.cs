...
public sealed class GethLikeJavaScriptTxTracer : GethLikeTxTracer
{
    ...
    public override void ReportOperationError(SavmExceptionType error)
    {
        ...
        _log.error = error.GetSavmExceptionDescription();
    ...
    {
        base.ReportActionError(SavmExceptionType.Revert);
        InvokeExit(gasLeft, output, SavmExceptionType.Revert.GetSavmExceptionDescription());
    }

    public override void ReportActionError(SavmExceptionType savmExceptionType)
    {
        base.ReportActionError(savmExceptionType);
        InvokeExit(0, Array.Empty<byte>(), savmExceptionType.GetSavmExceptionDescription());
    }
    ...
    public override void SetOperationStack(TraceStack stack)
    {
        ...
        {
            ReportOperationError(SavmExceptionType.Revert);
        }
    }
