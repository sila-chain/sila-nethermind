...
public class NativePrestateTracer : GethLikeNativeTxTracer
{
        ...
        : base(options)
    {
        ...
        NativePrestateTracerConfig config = options.TracerConfig?.Deserialize<NativePrestateTracerConfig>(SilaJsonSerializer.JsonOptions) ?? new NativePrestateTracerConfig();
