...
public class ParityLikeTxTracer : TxTracer
{
    ...
    private static string? GetErrorDescription(SavmExceptionType savmExceptionType) => savmExceptionType switch
    {
        SavmExceptionType.None => null,
        SavmExceptionType.BadInstruction => "Bad instruction",
        SavmExceptionType.StackOverflow => "Stack overflow",
        SavmExceptionType.StackUnderflow => "Stack underflow",
        SavmExceptionType.OutOfGas => "Out of gas",
        SavmExceptionType.InvalidJumpDestination => "Bad jump destination",
        SavmExceptionType.AccessViolation => "Access violation",
        SavmExceptionType.StaticCallViolation => "Static call violation",
        SavmExceptionType.Revert => "Reverted",
        _ => "Error",
    };
    ...
    {
        if (error != SavmExceptionType.InvalidJumpDestination &&
            error != SavmExceptionType.NotEnoughBalance)
        {
    ...
    {
        _currentAction!.Result = null;
        _currentAction.Error = GetErrorDescription(savmExceptionType);
        PopAction();
    }
