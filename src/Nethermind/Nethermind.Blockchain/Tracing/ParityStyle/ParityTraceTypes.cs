...
public enum ParityTraceTypes
{
    [Description("None.")]
    None = 0,
    [Description("Provides a full trace of the SAVM state throughout the execution of transactions at each op-code, including subcalls.")]
    VmTrace = 1,
    [Description("Provides Sila state difference detailing all altered portions of the state made due to the execution of transactions.")]
    StateDiff = 2,
