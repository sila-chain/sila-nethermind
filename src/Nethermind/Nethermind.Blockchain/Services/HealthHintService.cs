...
namespace Nethermind.Blockchain.Services
{
    public class HealthHintService(ChainSpec chainSpec) : IHealthHintService
    {
        ...
        public ulong? MaxSecondsIntervalForProcessingBlocksHint()
        {
            ...
            if (_chainSpec.SealEngineType == SealEngineType.Silash)
                blockProcessorHint = HealthHintConstants.SilashStandardProcessingPeriod * HealthHintConstants.SilashProcessingSafetyMultiplier;
            else
