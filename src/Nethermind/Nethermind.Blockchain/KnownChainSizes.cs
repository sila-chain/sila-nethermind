...
namespace Nethermind.Blockchain
{
    ...
    public static class ChainSizes
    {
        ...
        {
            BlockchainIds.SilaMainnet => new ChainEstimations(new LinearExtrapolation(156.GB, 90.MB, new DateTime(2024, 07, 17)),
                new LinearExtrapolation(180.GB, 95.MB, new DateTime(2024, 07, 17))),
            BlockchainIds.SilaSepolia => new ChainEstimations(new LinearExtrapolation(38.GB, 90.MB, new DateTime(2024, 07, 17)),
                new LinearExtrapolation(45.GB, 95.MB, new DateTime(2024, 07, 17))),

            BlockchainIds.SilaHolesky => new ChainEstimations(new LinearExtrapolation(17.GB, 30.MB, new DateTime(2024, 07, 17))),
