...
{
    public class ReceiptsRecovery(ISilaEcdsa? ecdsa, ISpecProvider? specProvider, bool reinsertReceiptOnRecover = true) : IReceiptsRecovery
    {
        private readonly ISilaEcdsa _ecdsa = ecdsa ?? throw new ArgumentNullException(nameof(ecdsa));
        ...
        private class RecoveryContext(IReleaseSpec releaseSpec, ReceiptRecoveryBlock block, bool forceRecoverSender, ISilaEcdsa ecdsa) : IReceiptsRecovery.IRecoveryContext
        {
            ...
            private readonly ISilaEcdsa _ecdsa = ecdsa;
