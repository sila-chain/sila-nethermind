...
namespace Nethermind.Clique.Test
{
    ...
    public class CliqueRpcModuleTests
    {
        ...
        public void Sets_clique_block_producer_properly()
        {
            ...
            Signer signer = new(BlockchainIds.SilaSepolia, TestItem.PrivateKeyA, LimboLogs.Instance);
            ...
            SnapshotManager snapshotManager = new(CliqueConfig.Default, new MemDb(), Substitute.For<IBlockTree>(), NullSilaEcdsa.Instance, LimboLogs.Instance);
