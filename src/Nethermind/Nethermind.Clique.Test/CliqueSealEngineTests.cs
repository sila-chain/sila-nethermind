...
public class CliqueSealEngineTests
{
    ...
    {
        ISilaEcdsa ecdsa = new SilaEcdsa(BlockchainIds.SilaSepolia);
        ...
        _clique = new CliqueSealer(new Signer(BlockchainIds.SilaSepolia, _currentSigner, LimboLogs.Instance), config,
