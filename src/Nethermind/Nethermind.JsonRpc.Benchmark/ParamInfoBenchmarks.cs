...
namespace Nethermind.JsonRpc.Benchmark
{
    public class ParamInfoBenchmarks
    {
        ...
        {
            Scenarios[0] = typeof(SilRpcModule).GetMethod("sil_getStorageAt", BindingFlags.Public | BindingFlags.Instance);
            Scenarios[1] = typeof(SilRpcModule).GetMethod("sil_blockNumber", BindingFlags.Public | BindingFlags.Instance);
        }
