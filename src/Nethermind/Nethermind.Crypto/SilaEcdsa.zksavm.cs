...
#pragma warning disable NETH003 // Build variant: only one of SilaEcdsa.std.cs / SilaEcdsa.zksavm.cs is compiled per build
...
public sealed class SilaEcdsa(ulong chainId) : ISilaEcdsa
{
