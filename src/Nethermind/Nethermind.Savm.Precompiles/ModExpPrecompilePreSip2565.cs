...
/// <summary>
///     https://github.com/sila-chain/SIPs/blob/vbuterin-patch-2/SIPS/bigint_modexp.md
/// </summary>
[Obsolete("Pre-sip2565 implementation")]
public class ModExpPrecompilePreSip2565 : IPrecompile<ModExpPrecompilePreSip2565>
{
    public static ModExpPrecompilePreSip2565 Instance { get; } = new();
    private static readonly UInt256 Eight = 8;

    private ModExpPrecompilePreSip2565()
    {
    }
