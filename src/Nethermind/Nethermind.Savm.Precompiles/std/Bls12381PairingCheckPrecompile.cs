...
public partial class Bls12381PairingCheckPrecompile
{
    ...
    public partial Result<byte[]> Run(ReadOnlyMemory<byte> inputData, IReleaseSpec _)
    {
        ...
        for (int i = 0; i < inputData.Length / PairSize; i++)
        {
            ...
            Result result =
                x.TryDecodeRaw(inputData[offset..(offset + Sip2537.LenG1)].Span) &&
                y.TryDecodeRaw(inputData[(offset + Sip2537.LenG1)..(offset + PairSize)].Span);
            ...
            if (result)
            {
                ...
                if (!(Sip2537.DisableSubgroupChecks || y.InGroup()))
