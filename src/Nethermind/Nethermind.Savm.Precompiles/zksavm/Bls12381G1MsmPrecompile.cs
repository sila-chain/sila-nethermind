...
public partial class Bls12381G1MsmPrecompile
{
    ...
    {
        int decodedLen = pairCount * (Sip2537.LenG1Trimmed + Sip2537.LenFr);
    ...
    {
        Span<byte> decoded = stackalloc byte[Sip2537.LenG1Trimmed + Sip2537.LenFr];

        if (!Sip2537.TryDecodeG1(input[..Sip2537.LenG1], decoded[..Sip2537.LenG1Trimmed]))
            return Errors.InvalidFieldElementTopBytes;

        input[Sip2537.LenG1..].CopyTo(decoded[Sip2537.LenG1Trimmed..]);
    ...
    private static bool TryDecodeInput(ReadOnlySpan<byte> input, Span<byte> decoded, int pairCount)
    {
        ...
        {
            if (!Sip2537.TryDecodeG1(input.Slice(srcOffset, Sip2537.LenG1), decoded.Slice(dstOffset, Sip2537.LenG1Trimmed)))
                return false;

            srcOffset += Sip2537.LenG1;
            dstOffset += Sip2537.LenG1Trimmed;
