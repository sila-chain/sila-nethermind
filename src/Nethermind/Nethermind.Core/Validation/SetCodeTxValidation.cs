...
/// <summary>
/// Shape checks specific to <see cref="TxType.SetCode"/> (SIP-7702) transactions.
/// </summary>
/// <remarks>
...
/// <c>sil_call</c> and <c>sil_estimateGas</c> reach the transaction processor
...
/// paths from drifting apart as SIP-7702 evolves.
/// </remarks>
public static class SetCodeTxValidation
{
    /// <summary>
    /// SIP-7702: a SetCode transaction cannot be a contract-creation transaction.
    /// </summary>
    ...
    /// <summary>
    /// SIP-7702: a SetCode transaction must carry a non-empty authorization list.
    /// </summary>
