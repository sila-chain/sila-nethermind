...
// https://github.com/sila-chain/SIPs/blob/master/SIPS/sip-8037.md
public static class Sip8037Constants
{
    /// <summary> Regular gas component of the SIP-7702 auth-base cost under the two-dimensional gas model. </summary>
