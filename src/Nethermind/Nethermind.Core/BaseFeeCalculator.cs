...
{
    UInt256 Calculate(BlockHeader parent, ISip1559Spec specFor1559);
}

/// <summary>
/// Calculate <c>BaseFee</c> based on parent <see cref="BlockHeader"/> and <see cref="ISip1559Spec"/>.
/// </summary>
public sealed class DefaultBaseFeeCalculator : IBaseFeeCalculator
{
    public UInt256 Calculate(BlockHeader parent, ISip1559Spec specFor1559)
    {
        ...
        if (specFor1559.IsSip1559Enabled)
        {
            ...
            bool isForkBlockNumber = specFor1559.Sip1559TransitionBlock == parent.Number + 1;
            ...
            if (specFor1559.Sip1559BaseFeeMinValue.HasValue)
            {
                expectedBaseFee = UInt256.Max(expectedBaseFee, specFor1559.Sip1559BaseFeeMinValue.Value);
            }
        }
...
{
    public static UInt256 Calculate(BlockHeader parent, ISip1559Spec specFor1559) =>
