...
public static class TxErrorMessages
{
    ...
    public static readonly string BlobTxMissingBlobs =
        $"blob transaction must have at least {Sip4844Constants.MinBlobsPerTransaction} blob";
    ...
    public static readonly string InvalidBlobVersionedHashSize =
        $"InvalidBlobVersionedHashSize: Cannot exceed {Sip4844Constants.BytesPerBlobVersionedHash}.";
    ...
    public const string MissingAuthorizationList = "SIP-7702 transaction with empty auth list";
