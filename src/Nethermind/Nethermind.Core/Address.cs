...
namespace Nethermind.Core
{
    ...
    public sealed class Address : IEquatable<Address>, IComparable<Address>
    {
        ...
        /// <summary>
        ///     https://github.com/sila-chain/SIPs/issues/55
        /// </summary>
        /// <returns></returns>
        public string ToString(bool withSip55Checksum) => ToString(true, withSip55Checksum);

        /// <summary>
        ///     https://github.com/sila-chain/SIPs/issues/55
        /// </summary>
        /// <returns></returns>
        public string ToString(bool withZeroX, bool withSip55Checksum) => Bytes.ToHexString(withZeroX, false, withSip55Checksum);
    ...
    public readonly struct AddressBySip55ChecksumOrdinalComparer : IComparer<Address>
    {
        [SkipLocalsInit]
    ...
    public ref struct AddressStructRef
    {
        ...
        /// </summary>
        /// <returns></returns>
        public readonly string ToString(bool withSip55Checksum) => ToString(true, withSip55Checksum);

        /// <summary>
        ///     https://github.com/sila-chain/SIPs/issues/55
        /// </summary>
        /// <returns></returns>
        public readonly string ToString(bool withZeroX, bool withSip55Checksum) => Bytes.ToHexString(withZeroX, false, withSip55Checksum);
