...
public readonly struct StorageChange(uint index, SavmWord value) : IEquatable<StorageChange>, IIndexedChange
{
    ...
    /// </summary>
    public readonly SavmWord Value = value;
    ...
    public StorageChange(uint index, in UInt256 value)
        : this(index, Unsafe.As<UInt256, SavmWord>(ref Unsafe.AsRef(in value)).ByteSwap())
    {
    }
