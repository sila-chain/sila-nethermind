...
namespace Nethermind.Core
{
    ...
    public class Transaction
    {
        ...
        /// <summary>
        /// Gas used for block accounting (pre-refund when SIP-7778 is enabled).
        ...
        public AccessList? AccessList { get; set; } // sip2930

        public UInt256? MaxFeePerBlobGas { get; set; } // sip4844

        public byte[]?[]? BlobVersionedHashes { get; set; } // sip4844
