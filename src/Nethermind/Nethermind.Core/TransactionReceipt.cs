...
namespace Nethermind.Core
{
    public class TxReceipt
    {
        ...
        // JSON dump (BlockTraceDumper) to aid investigation of SIP-7778/SIP-8037
        // gas-accounting issues.
        /// <summary>SIP-7778 pre-refund gas used by block-level gas accounting (regular dim).</summary>
        public ulong BlockGasUsed { get; set; }
        /// <summary>SIP-8037 state-dim gas (storage / state-mutating ops) used by block accounting.</summary>
        public ulong StorageGasUsed { get; set; }
        /// <summary>Post-refund execution gas without SIP-7976 floor adjustment (OperationGas).</summary>
        public ulong ExecutionGasUsed { get; set; }
        /// <summary>Effective gas price after SIP-1559 baseFee adjustment - computed at receipt-build time.</summary>
