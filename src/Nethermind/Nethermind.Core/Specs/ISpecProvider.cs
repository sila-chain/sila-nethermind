...
{
    /// <summary>
    /// Provides details of enabled SIPs and other chain parameters at any chain height.
    /// </summary>
    public interface ISpecProvider
    {
        ...
        /// https://github.com/sila-chain/SIPs/blob/d896145678bd65d3eafd8749690c1b5228875c39/SIPS/sip-3675.md#definitions
        ...
        /// <summary>
        /// Retrieves the list of enabled SIPs at genesis block.
        /// </summary>
        ...
        /// <summary>
        /// Block number at which DAO happens (only relevant for sila-mainnet)
        /// </summary>
        ...
        /// </summary>
        string SealEngine => SealEngineType.Silash;
    ...
    public static class SpecProviderExtensions
    {
        extension(ISpecProvider specProvider)
        {
            ...
            /// for every new not yet scheduled SIP. Because of that we can't use long.MaxValue and
