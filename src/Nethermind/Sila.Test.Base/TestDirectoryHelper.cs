...
public static class TestDirectoryHelper
{
    ...
    /// <summary>
    /// Derives directory from class name by stripping a known suffix and lowsrcasing.
    ...
    /// <summary>
    /// Derives a JSON filename by stripping a suffix and lowsrcasing the first character.
