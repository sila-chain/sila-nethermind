...
{
    public class Sil62ProtocolHandlerBenchmarks
    {
        ...
        public void SetUp()
        {
            ...
            SilaEcdsa ecdsa = new(TestBlockchainIds.ChainId);
            ...
            _handler = new Sil62ProtocolHandler(session, _ser, stats, syncSrv, RunImmediatelyScheduler.Instance, txPool, Consensus.ShouldGossip.Instance, LimboLogs.Instance);
        ...
        public void Current()
        {
            ...
            _zeroPacket.PacketType = Sil62MessageCode.Transactions;
            _handler.HandleMessage(_zeroPacket);
        }
