...
/// <summary>
/// Contributes the capabilities every node advertises by default (currently sil/68).
/// </summary>
/// <remarks>
...
public class DefaultP2PCapabilityResolver : IP2PCapabilityResolver
{
    ...
    public void Resolve(ISet<Capability> capabilities) => capabilities.Add(new Capability(Protocol.Sil, 68));
}
