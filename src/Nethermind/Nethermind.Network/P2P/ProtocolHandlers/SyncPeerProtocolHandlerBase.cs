...
namespace Nethermind.Network.P2P.ProtocolHandlers
{
    public abstract class SyncPeerProtocolHandlerBase : ZeroProtocolHandlerBase, ISyncPeer
    {
        ...
        public virtual Task<IOwnedReadOnlyList<TxReceipt[]>> GetReceipts(IReadOnlyList<Hash256> blockHash, CancellationToken token) => throw new NotSupportedException("Fast sync not supported by sil62 protocol");

        public virtual Task<IByteArrayList> GetNodeData(IReadOnlyList<Hash256> hashes, CancellationToken token) => throw new NotSupportedException("Fast sync not supported by sil62 protocol");
        ...
        protected async Task<BlockHeadersMessage> Handle(GetBlockHeadersMessage getBlockHeadersMessage, CancellationToken cancellationToken)
        {
            ...
            // // to clearly state that this client is an SIL client and not ETC (and avoid disconnections on reversed sync)
            ...
            // {
            //     // hardcoded response
            //     // Packet packet = new Packet(ProtocolCode, Sil62MessageCode.BlockHeaders, Bytes.FromHexString(""));
        ...
        protected Task<BlockHeadersMessage> FulfillBlockHeadersRequest(GetBlockHeadersMessage msg, CancellationToken cancellationToken)
        {
            ...
            {
                throw new SilSyncException("Incoming headers request for more than 1024 headers");
            }
