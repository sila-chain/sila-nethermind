...
{
    public class Sil62ProtocolHandler : SyncPeerProtocolHandlerBase, IZeroProtocolHandler
    {
        ...
        public Sil62ProtocolHandler(ISession session,
        ...
        public static string Code => Protocol.Sil;
        public override byte ProtocolVersion => SilVersions.Sil62;
        public override string ProtocolCode => Protocol.Sil;
        public override int MessageIdSpaceSize => 8;
        public override string Name => "sil62";
        protected override TimeSpan InitTimeout => Timeouts.Sil62Status;
        ...
        protected override bool HandleMessageCore(ZeroPacket message)
        {
            ...
            switch (message.PacketType)
            {
                ...
                case Sil62MessageCode.NewBlockHashes:
                    ...
                    return true;
                case Sil62MessageCode.Transactions:
                ...
                case Sil62MessageCode.BlockBodies:
                    ...
                    return true;
                case Sil62MessageCode.NewBlock:
                    if (CanAcceptBlockGossip())
                    {
        ...
        {
            if (!_statusReceived && packetType != Sil62MessageCode.Status)
            {
