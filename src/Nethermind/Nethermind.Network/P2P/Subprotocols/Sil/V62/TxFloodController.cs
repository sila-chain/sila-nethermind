...
{
    internal class TxFloodController(Sil62ProtocolHandler protocolHandler, ITimestamper timestamper, ILogger logger)
    {
        private DateTime _checkpoint = DateTime.UtcNow;
        private readonly Sil62ProtocolHandler _protocolHandler = protocolHandler ?? throw new ArgumentNullException(nameof(protocolHandler));
