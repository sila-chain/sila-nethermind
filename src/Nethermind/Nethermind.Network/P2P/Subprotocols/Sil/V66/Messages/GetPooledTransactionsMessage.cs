...
public class GetPooledTransactionsMessage : Sil66Message<V65.Messages.GetPooledTransactionsMessage>, INew<IOwnedReadOnlyList<Hash256>, GetPooledTransactionsMessage>
{
