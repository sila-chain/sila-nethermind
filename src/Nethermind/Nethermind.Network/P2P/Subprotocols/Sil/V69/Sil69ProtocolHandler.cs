...
/// <summary>
/// https://sips.sila.org/SIPS/sip-7642
/// </summary>
public class Sil69ProtocolHandler(
    ISession session,
    ...
    : Sil68ProtocolHandler(session, serializer, nodeStatsManager, syncServer, backgroundTaskScheduler, txPool,
        gossipPolicy, forkInfo, logManager, txPoolConfig, specProvider, transactionsGossipPolicy), ISyncPeer, IStaticProtocolInfo
{
    public override string Name => "sil69";

    public new static byte Version => SilVersions.Sil69;
    ...
    protected override bool HandleMessageCore(ZeroPacket message)
    {
        ...
        switch (message.PacketType)
        {
            ...
            case Sil69MessageCode.Receipts:
                ...
                return true;
            case Sil69MessageCode.GetReceipts:
                HandleInBackground<GetReceiptsMessage, ReceiptsMessage69>(message, Handle);
                return true;
            case Sil69MessageCode.BlockRangeUpdate:
    ...
    private new async Task<ReceiptsMessage69> Handle(GetReceiptsMessage getReceiptsMessage, CancellationToken cancellationToken)
    {
        ...
        return new(message.RequestId, message.SilMessage);
    }
