...
namespace Nethermind.Network.P2P.Subprotocols.Sil.V68;

public class Sil68ProtocolHandler(ISession session,
    ...
    : Sil67ProtocolHandler(session, serializer, nodeStatsManager, syncServer, backgroundTaskScheduler, txPool, gossipPolicy, forkInfo, logManager, transactionsGossipPolicy), IStaticProtocolInfo
{
    ...
    public override string Name => "sil68";

    public new static byte Version => SilVersions.Sil68;
    ...
    protected override bool HandleMessageCore(ZeroPacket message)
    {
        ...
        {
            case Sil68MessageCode.NewPooledTransactionHashes:
