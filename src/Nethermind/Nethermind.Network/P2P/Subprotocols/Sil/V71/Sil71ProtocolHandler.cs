...
namespace Nethermind.Network.P2P.Subprotocols.Sil.V71;

/// <summary>
/// https://sips.sila.org/SIPS/sip-8159 — sil/71: Block Access List Exchange
/// Adds GetBlockAccessLists (0x12) and BlockAccessLists (0x13) messages for BAL synchronization.
/// </summary>
public class Sil71ProtocolHandler : Sil70ProtocolHandler, ISyncPeer, IStaticProtocolInfo
{
    private readonly MessageDictionary<GetBlockAccessListsMessage, BlockAccessListsMessage> _balRequests;

    /// <summary>
    /// Recommended soft limit for BlockAccessLists responses (10 MiB per SIP-8159).
    /// </summary>
    private const int BalResponseSoftLimit = 10 * MemorySizes.MiB;

    public Sil71ProtocolHandler(
        ISession session,
    ...
    public override string Name => "sil71";

    public new static string Code => Protocol.Sil;
    public new static byte Version => SilVersions.Sil71;
