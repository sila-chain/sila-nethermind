...
using Nethermind.Network.P2P.Subprotocols.Sil.V64;
...
namespace Nethermind.Network.P2P.Subprotocols.Sil.V65
{
    /// <summary>
    /// https://github.com/sila-chain/SIPs/blob/master/SIPS/sip-2464.md
    /// </summary>
    public class Sil65ProtocolHandler(
        ISession session,
        ...
        : Sil64ProtocolHandler(session, serializer, nodeStatsManager, syncServer, backgroundTaskScheduler, txPool, gossipPolicy, forkInfo, logManager, transactionsGossipPolicy),
          IMessageHandler<PooledTransactionRequestMessage>
    {
        public override string Name => "sil65";

        public override byte ProtocolVersion => SilVersions.Sil65;
        ...
        protected override bool HandleMessageCore(ZeroPacket message)
        {
            ...
            {
                case Sil65MessageCode.NewPooledTransactionHashes:
                    ...
                    return true;
                case Sil65MessageCode.GetPooledTransactions:
                    HandleInBackground<GetPooledTransactionsMessage>(message, Handle);
                    return true;
                case Sil65MessageCode.PooledTransactions:
                    if (CanReceiveTransactions)
                    {
