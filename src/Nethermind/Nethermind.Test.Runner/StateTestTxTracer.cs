...
public class StateTestTxTracer : ITxTracer, IDisposable
{
    ...
    private static string? GetErrorDescription(SavmExceptionType savmExceptionType) => savmExceptionType switch
    {
        ...
        SavmExceptionType.BadInstruction => "BadInstruction",
        SavmExceptionType.StackOverflow => "StackOverflow",
        SavmExceptionType.StackUnderflow => "StackUnderflow",
        SavmExceptionType.OutOfGas => "OutOfGas",
        SavmExceptionType.InvalidJumpDestination => "BadJumpDestination",
        SavmExceptionType.AccessViolation => "AccessViolation",
        SavmExceptionType.StaticCallViolation => "StaticCallViolation",
        _ => "Error"
    };
