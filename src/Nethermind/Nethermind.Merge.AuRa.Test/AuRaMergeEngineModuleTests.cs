...
public class AuRaMergeEngineModuleTests(bool parallel) : EngineModuleTests(parallel)
{
    ...
    public override async Task NewPayloadV5_accepts_valid_BAL(string? blockHash, string? receiptsRoot, string? stateRoot, bool sip8037Enabled, bool useEnginePipeline)
    ...
    public override Task NewPayloadV5_rejects_invalid_BAL_early(string? blockHash, string? receiptsRoot, string? stateRoot, bool sip8037Enabled, bool useEnginePipeline, BalErrorKind errorKind) =>
