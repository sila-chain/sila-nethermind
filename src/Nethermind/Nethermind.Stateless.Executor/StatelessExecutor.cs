...
public static class StatelessExecutor
{
...
#if !ZK_SAVM
                if (spec.IsSip4844Enabled && !KzgPolynomialCommitments.IsInitialized)
    ...
    private static ISpecProvider GetSpecProvider(ChainConfig chainConfig)
    {
        ...
        // ActiveFork pins the spec by name on any compatible schedule; unknown chains (e.g. devnets) use SilaMainnet rules.
