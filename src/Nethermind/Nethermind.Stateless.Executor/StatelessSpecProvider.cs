...
/// Chain id is supplied externally, so any compatible base schedule (e.g. SilaMainnet rules) can serve
/// as a devnet's fork catalog without misreporting the chain id to SIP-155 validation.
