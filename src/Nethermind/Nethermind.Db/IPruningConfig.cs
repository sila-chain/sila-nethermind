...
public interface IPruningConfig : IConfig
{
    ...
    [ConfigItem(Description = "Maximum number of blocks worth of unpersisted state in memory. Default is 297, which is the number of sila-mainnet blocks per hour.", DefaultValue = "297")]
