...
#pragma warning disable NETH003 // Build variant: only one of ILogger.std.cs / ILogger.zksavm.cs is compiled per build
/// <summary>zkSAVM no-op <see cref="ILogger"/>: all flags literal <c>false</c>, all log methods empty + inlined.</summary>
