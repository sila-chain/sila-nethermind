...
namespace Nethermind.HealthChecks
{
        ...
        : INodeHealthService
    {
        ...
        private static void AddStillSyncingMessage(ICollection<(string Description, string LongDescription)> messages,
            SyncingResult silSyncing) => messages.Add(("Still syncing",
                $"The node is still syncing, CurrentBlock: {silSyncing.CurrentBlock}, HighestBlock: {silSyncing.HighestBlock}. The status will change to healthy once synced"));
