...
namespace Nethermind.Facade.Test.Sil
{
    [TestFixture]
    [Parallelizable(ParallelScope.All)]
    public class SilSyncingInfoTests
    {
        [Test]
        public void GetFullInfo_WhenNotSyncing()
        {
            ...
            SilSyncingInfo silSyncingInfo = new(blockTree, syncPointers, syncConfig,
                new StaticSelector(SyncMode.All), syncProgressResolver, LimboLogs.Instance);
            SyncingResult syncingResult = silSyncingInfo.GetFullInfo();
        ...
        public void IsSyncing_ReturnsExpectedResult(ulong bestHeader, ulong currentHead, bool expectedResult)
        {
            ...
            SilSyncingInfo silSyncingInfo = new(blockTree, syncPointers, new SyncConfig(),
                new StaticSelector(SyncMode.All), syncProgressResolver, LimboLogs.Instance);
            SyncingResult syncingResult = silSyncingInfo.GetFullInfo();
        ...
        public void Should_calculate_sync_time()
        {
            ...
            Assert.That(silSyncingInfo.IsSyncing(), Is.EqualTo(false));
            Assert.That(silSyncingInfo.UpdateAndGetSyncTime().TotalMicroseconds, Is.EqualTo(0));
            ...
            Assert.That(silSyncingInfo.IsSyncing(), Is.EqualTo(true));
            Assert.That(silSyncingInfo.UpdateAndGetSyncTime().TotalMicroseconds, Is.EqualTo(0));
            ...
            Assert.That(silSyncingInfo.IsSyncing(), Is.EqualTo(true));
            Assert.That(silSyncingInfo.UpdateAndGetSyncTime().TotalMicroseconds, Is.Not.EqualTo(0));
