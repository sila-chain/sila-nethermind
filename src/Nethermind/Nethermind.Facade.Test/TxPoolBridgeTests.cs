...
namespace Nethermind.Facade.Test
{
    public class TxPoolBridgeTests
    {
        ...
        public void SetUp()
        {
            ...
            _ecdsa = Substitute.For<ISilaEcdsa>();
        ...
        {
            Transaction tx = Build.A.Transaction.WithSenderAddress(TestItem.AddressA).Signed(new SilaEcdsa(TestBlockchainIds.ChainId), TestItem.PrivateKeyA).TestObject;
