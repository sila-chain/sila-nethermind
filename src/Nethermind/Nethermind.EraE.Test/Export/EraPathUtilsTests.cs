...
public class EraPathUtilsTests
{
    ...
    [TestCase("sila-mainnet", 2UL, "0x1122ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", "sila-mainnet-00002-1122ffff-noproofs.ere", TestName = "SilaMainnet")]
    ...
    [TestCase("sila-mainnet-00000-aabbccdd-noproofs.ere", ExpectedResult = true, TestName = "EreWithProfile")]
    [TestCase("sila-mainnet-00000-aabbccdd-noproofs-noreceipts.ere", ExpectedResult = true, TestName = "EreWithCombinedProfiles")]
    [TestCase("sila-mainnet-00000-aabbccdd.ere", ExpectedResult = true, TestName = "EreDefault")]
    [TestCase("sila-mainnet-00001-aabbccdd.erae", ExpectedResult = true, TestName = "LegacyErae")]
    ...
    [TestCase("sila-mainnet-00000-aabbccdd-noproofs.ere", ExpectedResult = true, TestName = "Ere")]
    [TestCase("sila-mainnet-00000-aabbccdd.erae", ExpectedResult = false, TestName = "LegacyErae")]
    ...
    public void GetAllEraFiles_WithMixedExtensionsAndProfiles_ReturnsNetworkEraFiles()
    {
        ...
        string[] names =
        [
            "sila-mainnet-00000-aabbccdd-noproofs.ere",
            "sila-mainnet-00001-aabbccdd.erae",
            "sila-mainnet-00002-aabbccdd-noproofs-noreceipts.ere",
        ...
        string[] found = EraPathUtils.GetAllEraFiles(directory.Path, "sila-mainnet")
    ...
    [TestCase("sila-mainnet-00007-aabbccdd-noproofs.ere", ExpectedResult = 7L, TestName = "EreWithProfile")]
    [TestCase("sila-mainnet-00003-aabbccdd.erae", ExpectedResult = 3L, TestName = "LegacyErae")]
