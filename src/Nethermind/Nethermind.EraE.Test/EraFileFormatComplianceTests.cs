...
/// Cross-client interoperability testing with go-sila / fluffy is pending availability
/// of reference .erae test files (go-sila has not yet written Proof entries as of 2026-03).
/// </summary>
