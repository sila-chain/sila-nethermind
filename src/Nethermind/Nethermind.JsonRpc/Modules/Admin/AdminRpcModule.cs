...
public class AdminRpcModule : IAdminRpcModule
{
    ...
    {
        _nodeInfo.Protocols[Protocol.Sil].Difficulty = _blockTree.Head?.TotalDifficulty ?? 0;
        _nodeInfo.Protocols[Protocol.Sil].NetworkId = _blockTree.NetworkId;
        _nodeInfo.Protocols[Protocol.Sil].ChainId = _blockTree.ChainId;
        _nodeInfo.Protocols[Protocol.Sil].HeadHash = _blockTree.HeadHash;
        _nodeInfo.Protocols[Protocol.Sil].GenesisHash = _blockTree.GenesisHash;
        _nodeInfo.Protocols[Protocol.Sil].Config = _parameters;
    }
}
