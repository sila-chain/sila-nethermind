...
namespace Nethermind.JsonRpc.Modules.Admin
{
    public class PeerInfo
    {
        ...
        private void SetProtocols(IReadOnlyList<Capability> capabilities)
        {
            ...
            {
                if (capability.ProtocolCode == Protocol.Sil && silVersion == 0)
                {
                    silVersion = capability.Version;
                }
                ...
                if (silVersion > 0 && snapVersion > 0) break;
            }

            // SIL protocol (always present)
            protocols[Protocol.Sil] = new { Version = silVersion };
        ...
        private void SetDetailedFields(Peer peer)
        {
            ...
            SilDetails = peer.Node.SilDetails;
