...
/// <summary>
/// Response for sil_capabilities — describes the head block and the historical data availability of each resource type.
/// Follows sila/execution-apis#755.
/// </summary>
/// <remarks>
...
/// <param name="Stateproofs">Proof / trie-node availability (sil_getProof depth window).</param>
public record SilCapabilities(
