...
{
    /// <summary>
    /// Response payload of <c>proof_getProofWithMeta</c> — the SIP-1186 account proof plus
    /// per-call diagnostics from <see cref="ProofMeta"/>.
    /// </summary>
    public class AccountProofWithMeta
    {
        /// <summary>SIP-1186 account proof, identical in shape to <c>sil_getProof</c>'s result.</summary>
