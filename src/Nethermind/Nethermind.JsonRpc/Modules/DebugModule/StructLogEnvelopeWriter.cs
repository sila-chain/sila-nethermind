...
using ErrorType = Nethermind.Savm.TransactionProcessing.TransactionResult.ErrorType;
...
internal static class StructLogEnvelopeWriter
{
    ...
    private static string FormatErrorDescription(TransactionResult result)
    {
        ...
        return result.Error switch
        {
            ...
            ErrorType.TransactionSizeOverMaxInitCodeSize => ReplacePrefix(detail, "SIP-3860 - transaction size over max init code size", "max initcode size exceeded"),
