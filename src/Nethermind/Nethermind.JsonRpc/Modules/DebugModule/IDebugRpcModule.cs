...
public interface IDebugRpcModule : IRpcModule
{
    ...
    [JsonRpcMethod(Description = "This method lets you run an sil_call within the context of the given block execution using the final state of parent block as the base. The block can be specified either by hash or by number. It takes the same input object as a sil_call. It returns the same output as debug_traceTransaction.", IsImplemented = true, IsSharable = false)]
