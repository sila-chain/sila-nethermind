...
public static class SubscriptionFactoryExtensions
{
    public static void RegisterNewHeadSubscription(
        ...
        IBlockForRpcFactory blockForRpcFactory
            ...
            SubscriptionType.SilSubscription.NewHeads,
    ...
    public static void RegisterLogsSubscription(
        ...
        ILogManager? logManager
            ...
            SubscriptionType.SilSubscription.Logs,
    ...
    public static void RegisterTransactionReceiptsSubscription(
        ...
        ILogManager? logManager
            ...
            SubscriptionType.SilSubscription.TransactionReceipts,
            (jsonRpcDuplexClient, filter) =>
    ...
    public static void RegisterNewPendingTransactionsSubscription(
        ...
        ILogManager? logManager
            ...
            SubscriptionType.SilSubscription.NewPendingTransactions,
            (jsonRpcDuplexClient, args) =>
    ...
    public static void RegisterDroppedPendingTransactionsSubscription(
        ...
        ILogManager? logManager
            ...
            SubscriptionType.SilSubscription.DroppedPendingTransactions,
            (jsonRpcDuplexClient) =>
    ...
    public static void RegisterSyncingSubscription(
        ...
        ILogManager? logManager
            ...
            SubscriptionType.SilSubscription.Syncing,
            (jsonRpcDuplexClient) =>
            new SyncingSubscription(jsonRpcDuplexClient, blockTree, silSyncingInfo, logManager)
            );
        ...
        )
    {
        ...
        subscriptionFactory.RegisterSyncingSubscription(blockTree, silSyncingInfo, logManager);
