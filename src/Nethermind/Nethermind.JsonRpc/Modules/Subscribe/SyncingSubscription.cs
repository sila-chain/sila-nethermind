...
namespace Nethermind.JsonRpc.Modules.Subscribe
{
    public class SyncingSubscription : Subscription
    {
            ...
            : base(jsonRpcDuplexClient)
        {
            ...
            _ethSyncingInfo = silSyncingInfo ?? throw new ArgumentNullException(nameof(silSyncingInfo));
        ...
        public override string Type => SubscriptionType.SilSubscription.Syncing;
