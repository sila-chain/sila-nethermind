...
namespace Nethermind.JsonRpc.Modules.Trace
{
        ...
        : ITraceRpcModule
    {
        ...
        /// fills in <see cref="BlockHeader.BaseFeePerGas"/> when activating SIP-1559 and
        /// <see cref="BlockHeader.ExcessBlobGas"/> when activating SIP-4844.
        /// </summary>
        /// <remarks>
        /// Known limitation: <c>WithdrawalsRoot</c> (SIP-4895), <c>ParentBeaconBlockRoot</c>
        /// (SIP-4788), and <c>RequestsHash</c> (SIP-7685) are not synthesized. When a block is
        ...
        /// <summary>
        /// Trace simulated blocks transactions (sil_simulateV1)
        /// </summary>
