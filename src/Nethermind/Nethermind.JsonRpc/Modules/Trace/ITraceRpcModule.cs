...
namespace Nethermind.JsonRpc.Modules.Trace
{
    ...
    public interface ITraceRpcModule : IRpcModule
    {
        ...
        [JsonRpcMethod(Description = "Traces a call to sil_sendRawTransaction without making the call, returning the traces",
            IsImplemented = true,
            IsSharable = false,
        ...
        ResultWrapper<IEnumerable<ParityTxTraceFromStore>> trace_block(
            ...
            [JsonRpcParameter(Description = "Optional fork name (e.g. \"Berlin\", \"SilaCancun\") to re-execute the block under. Must be one of the chain's named forks (see ISpecProvider AvailableForks). Default: the block's natural fork.")] string? fork = null);
