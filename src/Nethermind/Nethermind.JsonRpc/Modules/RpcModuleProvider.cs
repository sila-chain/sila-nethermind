...
namespace Nethermind.JsonRpc.Modules
{
    public class RpcModuleProvider : IRpcModuleProvider
    {
        ...
        [
            ...
            "sil_call", "sil_getBlockByNumber", "sil_chainId"
        ];
        ...
        public class ResolvedMethodInfo
        {
                ...
                RpcEndpoint availability)
            {
                ...
                for (int i = 0; i < parameters.Length; i++)
                {
                    ...
                    else
                    {
                        ...
                        JsonConverter converter = SilaJsonSerializer.JsonOptions.GetConverter(paramType);
            ...
            private static JsonTypeInfo? GetJsonTypeInfo(Type? payloadType)
            {
                ...
                SilaJsonSerializer.JsonOptions.TryGetTypeInfo(payloadType, out JsonTypeInfo? typeInfo);
                return typeInfo;
            }
