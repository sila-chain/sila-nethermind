...
public class XdcBaseFeeCalculatorTests
{
    ...
    [TestCase(false, 0L)]
    public void Calculate_ReturnsConstantBaseFeeOnlyWhenSip1559Enabled(bool isSip1559Enabled, long expectedBaseFee)
    {
        IReleaseSpec releaseSpec = ReleaseSpecSubstitute.Create();
        releaseSpec.IsSip1559Enabled.Returns(isSip1559Enabled);
