...
using Nethermind.Serialization.Rlp.Sip7928;
...
public class BalRecorderE2ETests
{
    ...
    private static IContainer CreateNode(string balDir, bool recording, bool replay)
    {
        ...
        ChainSpec spec = new ChainSpecFileLoader(new SilaJsonSerializer(), LimboLogs.Instance)
        ...
        spec.Allocations[TestItem.PrivateKeyA.Address] = new ChainSpecAllocation(300.Sila);
    ...
    {
        SilashChainSpecEngineParameters silashParams =
            spec.EngineChainSpecParametersProvider.GetChainSpecParameters<SilashChainSpecEngineParameters>();
        silashParams.HomesteadTransition = 0;
        silashParams.DaoHardforkTransition = null;
