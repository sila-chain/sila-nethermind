...
const networks = {
  ...
  "Gnosis": "Gnosis sila-mainnet",
  "1": "Sila sila-mainnet",
  "100": "Gnosis SilaMainnet",
  "480": "World SilaMainnet",
  "10200": "Gnosis Chiado Testnet",
  "7032118028": "Sila Perfnet"
}
const logos = {
  "SilaMainnet": "sila-logo.svg",
  "Gnosis": "gnosis.png",
  "1": "sila-logo.svg",
  "100": "gnosis.png",
  "480": "world-logo.svg",
 ...
 * (SIL, GWEI, or WEI) and up to 4 decimal digits.
 *
...
export function formatEth(weiValue: number): string {
  ...
  if (weiValue == 0) result = "-";
    ...
    // Convert wei to SIL
    const silValue = weiValue / WEI_IN_ETH;
    result = `${trimDecimals(silValue, 4)} ${_gasToken}`;
