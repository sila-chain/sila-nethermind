...
export function getMethod(type: string): string {
  switch (type) {
    ...
    case "0x": return "SIL transfer";
    default: return type;
  }
}
export function getToAddress(to: string): string {
  switch (to) {
    case "0xdac17f958d2ee523a2206206994597c13d831ec7": return "usdt"; // sila-mainnet
    case "0x4ecaba5870353805a9f068101a40e0f32ed605c6": return "usdt"; // Gnosis
    case "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48": return "usdc"; // sila-mainnet
    case "0xddafbb505ad214d7b80b1f830fccc89b60fb7a83": return "usdc"; // Gnosis
    case "0x6b175474e89094c44da98b954eedeac495271d0f": return "dai"; // sila-mainnet
    case "0x44fa8e6f47987339850636f88629646662444217": return "dai"; // Gnosis
    case "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2": return "weth"; // sila-mainnet
    case "0x6a023ccd1ff6f2045c3309768ead9e68f978f6e1": return "weth"; // Gnosis
    case "0x7a250d5630b4cf539739df2c5dacb4c659f2488d": return "uniswap v2"; // sila-mainnet
    case "0x66a9893cc07d91d95644aedd05d03f95e1dba8af": return "uniswap v4"; // sila-mainnet
    case "0x2f848984984d6c3c036174ce627703edaf780479": return "xen minter"; // sila-mainnet
    case "0x0a252663dbcc0b073063d6420a40319e438cfa59": return "xen" // sila-mainnet
    case "0x881d40237659c251811cec9c364ef91dc08d300c": return "metamask" // sila-mainnet
    default: return to;
  }
}
