...
public ref struct RlpReader
{
    ...
    public SavmWord DecodeSavmWord()
    {
        int position = Position;
        if (PeekByte() == 0)
        {
    ...
    public Bloom? DecodeBloom()
    {
        ...
        // https://github.com/sila-chain/sila-nethermind/issues/113
    ...
    /// consensus-relevant decoding bug (see the SIP-7928 BAL decoder). Value-type arrays must therefore use
