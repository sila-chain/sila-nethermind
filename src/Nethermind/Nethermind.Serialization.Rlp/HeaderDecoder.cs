...
namespace Nethermind.Serialization.Rlp
{
    ...
    public class HeaderDecoder() : RlpDecoder<BlockHeader>, IHeaderDecoder
    {
        ...
        /// The base implementation reads the Silash/PoS <c>mixHash</c> + <c>nonce</c> pair; consensus
        ...
        public override void Encode<TWriter>(ref TWriter writer, BlockHeader? header, RlpBehaviors rlpBehaviors = RlpBehaviors.None)
        {
            ...
            requiredItems[3] = header.BlobGasUsed is not null || header.ExcessBlobGas is not null; // SIP-4844: BlobGasUsed, ExcessBlobGas always encoded as a pair
        ...
        private int GetContentLength(BlockHeader? item, RlpBehaviors rlpBehaviors)
        {
            ...
            requiredItems[3] = item.BlobGasUsed is not null || item.ExcessBlobGas is not null; // SIP-4844: BlobGasUsed, ExcessBlobGas always encoded as a pair
