...
namespace Nethermind.Serialization.Rlp
{
    ...
    /// <summary>
    ///     https://github.com/sila-chain/wiki/wiki/RLP
    ///
    ...
    public partial class Rlp
    {
        ...
        public static Rlp Encode(Transaction transaction, bool forSigning, bool isSip155Enabled = false, ulong chainId = 0) =>
            TxDecoder.Instance.EncodeTx(transaction, RlpBehaviors.SkipTypedWrapping, forSigning, isSip155Enabled, chainId);
        ...
        public static int LengthOf(in SavmWord value)
        {
