...
namespace Nethermind.Serialization.Rlp.Sip7928;
...
public class AccountChangesDecoder : RlpDecoder<ReadOnlyAccountChanges>
{
    ...
    private static readonly RlpLimit _slotsLimit = new(Sip7928Constants.MaxSlots, "", ReadOnlyMemory<char>.Empty);
    private static readonly RlpLimit _storageLimit = new(Sip7928Constants.MaxSlots, "", ReadOnlyMemory<char>.Empty);
    private static readonly RlpLimit _txLimit = new(Sip7928Constants.MaxTxs, "", ReadOnlyMemory<char>.Empty);
