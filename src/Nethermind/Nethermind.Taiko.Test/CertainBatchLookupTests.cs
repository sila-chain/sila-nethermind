...
public class CertainBatchLookupTests
{
    ...
    /// <summary>
    /// Mirrors sil/taiko_api_backend_test.go TestLastCertainL1OriginByBatchID from taiko-geth PR #537.
    ...
    /// alethia-reth PR #177 filters_batch_lookup_results_below_network_threshold. On SilaMainnet,
    ...
    /// Any block id, including ones well below the SilaMainnet/Hoodi thresholds, must pass through.
    /// </summary>
