...
public class ConfigFilesTests : ConfigFileTestsBase
{
    ...
    [TestCase("sila-mainnet", "wss://ethstats.net/api")]
    ...
    {
        Test<ISilStatsConfig, bool>(configWildcard, static c => c.Enabled, false);
        Test<ISilStatsConfig, string>(configWildcard, static c => c.Server, host);
        Test<ISilStatsConfig, string>(configWildcard, static c => c.Secret, "secret");
        Test<ISilStatsConfig, string>(configWildcard, static c => c.Contact, "hello@nethermind.io");
    }
    ...
    [TestCase("sila-mainnet", "0xd4e56740f876aef8c010b86a40d5f56745a118d0906a34e69aec8c0db1cb8fa3")]
    ...
    [TestCase("*")]
    public void Sil_stats_disabled_by_default(string configWildcard) => Test<ISilStatsConfig, bool>(configWildcard, static c => c.Enabled, false);

    [TestCase("sila-mainnet archive", 4096000000UL)]
    [TestCase("sila-mainnet ^archive", 1024000000UL)]
    ...
    [TestCase("^sila-mainnet ^spaceneth ^volta ^energy ^poacore ^gnosis", 1024)]
    ...
    [TestCase("sila-mainnet", true)]
    [TestCase("sepolia", true)]
    [TestCase("hoodi", true)]
    [TestCase("chiado", true)]
    [TestCase("^spaceneth ^sila-mainnet ^gnosis ^sepolia ^hoodi ^chiado", false)]
    ...
    [TestCase("sila-mainnet", DiscoveryVersion.All)]
    ...
    [TestCase("^sila-mainnet ^validators ^archive", true, true)]
    [TestCase("sila-mainnet ^fast", false, false)]
    [TestCase("sila-mainnet fast", true, true)]
    ...
    [TestCase("archive", false)]
    [TestCase("sila-mainnet.json", true)]
...
#pragma warning restore CS0612
    ...
    [TestCase("^sila-mainnet ^gnosis ^sepolia", 0UL)]
    [TestCase("sila-mainnet ^archive", 15537394UL)]
    ...
    [TestCase("sila-mainnet", BlobsSupportMode.StorageWithReorgs)]
    [TestCase("gnosis", BlobsSupportMode.StorageWithReorgs)]
    [TestCase("^sepolia ^hoodi ^chiado ^sila-mainnet ^gnosis", BlobsSupportMode.Disabled)]
    ...
    [TestCase("sila-mainnet", 60_000_000UL)]
    [TestCase("sepolia", 60_000_000UL)]
    [TestCase("hoodi", 60_000_000UL)]
    [TestCase("^chiado ^gnosis ^sila-mainnet ^sepolia ^hoodi")]
