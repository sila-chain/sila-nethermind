...
namespace Nethermind.Runner.Test.Sila.Steps
{
    [TestFixture, Parallelizable(ParallelScope.All)]
    public class SilaStepsManagerTests
    {
        [Test]
        public async Task When_no_assemblies_defined()
        {
            await using IContainer container = CreateNethermindEnvironment();
            SilaStepsManager stepsManager = container.Resolve<SilaStepsManager>();
        ...
        private static ContainerBuilder CreateCommonBuilder(params IEnumerable<StepInfo> stepInfos)
        {
            ContainerBuilder builder = new ContainerBuilder()
                ...
                .AddSingleton(new SilaJsonSerializer())
                .Bind<IJsonSerializer, SilaJsonSerializer>()
                ...
                .AddSingleton<ISilaStepsLoader, SilaStepsLoader>()
                .AddSingleton<SilaStepsManager>()
                .AddSingleton<ILogManager>(LimboLogs.Instance);
