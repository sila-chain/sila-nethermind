...
public class StartupTests
{
        ...
        IJsonRpcLocalStats? jsonRpcLocalStats = null)
    {
        ...
        RpcModuleProvider moduleProvider = new(new RealFileSystem(), rpcConfig, new SilaJsonSerializer(), LimboLogs.Instance);
        moduleProvider.Register(new SingletonModulePool<IEngineRpcModule>(new SingletonFactory<IEngineRpcModule>(engineModule), true));

        SilaJsonSerializer jsonSerializer = new();
    ...
    [
        ...
        new TestCaseData("x\"\\\n\u0001", JsonSerializer.Serialize("x\"\\\n\u0001", SilaJsonSerializer.JsonOptions)).SetName("escaped string"),
