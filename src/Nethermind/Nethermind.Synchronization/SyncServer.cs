...
namespace Nethermind.Synchronization
{
    ...
    public class SyncServer : ISyncServer
    {
        ...
        public void AddNewBlock(Block block, ISyncPeer nodeWhoSentTheBlock)
        {
            ...
            // Also, note, Parity consistently sends invalid TotalDifficulty values both on Clique and SilaMainnet.
        ...
        private void ThrowOnInvalidBlock(Block block, ISyncPeer nodeWhoSentTheBlock)
        {
            ...
            throw new SilSyncException(message);
        }
        ...
        private bool ValidateSeal(Block block, ISyncPeer syncPeer)
        {
            ...
            // We hint validation range mostly to help silash to cache epochs.
        ...
        /// <summary>
        /// Code from AndreaLanfranchi - https://github.com/sila-chain/sila-nethermind/pull/2078
