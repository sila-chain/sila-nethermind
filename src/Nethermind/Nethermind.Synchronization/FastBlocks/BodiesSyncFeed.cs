...
namespace Nethermind.Synchronization.FastBlocks
{
    public class BodiesSyncFeed : BarrierSyncFeed<BodiesSyncBatch?>
    {
        ...
        private const ulong DefaultFlushDbInterval = 100000; // About every 10GB on sila-mainnet
        private readonly ulong _flushDbInterval; // About every 10GB on sila-mainnet
