...
namespace Nethermind.JsonRpc.Test.Data
{
    ...
    public class ReceiptsForRpcTests
    {
        ...
        public void Error_field_is_not_serialized()
        {
            ...
            string json = new SilaJsonSerializer().Serialize(receiptForRpc);
        ...
        public void Error_field_is_not_deserialized()
        {
            ...
            ReceiptForRpc? receiptForRpc = new SilaJsonSerializer().Deserialize<ReceiptForRpc>(json);
        ...
        private static string SerializeReceipt(TxReceipt receipt)
            => new SilaJsonSerializer(new JsonConverter[] { new TxReceiptConverter() }).Serialize(receipt);
    }
}
