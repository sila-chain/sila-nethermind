...
namespace Nethermind.JsonRpc.Test.Data
{
    ...
    public class BlockParameterConverterTests : SerializationTestBase
    {
        ...
        public void SetUp()
        {
            ...
            SilaJsonSerializer.StrictHexFormat = false;
        }
        ...
        {
            IJsonSerializer serializer = new SilaJsonSerializer();
        ...
        {
            bool original = SilaJsonSerializer.StrictHexFormat;
            try
            {
                SilaJsonSerializer.StrictHexFormat = true;
                IJsonSerializer serializer = new SilaJsonSerializer();
            ...
            {
                SilaJsonSerializer.StrictHexFormat = original;
            }
        }
