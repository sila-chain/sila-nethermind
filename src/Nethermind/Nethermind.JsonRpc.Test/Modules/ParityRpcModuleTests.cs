...
namespace Nethermind.JsonRpc.Test.Modules
{
    ...
    public class ParityRpcModuleTests
    {
        ...
        private SilaEcdsa _silaEcdsa = null!;
...
#pragma warning restore NUnit1032
        ...
        public void Initialize()
        {
            ...
            _silaEcdsa = new(specProvider.ChainId);
            ...
            _txPool = new TxPool.TxPool(_silaEcdsa,
                new BlobTxStorage(),
            ...
            ulong blockNumber = 2;
            Transaction pendingTransaction = Build.A.Transaction.Signed(_silaEcdsa, TestItem.PrivateKeyD, false)
            ...
            blockNumber = 1;
            Transaction transaction1 = Build.A.Transaction.Signed(_silaEcdsa, TestItem.PrivateKeyD, false)
            ...
            Transaction transaction2 = Build.A.Transaction.Signed(_silaEcdsa, TestItem.PrivateKeyD, false)
                .WithSenderAddress(Address.FromNumber((UInt256)blockNumber))
                .WithNonce(120).TestObject;
            transaction2.Signature!.V = 37;

            Transaction transaction3 = Build.A.Transaction.Signed(_silaEcdsa, TestItem.PrivateKeyD, false)
                .WithSenderAddress(Address.FromNumber((UInt256)blockNumber))
        ...
        private static Peer SetUpPeerA()
        {
            ...
            peer.OutSession.TryGetProtocolHandler(Protocol.Sil, out Arg.Any<IProtocolHandler>()).Returns(x =>
            {
                x[1] = protocolHandler;
                return true;
            });
            ...
            {
                p2PHandler.AgreedCapabilities.Returns(new List<Capability> { new("sil", 65), new("sil", 64) });
            }
        ...
        private IParityRpcModule CreateParityRpcModule(IPeerManager? peerManager = null) => new ParityRpcModule(_silaEcdsa,
                _txPool,
                _blockTree,
                _receiptStorage,
        ...
        public async Task parity_netPeers_standard_case()
        {
            ...
            string expectedResult = string.Concat("{\"jsonrpc\":\"2.0\",\"result\":{\"active\":3,\"connected\":5,\"max\":15,\"peers\":[{\"id\":\"", TestItem.PublicKeyA, "\",\"name\":\"Geth/v1.9.21-stable/linux-amd64/go1.15.2\",\"caps\":[\"sil/65\",\"sil/64\"],\"network\":{\"localAddress\":\"127.0.0.1\",\"remoteAddress\":\"Handshake\"},\"protocols\":{\"sil\":{\"version\":65,\"difficulty\":\"0x5ea4ed\",\"head\":\"", TestItem.KeccakA, "\"}}},{\"name\":\"Geth/v1.9.26-unstable/linux-amd64/go1.15.6\",\"caps\":[],\"network\":{\"localAddress\":\"95.217.106.25\"},\"protocols\":{\"sil\":{\"version\":0,\"difficulty\":\"0x0\"}}},{\"id\":\"", TestItem.PublicKeyB, "\",\"caps\":[],\"network\":{\"remoteAddress\":\"Handshake\"},\"protocols\":{\"sil\":{\"version\":0,\"difficulty\":\"0x0\"}}}]},\"id\":67}");
            Assert.That(serialized, Is.EqualTo(expectedResult));
        }
