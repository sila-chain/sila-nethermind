...
public class SilSimulateTestsSimplePrecompiles : SilRpcSimulateTestsBase
{
    /* Compiled contract
    ...
    */
    ...
    /// </summary>
    [Test]
    public async Task Test_eth_simulate_src()
    {
        ...
        Signature signature = chain.SilaEcdsa.Sign(TestItem.PrivateKeyA, in messageHash);
