...
public partial class SilRpcModuleTests
{
    ...
    [TestCase(
        ...
        "header not found")]
    public async Task Sil_estimateGas_returns_geth_compatible_error_for_missing_block(string blockId, string expectedMessage)
    {
        ...
        string serialized = await ctx.Test.TestEthRpc("sil_estimateGas", transaction, blockId);
