...
namespace Nethermind.JsonRpc.Test.Modules
{
    public class TestRpcBlockchain : TestBlockchain
    {
        ...
        public ISilRpcModule SilRpcModule { get; private set; } = null!;
        ...
        public class Builder<T>(T blockchain) where T : TestRpcBlockchain
        {
            ...
            public Builder<T> WithEthRpcModule(Func<TestRpcBlockchain, ISilRpcModule> builder)
            {
        ...
        private Func<TestRpcBlockchain, ISilRpcModule> _ethRpcModuleBuilder = static @this => new SilRpcModule(
            @this.RpcConfig,
            @this.Bridge,
            @this.BlockFinder,
            @this.BlockTree,
            ...
            @this.SpecProvider,
            @this.GasPriceOracle,
            new SilSyncingInfo(@this.BlockTree, Substitute.For<ISyncPointers>(), @this.Container.Resolve<ISyncConfig>(),
        ...
        protected override async Task<TestBlockchain> Build(Action<ContainerBuilder>? configurer = null)
        {
            ...
            SilaJsonSerializer.StrictHexFormat = RpcConfig.StrictHexFormat;
            ...
            TxSender ??= new TxPoolSender(TxPool, TxSealer, NonceManager, SilaEcdsa ?? new SilaEcdsa(SpecProvider.ChainId));
            GasPriceOracle ??= new GasPriceOracle(BlockFinder, SpecProvider, LogManager);
            ...
            SilRpcModule = _ethRpcModuleBuilder(this);
        ...
        public override void Dispose()
        {
            ...
            finally
            {
                ...
                {
                    SilaJsonSerializer.StrictHexFormat = previousStrictHexFormat;
        ...
        public Task<string> TestEthRpc(string method, params object?[]? parameters) =>
            RpcTest.TestSerializedRequest(SilRpcModule, method, parameters);
