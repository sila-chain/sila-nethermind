...
{
    private readonly IJsonSerializer _serializer = new SilaJsonSerializer();
    ...
    [
        ...
        .. SIP1559TransactionForRpcTests.Transactions,
    ...
    [TestCase("""{"maxFeePerGas":"0x1","maxPriorityFeePerGas":"0x1"}""", typeof(SIP1559TransactionForRpc))]
    ...
    public void Serialized_JSON_satisfies_schema(Transaction transaction)
    {
        ...
        switch (transaction.Type)
        {
            ...
            case TxType.AccessList:
                ...
                break;
            case TxType.SIP1559:
                SIP1559TransactionForRpcTests.ValidateSchema(json);
                break;
            case TxType.Blob:
