...
public static class SIP1559TransactionForRpcTests
{
    private static TransactionBuilder<Transaction> Build => Core.Test.Builders.Build.A.Transaction.WithType(TxType.SIP1559);
    ...
    [
        ...
        Build.WithChainId(BlockchainIds.SilaMainnet).TestObject,
        Build.WithChainId(BlockchainIds.SilaSepolia).TestObject,
