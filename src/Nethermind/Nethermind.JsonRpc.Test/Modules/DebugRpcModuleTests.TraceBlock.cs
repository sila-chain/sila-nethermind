...
public partial class DebugRpcModuleTests
{
    ...
    {
        using Context context = await Context.Create(new TestSingleReleaseSpecProvider(SilaOsaka.Instance));
    ...
    private static Transaction[] CreateTraceBlockTransactions(TestRpcBlockchain blockchain)
    {
        ...
        byte[] contract = Prepare.SavmCode
            .PushData(0)
            .PushData(32)
        ...
        byte[] deployment = Prepare.SavmCode
    ...
    public async Task GethLikeTxTraceStreamingResult_WriteToAsync_produces_same_json_as_serializer(int traceCount)
    {
        ...
        string stjJson = JsonSerializer.Serialize(result, SilaJsonSerializer.JsonOptions);
