...
{
    [TestCase("http://127.0.0.1:1234|http|sil;web3;net", "http", "127.0.0.1", 1234, RpcEndpoint.Http, new string[] { "sil", "web3", "net" })]
    [TestCase("http://0.0.0.0|ws|sil ;web3; net", "http", "0.0.0.0", 80, RpcEndpoint.Ws, new string[] { "sil", "web3", "net" })]
    [TestCase("https://localhost:9876|HTTpS; wSs|sil;Web3;NET", "https", "localhost", 9876, RpcEndpoint.Http | RpcEndpoint.Ws, new string[] { "sil", "web3", "net" })]
