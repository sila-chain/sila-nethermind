...
internal class ForensicsProcessor(IBlockTree blockTree, IEpochSwitchManager epochSwitchManager, ILogManager logManager) : IForensicsProcessor
{
    ...
    private static readonly SilaEcdsa _silaEcdsa = new(0);
    ...
    private IReadOnlyList<string> GetQcSignerAddresses(QuorumCertificate quorumCert)
    {
        ...
        {
            Address signer = _silaEcdsa.RecoverAddress(signatures[i], in signHash);
    ...
    private bool TryGetVoteSigner(Vote vote, out Address signer)
    {
        ...
        signer = _silaEcdsa.RecoverAddress(vote.Signature, in signHash);
        vote.Signer = signer;
        return true;
    }
    ...
    internal Task SendForensicProof(QuorumCertificate firstQc, QuorumCertificate secondQc)
    {
        ...
        ForensicProof forensicsProof = new()
        {
            ...
            ForensicsType = "QC",
            Content = JsonSerializer.Serialize(content, SilaJsonSerializer.JsonOptions)
        };
