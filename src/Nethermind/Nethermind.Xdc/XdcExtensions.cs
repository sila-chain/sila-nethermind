...
internal static partial class XdcExtensions
{
    ...
    public static Signature Sign(this ISilaEcdsa ecdsa, PrivateKey privateKey, XdcBlockHeader header)
    {
    ...
    public static Address RecoverVoteSigner(this ISilaEcdsa ecdsa, Vote vote)
    {
        KeccakRlpWriter writer = new();
