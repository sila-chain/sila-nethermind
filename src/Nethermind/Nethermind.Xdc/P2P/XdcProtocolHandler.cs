...
internal class XdcProtocolHandler(
    ...
    ITxGossipPolicy? transactionsGossipPolicy = null) : Sil63ProtocolHandler(session, serializer, nodeStatsManager, syncServer, backgroundTaskScheduler, txPool, gossipPolicy, logManager, transactionsGossipPolicy), IStaticProtocolInfo
{
