...
{
    /// <summary>
    /// https://github.com/sila-chain/wiki/wiki/Sila-Chain-Spec-Format
    /// https://opensila.github.io/Chain-specification
    /// </summary>
    ...
    public class ChainSpec
    {
        ...
        /// <c>sila</c> one, keyed by engine name. Applied to <see cref="Genesis"/> by the owning
