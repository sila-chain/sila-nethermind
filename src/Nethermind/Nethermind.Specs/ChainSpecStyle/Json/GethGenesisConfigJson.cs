...
/// <summary>
/// Represents the config object in a Geth-style genesis.json file as defined in SIP-7949.
/// </summary>
/// <remarks>
...
/// <see cref="HardforkLabels.ExpandAll"/> can fan timestamps and blocks into the per-SIP
...
/// merge-netsplit / SilaParis, Dao-fork / Dao, Bpo / BPO casing) pass an explicit override.
/// Per-SIP overrides (<c>Sip150Block</c>, <c>Sip155Block</c>, <c>Sip158Block</c>) are NOT routed —
/// they're SIP-level fallbacks consumed inline by <c>GethGenesisLoader</c>.
/// </remarks>
public class GethGenesisConfigJson : IHasNamedForks
{
    ...
    // SIP-level overrides — not fork labels, kept as plain typed properties.
    public ulong? Sip150Block { get; set; }
    public ulong? Sip155Block { get; set; }
    public ulong? Sip158Block { get; set; }
    ...
    public ulong? MergeNetsplitBlock { get => GetBlock(nameof(SilaParis)); set => SetBlock(value, nameof(SilaParis)); }
