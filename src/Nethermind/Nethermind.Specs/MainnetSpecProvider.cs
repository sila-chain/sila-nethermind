...
public class MainnetSpecProvider : ForkScheduleSpecProvider
{
    ...
    public MainnetSpecProvider() : this(new ForkSchedule
    {
        ...
        [ParisBlockNumber] = SilaParis.Instance,
        [ShanghaiBlockTimestamp] = SilaShanghai.Instance,
        [CancunBlockTimestamp] = SilaCancun.Instance,
        [PragueBlockTimestamp] = SilaPrague.Instance,
        [OsakaBlockTimestamp] = SilaOsaka.Instance,
        [BPO1BlockTimestamp] = BPO1.Instance,
        [BPO2BlockTimestamp] = BPO2.Instance,
        [AmsterdamBlockTimestamp] = SilaAmsterdam.Instance,
    })
    { }
    ...
    public override ulong NetworkId => Core.BlockchainIds.SilaMainnet;
