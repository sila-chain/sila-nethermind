...
public class EngineRpcCapabilitiesProvider(ISpecProvider specProvider) : IRpcCapabilitiesProvider
{
    ...
    {
        bool preCancun = !spec.IsSip4844Enabled;
        ...
        // SilaCancun
        Configure(nameof(IEngineRpcModule.engine_getPayloadV3), SszRestPaths.GetPayloads, GateWithWarn(spec.IsSip4844Enabled));
        Configure(nameof(IEngineRpcModule.engine_forkchoiceUpdatedV3), SszRestPaths.PostForkchoice, GateWithWarn(spec.IsSip4844Enabled));
        Configure(nameof(IEngineRpcModule.engine_newPayloadV3), SszRestPaths.PostPayloads, GateWithWarn(spec.IsSip4844Enabled));
        Configure(nameof(IEngineRpcModule.engine_getBlobsV1), SszRestPaths.PostBlobsV1, Gate(spec.IsSip4844Enabled));
        ...
        // SilaOsaka
        Configure(nameof(IEngineRpcModule.engine_getPayloadV5), SszRestPaths.GetPayloads, GateWithWarn(spec.IsSip7594Enabled));
        Configure(nameof(IEngineRpcModule.engine_getBlobsV2), SszRestPaths.PostBlobsV2, Gate(spec.IsSip7594Enabled));
        Configure(nameof(IEngineRpcModule.engine_getBlobsV3), SszRestPaths.PostBlobsV3, Gate(spec.IsSip7594Enabled));
        Configure(nameof(IEngineRpcModule.engine_getBlobsV4), SszRestPaths.PostBlobsV4, Gate(spec.IsSip7594Enabled));

        // SilaAmsterdam
        Configure(nameof(IEngineRpcModule.engine_getPayloadV6), SszRestPaths.GetPayloads, GateWithWarn(spec.IsSip7928Enabled));
        Configure(nameof(IEngineRpcModule.engine_newPayloadV5), SszRestPaths.PostPayloads, GateWithWarn(spec.IsSip7928Enabled));
        Configure(nameof(IEngineRpcModule.engine_forkchoiceUpdatedV4), SszRestPaths.PostForkchoice, GateWithWarn(spec.IsSip7843Enabled));
        Configure(nameof(IEngineRpcModule.engine_getPayloadBodiesByHashV2), SszRestPaths.PostBodiesByHash, GateWithWarn(spec.IsSip7928Enabled));
        Configure(nameof(IEngineRpcModule.engine_getPayloadBodiesByRangeV2), SszRestPaths.GetBodiesByRange, GateWithWarn(spec.IsSip7928Enabled));
        Configure(nameof(IEngineRpcModule.engine_newPayloadWithWitness), SszRestPaths.PostPayloadsWitness, GateWithWarn(spec.IsSip7928Enabled));
