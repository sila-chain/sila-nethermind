...
/// <see href="https://github.com/sila-chain/execution-apis/blob/main/src/engine/shanghai.md#engine_forkchoiceupdatedv2">
/// SilaShanghai</see> specification.
/// </summary>
/// <remarks>
    ...
    ILogManager logManager) : IForkchoiceUpdatedHandler
{
    ...
    /// <see href="https://github.com/sila-chain/execution-apis/pull/786">execution-apis#786</see>:
    ...
    private async Task<ResultWrapper<ForkchoiceUpdatedV1Result>?> ApplyForkchoiceUpdate(BlockHeader? newHeadHeader, ForkchoiceStateV1 forkchoiceState, PayloadAttributes? payloadAttributes)
    {
        ...
        if ((newHeadHeader.TotalDifficulty ?? 0) != 0 && (_poSSwitcher.MisconfiguredTerminalTotalDifficulty() || _poSSwitcher.BlockBeforeTerminalTotalDifficulty(newHeadHeader)))
        {
            ...
            // https://github.com/sila-chain/execution-apis/blob/main/src/engine/specification.md#specification
    ...
    // (https://github.com/sila-chain/execution-apis/blob/main/src/engine/paris.md#specification-1).
