...
/// <summary>
/// Advertises the post-merge sil/69, sil/70 and sil/71 capabilities once the node is operating post-merge —
...
public class MergeP2PCapabilityResolver : IP2PCapabilityResolver, IDisposable
{
    ...
    public void Resolve(ISet<Capability> capabilities)
    {
        ...
        capabilities.Add(new Capability(Protocol.Sil, 69));
        capabilities.Add(new Capability(Protocol.Sil, 70));
        capabilities.Add(new Capability(Protocol.Sil, 71));
    }
