...
public class ExecutionPayload : IForkValidator, IExecutionPayloadParams, IExecutionPayloadFactory<ExecutionPayload>
{
    ...
    /// <see href="https://sips.sila.org/SIPS/sip-2718">SIP-2718</see>.
    /// </summary>
    ...
    /// <see href="https://sips.sila.org/SIPS/sip-7685">SIP-7685</see>.
    /// </summary>
    [JsonIgnore]
    ...
    /// <see href="https://sips.sila.org/SIPS/sip-4844">SIP-4844</see>.
    /// </summary>
    ...
    /// <see href="https://sips.sila.org/SIPS/sip-7928">SIP-7928</see>.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    /// <see href="https://sips.sila.org/SIPS/sip-7843">SIP-7843</see>.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    /// <see href="https://sips.sila.org/SIPS/sip-4788">SIP-4788</see>.
    /// </summary>
    [JsonIgnore]
    ...
    public virtual bool ValidateFork(ISpecProvider specProvider) =>
        !specProvider.GetSpec(BlockNumber, Timestamp).IsSip4844Enabled;
}
