...
public class ExecutionProcessorTests
{
    ...
    private static readonly Address DepositContractAddress = Sip6110Constants.MainnetDepositContractAddress;
    private static readonly Address sip7002Account = Sip7002Constants.WithdrawalRequestPredeployAddress;
    private static readonly Address sip7251Account = Sip7251Constants.ConsolidationRequestPredeployAddress;
    ...
    public void Setup()
    {
        ...
        _stateProvider.CreateAccount(sip7002Account, AccountBalance);
        _stateProvider.CreateAccount(sip7251Account, AccountBalance);

        _stateProvider.InsertCode(sip7002Account, Sip7002TestConstants.CodeHash, Sip7002TestConstants.Code, SilaPrague.Instance);
        _stateProvider.InsertCode(sip7251Account, Sip7251TestConstants.CodeHash, Sip7251TestConstants.Code, SilaPrague.Instance);
        ...
        _spec.Sip7002ContractAddress.Returns(sip7002Account);
        _spec.Sip7251ContractAddress.Returns(sip7251Account);
        ...
        _transactionProcessor.Execute(Arg.Any<Transaction>(), Arg.Any<CallOutputTracer>())
            .Returns(ci =>
            {
                ...
                if (transaction.To == sip7002Account)
                {
                ...
                else if (transaction.To == sip7251Account)
                {
