...
public record SlowBlockLogEntry
{
    ...
    [JsonPropertyName("savm")] public SavmInfo Savm { get; init; } = new();
    ...
    public record TimingInfo
    {
        ...
        [JsonPropertyName("savm_ms")] public double SavmMs { get; init; }
    ...
    public record StateWritesInfo
    {
        ...
        [JsonPropertyName("code")] public long Code { get; init; }
        [JsonPropertyName("code_bytes")] public long CodeBytes { get; init; }
        [JsonPropertyName("sip7702_delegations_set")] public long Sip7702DelegationsSet { get; init; }
        [JsonPropertyName("sip7702_delegations_cleared")] public long Sip7702DelegationsCleared { get; init; }
    }
