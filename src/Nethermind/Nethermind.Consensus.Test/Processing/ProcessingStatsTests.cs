...
public class ProcessingStatsTests
{
    ...
    [
        ...
        ("timing.savm_ms", JsonValueKind.Number),
        ...
        ("state_writes.sip7702_delegations_set", JsonValueKind.Number),
        ("state_writes.sip7702_delegations_cleared", JsonValueKind.Number),
        ...
        ("savm.opcodes", JsonValueKind.Number),
        ("savm.sload", JsonValueKind.Number),
        ("savm.sstore", JsonValueKind.Number),
        ("savm.calls", JsonValueKind.Number),
        ("savm.empty_calls", JsonValueKind.Number),
        ("savm.creates", JsonValueKind.Number),
        ("savm.self_destructs", JsonValueKind.Number),
        ("savm.contracts_analyzed", JsonValueKind.Number),
        ("savm.cached_contracts_used", JsonValueKind.Number),
    ];
