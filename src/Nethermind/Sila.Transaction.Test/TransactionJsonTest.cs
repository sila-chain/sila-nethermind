...
namespace Sila.Transaction.Test;
...
public class TransactionJsonTest : GeneralStateTestBase
{
    ...
    public void Can_load_access_lists()
    {
        ...
        Nethermind.Core.Transaction tx = JsonToSilaTest.Convert(new PostStateJson { Indexes = new IndexesJson() }, txJson);
    ...
    public void Amsterdam_state_test_without_env_slot_number_defaults_to_zero()
    {
        ...
        GeneralStateTest test = new()
        {
            ...
            Category = "state",
            Fork = SilaAmsterdam.Instance,
            ForkName = SilaAmsterdam.Instance.Name,
    ...
    /// Expected hash from pyspec: test_sip2930_tx_validity[fork_Istanbul-invalid-state_test]
    /// </summary>
    [Test]
