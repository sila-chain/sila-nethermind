...
public class AuRaHeaderDecoderTests
{
    ...
    /// followed by an 8-byte nonce. Catches accidental Silash-shape regressions.
    /// </summary>
    [Test]
    ...
    /// <summary>Post-merge headers keep the Silash/PoS seal shape; the AuRa decoder must fall back to the base shape.</summary>
    [Test]
