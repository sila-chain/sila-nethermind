...
contract TxPermission {
    ...
    /// included into a block. See https://opensila.github.io/Permissioning.html#how-it-works-1
    ...
    /// @param _maxFeePerGas The `maxFeePerGas` in Wei for SIP-1559 transaction, or gas price for a legacy transaction.
    /// @param _maxInclusionFeePerGas The `maxInclusionFeePerGas` in Wei for SIP-1559 transaction.
    ...
    /// 0x01 - basic transaction (e.g. sila transferring to user wallet);
    /// 0x02 - contract call;
