...
public class ChainSpecLoaderTest
{
    ...
    public void Can_load_gnosis()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.That(chainSpec.Parameters.Sip2565Transition, Is.EqualTo(berlinGnosisBlockNumber));
            Assert.That(chainSpec.Parameters.Sip2929Transition, Is.EqualTo(berlinGnosisBlockNumber));
            Assert.That(chainSpec.Parameters.Sip2930Transition, Is.EqualTo(berlinGnosisBlockNumber));
    ...
    public void Can_load_posdao_with_rewriteBytecode()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            // Therefore Sip2565Transition should be null
            Assert.That(chainSpec.Parameters.Sip2565Transition, Is.Null);
        }
    }
