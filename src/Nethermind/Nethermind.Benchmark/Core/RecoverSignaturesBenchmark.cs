...
namespace Nethermind.Benchmarks.Core
{
    ...
    public class RecoverSignaturesBenchmark
    {
        ...
        private static SilaEcdsa _silaEcdsa;
        ...
        {
            _silaEcdsa = new(_specProvider.ChainId);
            _sut = new(_silaEcdsa, _specProvider, NullLogManager.Instance);
            ...
            static AuthorizationTuple CreateAuthorizationTuple(PrivateKey signer, ulong chainId, Address codeAddress, ulong nonce)
            {
                ...
                Signature sig = _silaEcdsa.Sign(signer, writer.GetValueHash());
