...
/// sila-mainnet block (~2k accounts, ~10k slots over ~200 contracts, ~5x that in trie nodes) with a shared hot-key
...
public class SnapshotCompactionBenchmark
{
    ...
    // lifecycle and exsrcising the NoResizeClear array reuse across compactions.
    [Benchmark]
    public int Compact()
    {
