...
namespace Nethermind.Network.Discovery.Test.Discv4
{
    ...
    [TestFixture]
    public class SIP8DiscoveryTests
    {
        ...
        public SIP8DiscoveryTests() => _messageSerializationService = Build.A.SerializationService().WithDiscovery(_privateKey).TestObject;
