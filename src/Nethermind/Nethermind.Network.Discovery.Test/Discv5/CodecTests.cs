...
public class CodecTests
{
    ...
    [Test]
    public void PacketCodec_Decodes_WhoAreYou_GoSila_Vector()
    {
    ...
    [TestCase(
        ...
        true)]
    public void PacketCodec_Decodes_PingHandshake_GoSila_Vectors(
        string packetHex,
    ...
    {
        using TalkReqMsg message = new([0, 0, 0, 3], "sil"u8.ToArray(), new byte[] { 1, 2, 3, 4 });
