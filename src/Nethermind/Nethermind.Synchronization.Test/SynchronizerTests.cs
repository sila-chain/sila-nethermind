...
[TestFixture(SynchronizerType.Sil2MergeFull)]
[TestFixture(SynchronizerType.Sil2MergeFast)]
[TestFixture(SynchronizerType.Sil2MergeFastWithoutTTD)]
[TestFixture(SynchronizerType.Sil2MergeFullWithoutTTD)]
...
public class SynchronizerTests(SynchronizerType synchronizerType)
{
        ...
        public SyncingContext(SynchronizerType synchronizerType, bool useMaxRequestLimits = false)
        {
            ISyncConfig GetSyncConfig() =>
                synchronizerType switch
                {
                    ...
                    SynchronizerType.Sil2MergeFastWithoutTTD => SyncConfig.WithFastSync,
                    SynchronizerType.Sil2MergeFullWithoutTTD => SyncConfig.WithFullSyncOnly,
                    SynchronizerType.Sil2MergeFast => SyncConfig.WithFastSync,
                    SynchronizerType.Sil2MergeFull => SyncConfig.WithFullSyncOnly,
    ...
    private static bool IsMerge(SynchronizerType synchronizerType) =>
        synchronizerType switch
        {
            SynchronizerType.Sil2MergeFast or SynchronizerType.Sil2MergeFull
                or SynchronizerType.Sil2MergeFastWithoutTTD or SynchronizerType.Sil2MergeFullWithoutTTD
                => true,
            _ => false
        };
    ...
    private static bool WithTTD(SynchronizerType synchronizerType) =>
        synchronizerType switch
        {
            SynchronizerType.Sil2MergeFast or SynchronizerType.Sil2MergeFull => true,
            _ => false
        };
