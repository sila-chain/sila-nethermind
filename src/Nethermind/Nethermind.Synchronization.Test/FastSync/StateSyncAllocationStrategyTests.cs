...
public class StateSyncAllocationStrategyTests
{
    ...
    [TestCase(SilVersions.Sil67, true, ExpectedResult = true)]
    [TestCase(SilVersions.Sil66, false, ExpectedResult = true)]
    [TestCase(SilVersions.Sil67, false, ExpectedResult = false)]
    public bool Can_allocate_node(int silVersion, bool hasSnap) =>
        IsNodeAllocated(silVersion, hasSnap);
