...
namespace Nethermind.Synchronization.Test.FastSync
{
        ...
        : StateSyncFeedTestsBase(defaultPeerCount: peerCount, defaultPeerMaxRandomLatency: maxNodeLatency)
    {
        ...
        public async Task Can_download_with_moving_target((string Name, Action<StateTree, ITrieStore, IDb> SetupTree) testCase)
        {
            ...
            remote.StateTree.Set(TestItem.AddressA, TrieScenarios.AccountJustState0.WithChangedBalance(123.Sila));
            remote.StateTree.Set(TestItem.AddressB, TrieScenarios.AccountJustState1.WithChangedBalance(123.Sila));
            remote.StateTree.Set(TestItem.AddressC, TrieScenarios.AccountJustState2.WithChangedBalance(123.Sila));
