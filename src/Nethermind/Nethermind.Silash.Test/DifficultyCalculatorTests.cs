...
namespace Nethermind.Silash.Test
{
    public class DifficultyCalculatorTests
    {
        ...
        public void Calculate_should_returns_expected_results()
        {
            ...
            releaseSpec.IsSip2Enabled.Returns(true);
            releaseSpec.IsSip100Enabled.Returns(true);
            releaseSpec.IsTimeAdjustmentPostOlympic.Returns(true);
            ISpecProvider specProvider = Substitute.For<ISpecProvider>();
            specProvider.GetSpec(Arg.Any<ForkActivation>()).Returns(releaseSpec);
            SilashDifficultyCalculator difficultyCalculator = new(specProvider);
        ...
        [TestCase(9000000UL + SilashDifficultyCalculator.InitialDifficultyBombBlock + 1)]
        [TestCase(9000000UL + SilashDifficultyCalculator.InitialDifficultyBombBlock + 3)]
        [TestCase(9000000UL + SilashDifficultyCalculator.InitialDifficultyBombBlock + 730000)]
        ...
        // previous difficulty bomb +  InitialDifficultyBombBlock + offset
        [TestCase(9700000UL + SilashDifficultyCalculator.InitialDifficultyBombBlock + 1)]
        [TestCase(9700000UL + SilashDifficultyCalculator.InitialDifficultyBombBlock + 3)]
        [TestCase(9700000UL + SilashDifficultyCalculator.InitialDifficultyBombBlock + 730000)]
        ...
        // previous difficulty bomb +  InitialDifficultyBombBlock + offset
        [TestCase(10700000UL + SilashDifficultyCalculator.InitialDifficultyBombBlock + 1)]
        [TestCase(10700000UL + SilashDifficultyCalculator.InitialDifficultyBombBlock + 3)]
        [TestCase(10700000UL + SilashDifficultyCalculator.InitialDifficultyBombBlock + 730000)]
            ...
            ulong blocksAbove, IReleaseSpec firstHardfork, IReleaseSpec secondHardfork)
        {
            ...
            SilashDifficultyCalculator firstHardforkDifficultyCalculator = new(firstHardForkSpecProvider);
            ...
            SilashDifficultyCalculator secondHardforkDifficultyCalculator = new(secondHardforkSpecProvider);
