...
public class SIP1559ParametersTests
{
    private static IEnumerable<(string hexString, SIP1559Parameters expected)> DecodeBlockHeaderParametersCases()
    {
        // V0
    ...
    public void DecodeBlockHeaderParameters((string HexString, SIP1559Parameters Expected) testCase)
    {
        ...
        {
            Assert.That(blockHeader.TryDecodeSIP1559Parameters(out SIP1559Parameters decoded, out _), Is.True);
