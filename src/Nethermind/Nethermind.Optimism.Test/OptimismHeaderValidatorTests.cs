...
public class OptimismHeaderValidatorTests(Fork fork)
{
    ...
    private static IEnumerable<(string data, Valid isValid)> SIP1559ParametersExtraData => new (string data, Valid isValid)[]
    {
    ...
    [TestCaseSource(nameof(SIP1559ParametersExtraData))]
    public void Validates_SIP1559Parameters_InExtraData((string hexString, Valid isValid) testCase)
    {
