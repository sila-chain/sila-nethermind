...
{
    private readonly List<Sil66Message<GetBlockHeadersMessage>> _recordedRequests = [];
    private MessageDictionary<Sil66Message<GetBlockHeadersMessage>, IOwnedReadOnlyList<BlockHeader>>
    ...
    {
        Request<Sil66Message<GetBlockHeadersMessage>, IOwnedReadOnlyList<BlockHeader>> request = CreateRequest(111);
    ...
    {
        Request<Sil66Message<GetBlockHeadersMessage>, IOwnedReadOnlyList<BlockHeader>> requestBefore = CreateRequest(112);
        Request<Sil66Message<GetBlockHeadersMessage>, IOwnedReadOnlyList<BlockHeader>> request = CreateRequest(111);
    ...
    {
        MessageDictionary<Sil66Message<GetBlockHeadersMessage>, (IDisposable, long)> dictionary = new(RecordingProtocolHandler.Create<Sil66Message<GetBlockHeadersMessage>>());
    ...
    private static Request<Sil66Message<GetBlockHeadersMessage>, IOwnedReadOnlyList<BlockHeader>> CreateRequest(int requestId)
    {
        Request<Sil66Message<GetBlockHeadersMessage>, IOwnedReadOnlyList<BlockHeader>> request =
            new(new Network.P2P.Subprotocols.Sil.V66.Messages.GetBlockHeadersMessage(requestId,
