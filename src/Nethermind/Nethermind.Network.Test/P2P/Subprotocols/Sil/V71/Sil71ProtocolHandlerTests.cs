...
namespace Nethermind.Network.Test.P2P.Subprotocols.Sil.V71;

public class Sil71ProtocolHandlerTests
{
    ...
    private Sil71ProtocolHandler _handler = null!;
    ...
    public void Setup()
    {
        ...
        _handler = new Sil71ProtocolHandler(
            _session,
            _svc,
    ...
    public void Metadata_correct()
    {
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.That(_handler.Name, Is.EqualTo("sil71"));
        ...
        byte[]?[] expectedBlockAccessLists)
    {
        ...
        HandleZeroMessage(request, Sil71MessageCode.GetBlockAccessLists);
    ...
    public async Task Can_request_and_handle_block_access_lists(bool viaSyncPeerInterface)
    {
        ...
        HandleZeroMessage(response!, Sil71MessageCode.BlockAccessLists);
    ...
    public void Should_throw_when_receiving_unrequested_block_access_lists()
    {
        ...
        HandleIncomingStatusMessage();
        Assert.Throws<SubprotocolException>(() => HandleZeroMessage(msg, Sil71MessageCode.BlockAccessLists));
    }
