...
namespace Nethermind.Network.Test.P2P.Subprotocols.Sil.V65
{
    [TestFixture, Parallelizable(ParallelScope.Self)]
    public class Sil65ProtocolHandlerTests
    {
        ...
        private Sil65ProtocolHandler _handler = null!;
        ...
        public void Setup()
        {
            ...
            _handler = new Sil65ProtocolHandler(
                _session,
                _svc,
        ...
        public void Metadata_correct()
        {
            ...
            Assert.That(_handler.Name, Is.EqualTo("sil65"));
        ...
        public void should_handle_NewPooledTransactionHashesMessage([Values(true, false)] bool canGossipTransactions)
        {
            ...
            HandleZeroMessage(msg, Sil65MessageCode.NewPooledTransactionHashes);
