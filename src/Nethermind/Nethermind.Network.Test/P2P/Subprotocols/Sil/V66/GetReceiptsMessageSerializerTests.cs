...
namespace Nethermind.Network.Test.P2P.Subprotocols.Sil.V66
{
    ...
    public class GetReceiptsMessageSerializerTests
    {
        ...
        public void RoundTrip()
        {
            ...
            Hash256[] hashes = { a, b };
            using Network.P2P.Subprotocols.Sil.V63.Messages.GetReceiptsMessage silMessage = new(hashes.ToPooledList());

            GetReceiptsMessage message = new(1111, silMessage);
        ...
        {
            using Network.P2P.Subprotocols.Sil.V63.Messages.GetReceiptsMessage silMessage = new(new[] { Keccak.Zero }.ToPooledList());
            using GetReceiptsMessage message = new(-1, silMessage);
            GetReceiptsMessageSerializer serializer = new();
