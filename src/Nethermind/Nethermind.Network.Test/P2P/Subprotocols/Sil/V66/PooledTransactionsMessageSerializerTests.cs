...
namespace Nethermind.Network.Test.P2P.Subprotocols.Sil.V66
{
    ...
    public class PooledTransactionsMessageSerializerTests
    {
        ...
        public void Roundtrip()
        {
            ...
            using Network.P2P.Subprotocols.Sil.V65.Messages.PooledTransactionsMessage silMessage = new(new ArrayPoolList<Transaction>(2) { tx1, tx2 });

            PooledTransactionsMessage message = new(1111, silMessage);
