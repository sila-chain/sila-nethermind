...
public class ReceiptsMessageSerializerTests
{
    ...
    [
        ...
        new object[] // Empty SIP-1559 tx
        {
            1,
            new TxReceipt[] { new EmptyTxReceipt { TxType = TxType.SIP1559 } },
            "c801c6c5c4028080c0"
        },
    ...
    public void Roundtrip(long requestId, TxReceipt[] receipts, string expected)
    {
        ...
        ReceiptsMessageSerializer69 serializer = new(new TestSpecProvider(SilaPrague.Instance));
    ...
    public void IgnoresBloom([Values(null, 255)] int? length)
    {
        ...
        message.SilMessage.TxReceipts[0]![0].Bloom = length.HasValue
