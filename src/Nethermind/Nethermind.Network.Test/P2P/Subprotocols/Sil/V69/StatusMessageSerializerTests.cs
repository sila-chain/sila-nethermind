...
public class StatusMessageSerializerTests
{
    ...
    [
        new TestCaseData(
            ...
            {
                ProtocolVersion = 69,
                NetworkId = BlockchainIds.SilaMainnet,
        ...
        new TestCaseData(
            ...
            .SetName("SilaMainnet with non-zero values"),
        new TestCaseData(
            new StatusMessage69
            {
                ProtocolVersion = 69,
                NetworkId = BlockchainIds.SilaSepolia,
            ...
            .SetName("SilaSepolia max values"),
    ];
