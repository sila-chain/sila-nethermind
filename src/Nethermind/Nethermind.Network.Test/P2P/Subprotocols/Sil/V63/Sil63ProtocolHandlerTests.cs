...
namespace Nethermind.Network.Test.P2P.Subprotocols.Sil.V63
{
    [TestFixture, Parallelizable(ParallelScope.Self)]
    public class Sil63ProtocolHandlerTests
    {
        ...
        public async Task Can_request_and_handle_receipts()
        {
            ...
            Packet receiptsPacket =
                new("sil", Sil63MessageCode.Receipts, _ctx._receiptMessageSerializer.Serialize(receiptsMsg));
        ...
        public async Task Limit_receipt_request()
        {
            ...
            Packet smallReceiptsPacket =
                new("sil", Sil63MessageCode.Receipts, _ctx._receiptMessageSerializer.Serialize(
        ...
        public void Should_not_exceed_soft_message_size_limit_for_receipts()
        {
            ...
            Packet getReceiptsPacket =
                new("sil", Sil63MessageCode.GetReceipts, _ctx._getReceiptMessageSerializer.Serialize(getReceiptsMessage));
        ...
        private class Context
        {
            ...
            private Sil63ProtocolHandler? _protocolHandler;
            public Sil63ProtocolHandler ProtocolHandler
            {
                get
                {
                    ...
                    _protocolHandler = new Sil63ProtocolHandler(
                        Session,
                    ...
                    Packet statusPacket =
                        new("sil", Sil62MessageCode.Status, _statusMessageSerializer.Serialize(statusMessage));
