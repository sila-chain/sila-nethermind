...
namespace Nethermind.Network.Test.P2P.Subprotocols.Sil.V67;

[TestFixture, Parallelizable(ParallelScope.Self)]
public class Sil67ProtocolHandlerTests
{
    ...
    public void Setup()
    {
        ...
        _handler = new Sil67ProtocolHandler(
            _session,
            _svc,
    ...
    public void Metadata_correct()
    {
        ...
        Assert.That(_handler.Name, Is.EqualTo("sil67"));
    ...
    public void Should_disconnect_on_get_node_data()
    {
        ...
        _session.DidNotReceive().DeliverMessage(Arg.Any<Network.P2P.Subprotocols.Sil.V66.Messages.NodeDataMessage>());
