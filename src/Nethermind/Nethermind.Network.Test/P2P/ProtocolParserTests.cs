...
public class ProtocolParserTests
{
    ...
    [TestCase("ethx", Description = "Partial match sil + extra char")]
    [TestCase("sil69", Description = "Wrong length 5 chars")]
    ...
    [TestCase("SIL", Description = "Upper case")]
    [TestCase("Sil", Description = "Mixed case")]
