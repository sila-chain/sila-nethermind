...
public class HelloMessageSerializerTests
{
    ...
    public void Can_do_roundtrip()
    {
        ...
        helloMessage.Capabilities = new ArrayPoolList<Capability>(1) { new(Protocol.Sil, 1) };
    ...
    [Test]
    public void Can_deserialize_sample_from_silaJ()
    {
        ...
        AssertHelloFields(
            helloMessage,
            clientId: "Sila(++)/v0.7.9/Release/Linux/g++",
            listenPort: 992,
            p2pVersion: 2,
            capabilityCount: 2,
    ...
    [Test]
    public void Can_deserialize_sample_from_sip8_silaJ()
    {
