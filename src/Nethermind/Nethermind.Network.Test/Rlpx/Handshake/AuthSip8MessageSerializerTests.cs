...
public class AuthSip8MessageSerializerTests
{
    ...
    private readonly AuthSip8MessageSerializer _serializer = new(new Sip8MessagePad(new CryptoRandom()));

    private void TestEncodeDecode(ISilaEcdsa ecdsa)
    {
        ...
        AuthSip8Message after = _serializer.Deserialize(data);
    ...
    [TestCase(BlockchainIds.SilaMainnet)]
    [TestCase(BlockchainIds.Morden)]
    [TestCase(BlockchainIds.RootstockMainnet)]
    [TestCase(BlockchainIds.DefaultGethPrivateChain)]
    [TestCase(BlockchainIds.SilaClassicMainnet)]
    [TestCase(BlockchainIds.SilaClassicTestnet)]
    [TestCase(BlockchainIds.SilaSepolia)]
