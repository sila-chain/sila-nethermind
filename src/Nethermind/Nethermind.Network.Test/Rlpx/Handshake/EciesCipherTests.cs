...
public class EciesCipherTests
{
    ...
    [Test]
    public void Can_decrypt_auth_sip8_message_with_additional_elements()
    {
        ...
        AuthSip8Message authMessage = _messageSerializationService.Deserialize<AuthSip8Message>(deciphered);
    ...
    [Test]
    public void Can_decrypt_auth_sip8_message()
    {
    ...
    [Test]
    public void Can_decrypt_ack_sip8_message()
    {
        ...
        AckSip8Message ackMessage = _messageSerializationService.Deserialize<AckSip8Message>(deciphered);
        Assert.That(NetTestVectors.EphemeralKeyB.PublicKey, Is.EqualTo(ackMessage.EphemeralPublicKey));
        Assert.That(NetTestVectors.NonceB, Is.EqualTo(ackMessage.Nonce));
    ...
    [Test]
    public void Can_decrypt_ack_sip8_message_with_additional_elements()
    {
