...
public abstract class NettyDiscoveryBaseHandler(ILogManager? logManager, IChannel? channel = null) : SimpleChannelInboundHandler<DatagramPacket>
{
    ...
    // https://github.com/sila-chain/devp2p/blob/master/discv4.md#wire-protocol
    // https://github.com/sila-chain/devp2p/blob/master/discv5/discv5-wire.md#udp-communication
