...
public class OptimismCostHelper(IOptimismSpecHelper opSpecHelper, Address l1BlockAddr) : ICostHelper
{
    ...
    public static UInt256 ComputeDataGas(Transaction tx, bool isRegolith)
    {
        ...
        // Add pre-SIP-3529 overhead
        nonZeroCount += isRegolith ? 0UL : OptimismConstants.PreRegolithNonZeroCountOverhead;

        return zeroCount * GasCostOf.TxDataZero + nonZeroCount * GasCostOf.TxDataNonZeroSip2028;
    }
    ...
    // Based on:
    // https://github.com/sila-chain-optimism/op-geth/blob/7c2819836018bfe0ca07c4e4955754834ffad4e0/core/types/rollup_cost.go
    ...
    internal static UInt256 ComputeGasUsedFjord(UInt256 estimatedSize) => BasicDivisor.IsZero ? default : estimatedSize * GasCostOf.TxDataNonZeroSip2028 / BasicDivisor;
