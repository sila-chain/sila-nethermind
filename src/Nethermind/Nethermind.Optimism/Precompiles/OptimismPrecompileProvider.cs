...
/// <summary>
/// Wraps the standard Sila precompiles, applying the OP-Stack input-size restrictions according
...
public class OptimismPrecompileProvider : IPrecompileProvider
{
    ...
    {
        Dictionary<AddressAsKey, CodeInfo> dict = new(new SilaPrecompileProvider().GetPrecompiles())
        {
