...
/// <remarks>
/// See: https://github.com/sila-chain-optimism/optimism/blob/c8b9f62736a7dad7e569719a84c406605f4472e6/op-node/rollup/types.go#L67
/// </remarks>
public sealed record OptimismRollupConfig
{
    ...
    {
        [JsonPropertyName("sip1559Elasticity")]
        public required ulong SIP1559Elasticity { get; init; }
        [JsonPropertyName("sip1559Denominator")]
        public required ulong SIP1559Denominator { get; init; }
        [JsonPropertyName("sip1559DenominatorCanyon")]
        public required ulong? SIP1559DenominatorCanyon { get; init; }
    }
    ...
    public static OptimismRollupConfig Build(
        ...
        ChainSpec chainSpec) => new()
        {
            ...
            {
                SIP1559Elasticity = (ulong)chainSpec.Parameters.Sip1559ElasticityMultiplier!.Value,
                SIP1559Denominator = (ulong)chainSpec.Parameters.Sip1559BaseFeeMaxChangeDenominator!.Value,
                SIP1559DenominatorCanyon = (ulong)engineParameters.CanyonBaseFeeChangeDenominator!.Value
            }
        };
}
