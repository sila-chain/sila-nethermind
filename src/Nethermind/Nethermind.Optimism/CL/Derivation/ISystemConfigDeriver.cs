...
public record SystemConfig
{
    ...
    /// <summary>
    /// Holocene-encoded SIP-1559 parameters.
    /// This value will be 0 if Holocene is not active, or if derivation has yet to
    /// process any SIP_1559_PARAMS system config update events.
    /// </summary>
    public byte[] SIP1559Params { get; init; } = new byte[32];
    ...
    public virtual bool Equals(SystemConfig? other)
    {
        ...
        return BatcherAddress.Equals(other.BatcherAddress)
               ...
               && SIP1559Params.SequenceEqual(other.SIP1559Params);
    }

    public override int GetHashCode() =>
        HashCode.Combine(BatcherAddress, GasLimit, Overhead, Scalar, SIP1559Params);

    public override string ToString() => $"BatcherAddress: {BatcherAddress}, GasLimit: {GasLimit}, Overhead: {Overhead.ToHexString()}, Scalar: {Scalar.ToHexString()}, SIP1559Params: {SIP1559Params.ToHexString()}";
