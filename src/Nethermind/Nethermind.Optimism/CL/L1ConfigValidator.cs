...
public class L1ConfigValidator(ISilApi silApi, ILogManager logManager) : IL1ConfigValidator
{
    private readonly ISilApi _ethApi = silApi;
    ...
    public async Task<bool> Validate(ulong expectedChainId, ulong genesisNumber, Hash256 expectedGenesisHash)
    {
        ...
        // TODO: `ISilApi.GetBlockByNumber` currently does not support `fullTxs = false` when deserializing,
