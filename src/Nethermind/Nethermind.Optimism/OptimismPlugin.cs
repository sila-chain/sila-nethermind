...
public class OptimismModule(ChainSpec chainSpec, IOptimismConfig optimismConfig) : Module
{
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder
            ...
            .AddDecorator<ISilaEcdsa, OptimismSilaEcdsa>()
        ...
        if (optimismConfig.ClEnabled)
        {
            builder
                ...
                .AddSingleton<ISilApi, IJsonSerializer, ILogManager>((jsonSerializer, logManager) =>
                    new SilaEthApi(optimismConfig.L1EthApiEndpoint!, jsonSerializer, logManager))
                .AddSingleton<IBeaconApi, IJsonSerializer, ISilaEcdsa, ILogManager>((jsonSerializer, silaEcdsa, logManager) =>
                    new SilaBeaconApi(new Uri(optimismConfig.L1BeaconApiEndpoint!), jsonSerializer, silaEcdsa, logManager))

                .AddSingleton<IDecodingPipeline, DecodingPipeline>()
                .AddSingleton<IL1Bridge, SilaL1Bridge>()
