...
/// <summary>
/// Represents an Sila Node Record (ENR) as defined in https://sips.sila.org/SIPS/sip-778
/// </summary>
public class NodeRecord
{
    ...
    /// <summary>
    /// Hash of the content, i.e. Keccak([seq, k, v, ...]) as defined in https://sips.sila.org/SIPS/sip-778
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    /// For IPv6, <c>udp6</c> is preferred and <c>udp</c> is used as the SIP-778 fallback.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// For IPv6, <c>tcp6</c> is preferred and <c>tcp</c> is used as the SIP-778 fallback.
    /// </remarks>
