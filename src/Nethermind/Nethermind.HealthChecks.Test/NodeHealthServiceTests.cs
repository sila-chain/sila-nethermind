...
public class NodeHealthServiceTests
{
    ...
    public void CheckHealth_returns_expected_results([ValueSource(nameof(CheckHealthTestCases))] CheckHealthTest test)
    {
        ...
        ISilSyncingInfo silSyncingInfo = new SilSyncingInfo(blockFinder, Substitute.For<ISyncPointers>(), syncConfig, Substitute.For<ISyncModeSelector>(), Substitute.For<ISyncProgressResolver>(), LimboLogs.Instance);
        ...
        NodeHealthService nodeHealthService =
            new(syncServer, blockchainProcessor, blockProducerRunner, new HealthChecksConfig(),
                healthHintService, silSyncingInfo, tracker, null, new[] { drive }, test.IsMining);
    ...
    public void post_merge_health_checks([ValueSource(nameof(CheckHealthPostMergeTestCases))] CheckHealthPostMergeTest test)
    {
        ...
        ISilSyncingInfo silSyncingInfo = new SilSyncingInfo(blockFinder, Substitute.For<ISyncPointers>(),
        ...
        NodeHealthService nodeHealthService =
            new(syncServer, blockchainProcessor, blockProducerRunner, new HealthChecksConfig(),
                healthHintService, silSyncingInfo, tracker, UInt256.Zero, new[] { drive }, false);
