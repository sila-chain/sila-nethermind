...
/// in place of the Silash <c>mixHash</c> + <c>nonce</c> the base model writes.
/// </summary>
...
/// falling back to the base (Silash/PoS) models for the post-merge headers of merged AuRa chains.
/// </summary>
