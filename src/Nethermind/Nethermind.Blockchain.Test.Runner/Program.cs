...
namespace Nethermind.Blockchain.Test.Runner
{
    internal class Program
    {
        ...
        {
            List<SilaTestResult> result = stateTest.RunTests().ToList();
        ...
        {
            IEnumerable<SilaTestResult> result = await blockchainTestRunner.RunTestsAsync();
            List<SilaTestResult> testResults = result.ToList();
        ...
        private static void RunAllStateTests(string testWildcard, Func<ITestSourceLoader, IStateTestRunner> testRunnerBuilder)
        {
            ...
            WrapAndRunDirectoryStateTests(testRunnerBuilder(new TestsSourceLoader(new LoadGeneralStateTestsStrategy(), "stChangedSIP150", testWildcard)));
            ...
            WrapAndRunDirectoryStateTests(testRunnerBuilder(new TestsSourceLoader(new LoadGeneralStateTestsStrategy(), "stSIP150singleCodeGasPrices", testWildcard)));
            WrapAndRunDirectoryStateTests(testRunnerBuilder(new TestsSourceLoader(new LoadGeneralStateTestsStrategy(), "stSIP150Specific", testWildcard)));
            WrapAndRunDirectoryStateTests(testRunnerBuilder(new TestsSourceLoader(new LoadGeneralStateTestsStrategy(), "stSIP158Specific", testWildcard)));
            WrapAndRunDirectoryStateTests(testRunnerBuilder(new TestsSourceLoader(new LoadGeneralStateTestsStrategy(), "stSIP2930", testWildcard)));
            ...
            WrapAndRunDirectoryStateTests(testRunnerBuilder(new TestsSourceLoader(new LoadGeneralStateTestsStrategy(), "stMemExpandingSIP150Calls", testWildcard)));
