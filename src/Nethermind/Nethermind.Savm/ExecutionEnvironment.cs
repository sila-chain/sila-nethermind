...
using Queue =
#if ZK_SAVM
        Nethermind.Savm.ZkSavmQueue<Nethermind.Savm.ExecutionEnvironment>;
#else
        System.Collections.Concurrent.ConcurrentQueue<Nethermind.Savm.ExecutionEnvironment>;
#endif

namespace Nethermind.Savm
{
    /// <summary>
    /// Execution environment for SAVM calls. Pooled to avoid allocation and GC write barrier overhead.
    /// </summary>
