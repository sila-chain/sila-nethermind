...
{
    private readonly ZkSavmQueue<StackItem> _stackPool = new();
    ...
    public partial byte[] RentStacks()
    {
        ...
        // the data-stack pointer to a 32-byte (SAVM word) boundary.
        return GC.AllocateUninitializedArray<byte>(StackLength + SavmStack.WordSize, pinned: true);
    }
}
