...
public static class TracerExtensions
{
    ...
    public static void TraceWord(this ITxTracer tracer, in SavmWord value) => tracer.ReportStackPush(MemoryMarshal.AsBytes(MemoryMarshal.CreateReadOnlySpan(in value, 1)));
