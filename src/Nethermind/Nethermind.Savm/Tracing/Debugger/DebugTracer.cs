...
namespace Nethermind.Savm.Tracing.Debugger;
    ...
    where TGasPolicy : struct, IGasPolicy<TGasPolicy>
{
    ...
    public void ReportActionError(SavmExceptionType savmExceptionType)
        => InnerTracer.ReportActionError(savmExceptionType);
...
/// <summary>
/// Non-generic DebugTracer for backward compatibility with SilaGasPolicy.
/// </summary>
public class DebugTracer(ITxTracer tracer) : DebugTracer<SilaGasPolicy>(tracer)
{
}
#endif
