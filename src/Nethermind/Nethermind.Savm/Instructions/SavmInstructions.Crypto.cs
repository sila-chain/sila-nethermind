...
public static partial class SavmInstructions
{
    ...
    /// </summary>
    [SkipLocalsInit]
    public static SavmExceptionType InstructionKeccak256<TGasPolicy, TTracingInst>(VirtualMachine<TGasPolicy> vm, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        ulong words = SavmCalculations.Div32Ceiling(in b, out bool outOfGas);
