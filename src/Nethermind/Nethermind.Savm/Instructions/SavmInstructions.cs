...
[assembly: InternalsVisibleTo("Nethermind.Savm.Precompiles")]
[assembly: InternalsVisibleTo("Nethermind.Savm.Benchmark")]
namespace Nethermind.Savm;

public static unsafe partial class SavmInstructions
{
    /// <summary>
    /// Generates the opcode lookup table for the Sila Virtual Machine.
    /// Each of the 256 entries in the returned array corresponds to an SAVM instruction,
    ...
    public static delegate*<VirtualMachine<TGasPolicy>, ref SavmStack, ref TGasPolicy, ref int, SavmExceptionType>[] GenerateOpCodes<TGasPolicy, TTracingInst>(IReleaseSpec spec)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        where TTracingInst : struct, IFlag
    {
        // Allocate lookup table for all possible opcodes.
        delegate*<VirtualMachine<TGasPolicy>, ref SavmStack, ref TGasPolicy, ref int, SavmExceptionType>[] lookup = new delegate*<VirtualMachine<TGasPolicy>, ref SavmStack, ref TGasPolicy, ref int, SavmExceptionType>[byte.MaxValue + 1];
        ...
        // SIP-8024 stack operations.
        if (spec.IsSip8024Enabled)
        {
        ...
        lookup[(int)Instruction.CREATE] = spec.IsSip8037Enabled
            ? &InstructionCreate<TGasPolicy, OpCreate, TTracingInst, OnFlag>
            : &InstructionCreate<TGasPolicy, OpCreate, TTracingInst, OffFlag>;
        lookup[(int)Instruction.CALL] = (spec.IsSip8037Enabled, spec.IsSip7708Enabled) switch
        {
        ...
        lookup[(int)Instruction.CALLCODE] = (spec.IsSip8037Enabled, spec.IsSip7708Enabled) switch
        {
        ...
        {
            lookup[(int)Instruction.DELEGATECALL] = (spec.IsSip8037Enabled, spec.IsSip7708Enabled) switch
            {
        ...
        {
            lookup[(int)Instruction.CREATE2] = spec.IsSip8037Enabled
        ...
        {
            lookup[(int)Instruction.STATICCALL] = (spec.IsSip8037Enabled, spec.IsSip7708Enabled) switch
            {
        ...
        lookup[(int)Instruction.SELFDESTRUCT] = (spec.IsSip8037Enabled, spec.IsSip7708Enabled) switch
        {
