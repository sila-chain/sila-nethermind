...
{
    /// <summary>
    /// Pops a value from the SAVM stack.
    ...
    /// <returns><see cref="SavmExceptionType.None"/> if successful; otherwise, <see cref="SavmExceptionType.StackUnderflow"/>.</returns>
    [SkipLocalsInit]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SavmExceptionType InstructionPop<TGasPolicy>(VirtualMachine<TGasPolicy> vm, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
    {
        ...
        return stack.PopLimbo() ? SavmExceptionType.None : SavmExceptionType.StackUnderflow;
    }
    ...
    public interface IOpCount
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        abstract static SavmExceptionType Push<TTracingInst>(int length, ref SavmStack stack, int programCounter)
    ...
    public struct Op0 : IOpCount
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SavmExceptionType Push<TTracingInst>(int length, ref SavmStack stack, int programCounter)
            where TTracingInst : struct, IFlag
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SavmExceptionType InstructionPush2<TGasPolicy, TTracingInst>(VirtualMachine<TGasPolicy> vm, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        where TTracingInst : struct, IFlag
    {
        ...
        if (!TTracingInst.IsActive &&
            remainingCode > Size &&
            stack.Head < SavmStack.MaxStackSize - 1 &&
    ...
    InvalidJumpDestination:
        return SavmExceptionType.InvalidJumpDestination;
    StackUnderflow:
    ...
    /// <param name="gas">The gas state which is reduced by the operation's cost.</param>
    /// <param name="programCounter">The program counter.</param>
    /// <returns><see cref="SavmExceptionType.None"/> on success.</returns>
    [SkipLocalsInit]
    public static SavmExceptionType InstructionPush0<TGasPolicy, TTracingInst>(VirtualMachine<TGasPolicy> vm, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        where TTracingInst : struct, IFlag
    {
        TGasPolicy.Consume<BaseGasCost>(ref gas);
    ...
    /// <returns><see cref="SavmExceptionType.None"/> on success.</returns>
    [SkipLocalsInit]
    public static SavmExceptionType InstructionPush<TGasPolicy, TOpCount, TTracingInst>(VirtualMachine<TGasPolicy> vm, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        SavmExceptionType result = TOpCount.Push<TTracingInst>(TOpCount.Count, ref stack, programCounter);
    ...
    /// <returns><see cref="SavmExceptionType.None"/> on success or <see cref="SavmExceptionType.StackUnderflow"/> if insufficient stack elements.</returns>
    [SkipLocalsInit]
    public static SavmExceptionType InstructionDup<TGasPolicy, TOpCount, TTracingInst>(VirtualMachine<TGasPolicy> vm, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        where TOpCount : struct, IOpCount
        where TTracingInst : struct, IFlag
    {
    ...
    /// <param name="gas">The gas state which is reduced by the operation's cost.</param>
    /// <param name="programCounter">Reference to the program counter.</param>
    /// <returns><see cref="SavmExceptionType.None"/> on success or <see cref="SavmExceptionType.StackUnderflow"/> if insufficient elements.</returns>
    [SkipLocalsInit]
    public static SavmExceptionType InstructionSwap<TGasPolicy, TOpCount, TTracingInst>(VirtualMachine<TGasPolicy> vm, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        where TOpCount : struct, IOpCount
        where TTracingInst : struct, IFlag
    {
    ...
    /// <summary>
    /// SIP-8024: DUPN instruction.
    /// Duplicates a stack item based on an immediate operand with extended encoding.
    /// </summary>
    [SkipLocalsInit]
    public static SavmExceptionType InstructionDupN<TGasPolicy, TTracingInst>(VirtualMachine<TGasPolicy> vm, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        where TTracingInst : struct, IFlag
    {
        TGasPolicy.Consume<VeryLowGasCost>(ref gas);
        ...
        return !TryDecodeSingle(ref stack, ref programCounter, out int depth)
            ? SavmExceptionType.BadInstruction
            : stack.Dup<TTracingInst>(depth);
    }

    /// <summary>
    /// SIP-8024: SWAPN instruction.
    /// Swaps top of stack with the Nth element, where N is decoded from the immediate.
    /// </summary>
    [SkipLocalsInit]
    public static SavmExceptionType InstructionSwapN<TGasPolicy, TTracingInst>(VirtualMachine<TGasPolicy> vm, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        where TTracingInst : struct, IFlag
    {
        TGasPolicy.Consume<VeryLowGasCost>(ref gas);
    ...
    /// <summary>
    /// SIP-8024: EXCHANGE instruction.
    /// Exchanges stack items at positions n and m from the top.
    /// </summary>
    [SkipLocalsInit]
    public static SavmExceptionType InstructionExchange<TGasPolicy, TTracingInst>(VirtualMachine<TGasPolicy> vm, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        where TTracingInst : struct, IFlag
    {
        TGasPolicy.Consume<VeryLowGasCost>(ref gas);
    ...
    // SIP-8024 specifies that a missing immediate beyond end of code evaluates to zero.
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static byte ReadSip8024ImmediateOrZero(ref byte code, int codeLength, int programCounter)
        => programCounter < codeLength ? Unsafe.Add(ref code, programCounter) : (byte)0;

    /// <summary>
    /// Reads and decodes an immediate for SIP-8024 DUPN/SWAPN instructions.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static bool TryDecodeSingle(ref SavmStack stack, ref int programCounter, out int depth)
    {
        byte imm = ReadSip8024ImmediateOrZero(ref stack.Code, stack.CodeLength, programCounter);
        depth = (imm + 145) & 0xFF;
    ...
    /// <summary>
    /// Reads and decodes an immediate for SIP-8024 EXCHANGE instruction.
    /// </summary>
    /// <remarks>
    /// Handles reading the immediate and advancing the program counter.
    ...
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static bool TryDecodePair(ref SavmStack stack, ref int programCounter, out int n, out int m)
    {
        byte imm = ReadSip8024ImmediateOrZero(ref stack.Code, stack.CodeLength, programCounter);
        ...
        // SIP-8024 base mapping (0-based stack): if (q < r) n=q+1, m=r+1 else n=r+1, m=29-q
    ...
    /// <param name="programCounter">Reference to the program counter.</param>
    /// <returns>
    /// <see cref="SavmExceptionType.None"/> if the log is successfully recorded; otherwise, an appropriate exception type such as
    /// <see cref="SavmExceptionType.StackUnderflow"/>, <see cref="SavmExceptionType.StaticCallViolation"/>, or <see cref="SavmExceptionType.OutOfGas"/>.
    /// </returns>
    [SkipLocalsInit]
    public static SavmExceptionType InstructionLog<TGasPolicy, TOpCount>(VirtualMachine<TGasPolicy> vm, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        where TGasPolicy : struct, IGasPolicy<TGasPolicy>
        where TOpCount : struct, IOpCount
    {
