...
public static partial class SavmInstructions
{
    ...
    [SkipLocalsInit]
    public static SavmExceptionType InstructionMath3Param<TGasPolicy, TOpMath, TTracingInst>(VirtualMachine<TGasPolicy> _, ref SavmStack stack, ref TGasPolicy gas, ref int programCounter)
        ...
        where TTracingInst : struct, IFlag
    {
        ...
        SavmStack.ReadUInt256FromSlot(ref topRef, out UInt256 c);
        if (c.IsZero)
        {
