...
public readonly ref struct TransactionSubstate
{
    ...
    private const int WordSize = SavmPooledMemory.WordSize;
    ...
    public TransactionSubstate(SavmExceptionType exceptionType, bool isTracerConnected, string? substateError = null)
    {
        ...
        SavmExceptionType = exceptionType;
        Refund = 0;
        _destroyList = null;
        // Real list, not a shared empty sentinel: SIP-7708 SELFDESTRUCT appends a transfer log and this readonly struct can't reassign later.
        _logs = [];
        ShouldRevert = false;
    }
    ...
    public TransactionSubstate(ReadOnlyMemory<byte> bytes,
        ...
        SavmExceptionType savmExceptionType = default,
        ILogger logger = default)
    {
        ...
        SavmExceptionType = savmExceptionType;
    ...
    /// </summary>
    /// <remarks>
    /// Shared by <c>sil_call</c>/<c>sil_estimateGas</c> and <c>proof_call</c> so they report identical
