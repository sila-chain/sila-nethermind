    ...
    where TGasPolicy : struct, IGasPolicy<TGasPolicy>
{
    ...
    /// SIP-7928 excludes the SYSTEM_ADDRESS caller from BALs for system contract calls;
    ...
    /// run with SIP-158 still on. Subclasses override to force SIP-158 off even at genesis.
    /// </summary>
    /// <remarks>
    ...
    protected override bool RecoverSenderIfNeeded(Transaction tx, IReleaseSpec spec, ExecutionOptions opts, in UInt256 effectiveGasPrice)
    {
        ...
        return (sender is null || (sender == spec.Sip158IgnoredAccount && !WorldState.AccountExists(sender)))
