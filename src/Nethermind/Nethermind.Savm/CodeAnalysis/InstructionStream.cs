...
namespace Nethermind.Savm.CodeAnalysis;
...
/// <summary>
/// Virtual opcodes for fused PUSH+op pairs, placed in byte values the SAVM does not define
...
/// <c>spec.IncludePush0Instruction</c> — i.e. ANY fork &gt;= SilaShanghai runs the stream; there is no
