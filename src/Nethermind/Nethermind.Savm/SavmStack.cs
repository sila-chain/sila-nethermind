...
public ref struct SavmStack
{
    ...
    public SavmStack(int head, ITxTracer txTracer, ref byte stack, scoped in ReadOnlySpan<byte> codeSpan)
    {
        Head = head;
        _tracer = txTracer;
        _stack = ref stack;
    ...
    public SavmStack(int head, ref byte stack, scoped in ReadOnlySpan<byte> codeSpan)
    {
        Head = head;
        _tracer = null;
        _stack = ref stack;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static SavmWord CreateWordFromUInt64(ulong value)
    ...
    private static SavmWord ByteSwap256Mask
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get
        {
    ...
    [SkipLocalsInit]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType PushBytes<TTracingInst>(scoped ReadOnlySpan<byte> value)
        where TTracingInst : struct, IFlag
    {
        ref byte dst = ref PushBytesRef();
        if (Unsafe.IsNullRef(ref dst)) return SavmExceptionType.StackOverflow;
        ...
        if (value.Length == WordSize)
        {
            ...
            {
                Unsafe.As<byte, SavmWord>(ref dst) = Unsafe.As<byte, SavmWord>(ref src);
            }
            else
            {
    ...
    private static void PushBytesPartial(ref byte dst, ref byte src, nuint length)
    {
        ...
        if (Vector256.IsHardwareAccelerated)
        {
            Unsafe.As<byte, SavmWord>(ref dst) = Vector256.Create(lo, hi).AsByte();
        }
        else
        {
    ...
    public SavmExceptionType PushBytes<TTracingInst>(scoped in ZeroPaddedSpan value)
        where TTracingInst : struct, IFlag
    {
        ref byte bytes = ref PushBytesRef();
        if (Unsafe.IsNullRef(ref bytes)) return SavmExceptionType.StackOverflow;
        ...
        if (valueSpan.Length >= WordSize)
        {
            ...
            Unsafe.As<byte, SavmWord>(ref bytes) = Unsafe.As<byte, SavmWord>(ref MemoryMarshal.GetReference(valueSpan));
        }
        else
        {
            Unsafe.As<byte, SavmWord>(ref bytes) = default; // Not full entry, clear first
    ...
    [SkipLocalsInit]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType PushRightPaddedBytes<TTracingInst>(ref byte src, uint length)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [SkipLocalsInit]
    private static SavmExceptionType PushBytesPartialZeroPadded(ref byte dst, ref byte src, nuint length)
    {
    ...
    {
        SavmWord beBytes = Unsafe.ReadUnaligned<SavmWord>(ref slot);
        SavmWord leBytes = beBytes.ByteSwap();
        return Unsafe.As<SavmWord, UInt256>(ref leBytes);
    }
    ...
    public static void ReadUInt256FromSlot(ref byte slot, out UInt256 value)
    {
        ...
        SavmWord beBytes = Unsafe.ReadUnaligned<SavmWord>(ref slot);
        Unsafe.As<UInt256, SavmWord>(ref value) = beBytes.ByteSwap();
    }
    ...
    public static void WriteUInt256ToSlot(ref byte slot, in UInt256 value)
    {
        ...
        Unsafe.As<byte, SavmWord>(ref slot) = leBytes.ByteSwap();
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push10Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
        ...
        ref SavmWord head = ref Unsafe.As<byte, SavmWord>(ref Unsafe.Add(ref _stack, (nint)(headOffset * WordSize)));
        ...
        head = default;
        ref ulong headU64 = ref Unsafe.As<SavmWord, ulong>(ref head);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push11Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push12Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push13Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push14Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push15Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push16Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
        ...
        {
            ref HalfWord head128 = ref Unsafe.As<SavmWord, HalfWord>(ref head);
            head128 = default;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push17Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push18Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push19Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push20Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push21Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push22Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push23Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push24Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push25Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push26Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push27Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push28Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push29Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push2Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push30Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push31Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push32Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
        ...
        ref SavmWord head = ref Unsafe.As<byte, SavmWord>(ref Unsafe.Add(ref _stack, (nint)(headOffset * WordSize)));
        head = Unsafe.ReadUnaligned<SavmWord>(ref value);

        return SavmExceptionType.None;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push3Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push4Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push5Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push6Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push7Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push8Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push9Bytes<TTracingInst>(ref byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType PushByte<TTracingInst>(byte value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType PushAddress<TTracingInst>(Address address)
        where TTracingInst : struct, IFlag
        => Push20Bytes<TTracingInst>(ref MemoryMarshal.GetReference(address.Bytes));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Push32Bytes<TTracingInst>(in ValueHash256 hash)
        where TTracingInst : struct, IFlag
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public SavmExceptionType PushBothPaddedBytes<TTracingInst>(ref byte start, int used, int pushSize)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
        ...
        if (Vector256.IsHardwareAccelerated)
        {
            Unsafe.As<byte, SavmWord>(ref dst) = default;
        }
        else
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType PushOne<TTracingInst>()
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType PushZero<TTracingInst>()
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
        ...
        {
            ref Vector128<uint> head128 = ref Unsafe.As<SavmWord, Vector128<uint>>(ref head);
            head128 = default;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType PushUInt32<TTracingInst>(uint value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType PushUInt64<TTracingInst>(ulong value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
        ...
        {
            ref Vector128<ulong> head128 = ref Unsafe.As<SavmWord, Vector128<ulong>>(ref head);
            head128 = default;
    ...
    /// </remarks>
    [SkipLocalsInit]
    public SavmExceptionType PushUInt256<TTracingInst>(in UInt256 value)
        where TTracingInst : struct, IFlag
    {
        uint headOffset = (uint)Head;
        uint newOffset = headOffset + 1;
        ...
        if (Avx2.IsSupported)
        {
            SavmWord shuffle = ByteSwap256Mask;
            if (Avx512Vbmi.VL.IsSupported)
            {
                SavmWord data = Unsafe.As<UInt256, SavmWord>(ref Unsafe.AsRef(in value));
            ...
            else
            {
                ...
                head = Avx2.Shuffle(Unsafe.As<Vector256<ulong>, SavmWord>(ref convert), shuffle);
            }
        }
        else
        {
        ...
        if (TTracingInst.IsActive)
            _tracer.ReportStackPush(MemoryMarshal.CreateReadOnlySpan(ref Unsafe.As<SavmWord, byte>(ref head), WordSize));

        return SavmExceptionType.None;
    }

    public SavmExceptionType PushSignedInt256<TTracingInst>(in Int256.Int256 value)
        where TTracingInst : struct, IFlag
    ...
    private static UInt256 ReadBeWord(ref byte bytes)
    {
        ...
        ulong low = ZkSavmBitOperations.Bswap64(r3);
        return (r0 | r1 | r2) == 0
            ? new UInt256(low, 0, 0, 0)
            : new UInt256(
                low,
                ZkSavmBitOperations.Bswap64(r2),
                ZkSavmBitOperations.Bswap64(r1),
                ZkSavmBitOperations.Bswap64(r0)
            );
    }
#endif
    ...
    public bool PopUInt256(out UInt256 result)
    {
        ...
        if (Avx2.IsSupported)
        {
            SavmWord data = Unsafe.ReadUnaligned<SavmWord>(ref bytes);
            SavmWord shuffle = ByteSwap256Mask;
            if (Avx512Vbmi.VL.IsSupported)
            {
                SavmWord convert = Avx512Vbmi.VL.PermuteVar32x8(data, shuffle);
                result = Unsafe.As<SavmWord, UInt256>(ref convert);
            }
            else
            {
                SavmWord convert = Avx2.Shuffle(data, shuffle);
                Vector256<ulong> permute = Avx2.Permute4x64(Unsafe.As<SavmWord, Vector256<ulong>>(ref convert), 0b_01_00_11_10);
    ...
    public bool PopUInt256(out UInt256 a, out UInt256 b)
    {
        ...
        if (Avx2.IsSupported)
        {
            ...
            if (Avx512Vbmi.VL.IsSupported)
            {
                SavmWord bData = Unsafe.ReadUnaligned<SavmWord>(ref bytes);
                Unsafe.As<UInt256, SavmWord>(ref b) = Avx512Vbmi.VL.PermuteVar32x8(bData, shuffle);

                SavmWord aData = Unsafe.ReadUnaligned<SavmWord>(ref Unsafe.Add(ref bytes, 32));
                Unsafe.As<UInt256, SavmWord>(ref a) = Avx512Vbmi.VL.PermuteVar32x8(aData, shuffle);
            }
            else
            {
                ...
                SavmWord bData = Unsafe.ReadUnaligned<SavmWord>(ref bytes);
                SavmWord bShuf = Avx2.Shuffle(bData, shuffle);
                Unsafe.As<UInt256, Vector256<ulong>>(ref b) = Avx2.Permute4x64(bShuf.AsUInt64(), SwapHalves);

                SavmWord aData = Unsafe.ReadUnaligned<SavmWord>(ref Unsafe.Add(ref bytes, 32));
                SavmWord aShuf = Avx2.Shuffle(aData, shuffle);
    ...
    public bool PopUInt256(out UInt256 a, out UInt256 b, out UInt256 c)
    {
        ...
        if (Avx2.IsSupported)
        {
            ...
            if (Avx512Vbmi.VL.IsSupported)
            {
                SavmWord cData = Unsafe.ReadUnaligned<SavmWord>(ref bytes);
                Unsafe.As<UInt256, SavmWord>(ref c) = Avx512Vbmi.VL.PermuteVar32x8(cData, shuffle);

                SavmWord bData = Unsafe.ReadUnaligned<SavmWord>(ref Unsafe.Add(ref bytes, 32));
                Unsafe.As<UInt256, SavmWord>(ref b) = Avx512Vbmi.VL.PermuteVar32x8(bData, shuffle);

                SavmWord aData = Unsafe.ReadUnaligned<SavmWord>(ref Unsafe.Add(ref bytes, 64));
                Unsafe.As<UInt256, SavmWord>(ref a) = Avx512Vbmi.VL.PermuteVar32x8(aData, shuffle);
            }
            else
            {
                ...
                SavmWord cData = Unsafe.ReadUnaligned<SavmWord>(ref bytes);
                SavmWord cShuf = Avx2.Shuffle(cData, shuffle);
    ...
    public bool PopUInt256(out UInt256 a, out UInt256 b, out UInt256 c, out UInt256 d)
    {
        ...
        if (Avx2.IsSupported)
        {
            ...
            if (Avx512Vbmi.VL.IsSupported)
            {
                SavmWord dData = Unsafe.ReadUnaligned<SavmWord>(ref bytes);
                Unsafe.As<UInt256, SavmWord>(ref d) = Avx512Vbmi.VL.PermuteVar32x8(dData, shuffle);

                SavmWord cData = Unsafe.ReadUnaligned<SavmWord>(ref Unsafe.Add(ref bytes, 32));
                Unsafe.As<UInt256, SavmWord>(ref c) = Avx512Vbmi.VL.PermuteVar32x8(cData, shuffle);

                SavmWord bData = Unsafe.ReadUnaligned<SavmWord>(ref Unsafe.Add(ref bytes, 64));
                Unsafe.As<UInt256, SavmWord>(ref b) = Avx512Vbmi.VL.PermuteVar32x8(bData, shuffle);

                SavmWord aData = Unsafe.ReadUnaligned<SavmWord>(ref Unsafe.Add(ref bytes, 96));
                Unsafe.As<UInt256, SavmWord>(ref a) = Avx512Vbmi.VL.PermuteVar32x8(aData, shuffle);
            }
            else
            {
                ...
                SavmWord dData = Unsafe.ReadUnaligned<SavmWord>(ref bytes);
                SavmWord dShuf = Avx2.Shuffle(dData, shuffle);
    ...
    public readonly bool PeekUInt256IsZero()
    {
        ...
        return Unsafe.ReadUnaligned<SavmWord>(ref Unsafe.Add(ref baseRef, (nint)((uint)head * WordSize))) == default;
    }
    ...
    public readonly Span<byte> PeekWord256()
    {
        ...
        if (head-- == 0)
        {
            ThrowSavmStackUnderflowException();
        }
    ...
    /// this overload throws <see cref="SavmStackUnderflowException"/> on underflow rather than
    /// signalling via return value.
    /// </summary>
    public Span<byte> PopWord256()
    {
        ref byte bytes = ref PopBytesByRef();
        if (Unsafe.IsNullRef(ref bytes)) ThrowSavmStackUnderflowException();
    ...
    [SkipLocalsInit]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SavmExceptionType Dup<TTracingInst>(int depth)
        where TTracingInst : struct, IFlag
    {
        int head = Head;
        if (head < depth)
        ...
        Head = head;
        Unsafe.WriteUnaligned(ref to, Unsafe.ReadUnaligned<SavmWord>(ref from));
        return SavmExceptionType.None;
    }
    ...
    [SkipLocalsInit]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly SavmExceptionType Swap<TTracingInst>(int depth)
        where TTracingInst : struct, IFlag
    {
        int head = Head;
        if (head < depth)
        ...
        SavmWord buffer = Unsafe.ReadUnaligned<SavmWord>(ref bottom);
        Unsafe.WriteUnaligned(ref bottom, Unsafe.ReadUnaligned<SavmWord>(ref top));
    ...
    [SkipLocalsInit]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly SavmExceptionType Exchange<TTracingInst>(int n, int m)
        where TTracingInst : struct, IFlag
    {
        int maxDepth = Math.Max(n, m);
        if (!EnsureDepth(maxDepth)) return SavmExceptionType.StackUnderflow;
        ...
        SavmWord buffer = Unsafe.ReadUnaligned<SavmWord>(ref first);
        Unsafe.WriteUnaligned(ref first, Unsafe.ReadUnaligned<SavmWord>(ref second));
    ...
    [StackTraceHidden]
    [DoesNotReturn]
    internal static void ThrowSavmStackUnderflowException()
    {
        Metrics.SavmExceptions++;
        throw new SavmStackUnderflowException();
    }
