...
namespace Nethermind.Savm
{
    public static class ExecutionTypeExtensions
    {
        ...
        /// </summary>
        /// <remarks>
        /// <see cref="ExecutionType.DELEGATECALL"/> carries the caller's value without moving SIL, while
        /// <see cref="ExecutionType.STATICCALL"/> cannot transfer SIL. <see cref="ExecutionType.CALLCODE"/>
