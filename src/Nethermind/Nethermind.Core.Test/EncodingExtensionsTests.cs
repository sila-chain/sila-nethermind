...
public class EncodingExtensionsTests
{
    ...
    // JSON
    [TestCase("""{"id":1,"jsonrpc":"2.0","method":"sil_blockNumber","params":[]}""", 10)]
    [TestCase("""{"id":1,"jsonrpc":"2.0","method":"sil_blockNumber","params":[]}""", 63)]
    [TestCase("""{"id":1,"jsonrpc":"2.0","method":"sil_blockNumber","params":[]}""", 64)]
    // 2-bytes chars
    [TestCase("\u0101\u0102\u0103\u0104\u0105", 1)]
    [TestCase("\u0101\u0102\u0103\u0104\u0105", 3)]
    [TestCase("\u0101\u0102\u0103\u0104\u0105", 5)]
