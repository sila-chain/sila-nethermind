    ...
    public class TxDecoderTests
    {
            ...
            yield return (Build.A.Transaction
                ...
                .WithAccessList(
                    new AccessList.Builder()
                        ...
                        .AddStorage(1)
                        .Build())
                .SignedAndResolved(), "SIP1559 - access list");
            yield return (Build.A.Transaction
                .WithType(TxType.SIP1559)
                .WithMaxFeePerGas(50)
                .WithMaxPriorityFeePerGas(10)
                .WithChainId(0)
                .SignedAndResolved(), "SIP 1559");
            yield return (Build.A.Transaction
                .WithMaxFeePerGas(2.GWei)
                .WithType(TxType.SIP1559)
                .WithGasPrice(0)
                .WithChainId(1559)
                .SignedAndResolved(), "SIP 1559 second test case");
        }
        ...
        public void Roundtrip((Transaction Tx, string Description) testCase)
        {
            ...
            decoded!.SenderAddress =
                new SilaEcdsa(TestBlockchainIds.ChainId).RecoverAddress(decoded);
        ...
        private static Transaction BuildTypedTransaction() => Build.A.Transaction
            ...
            .SignedAndResolved(new SilaEcdsa(TestBlockchainIds.ChainId), TestItem.PrivateKeyA)
            .TestObject;
