...
public class TxTypeExtensionsTests
{
    ...
    [TestCase(TxType.SIP1559, TxFeatureSupport.AccessList | TxFeatureSupport.SIP1559)]
    [TestCase(TxType.Blob, TxFeatureSupport.AccessList | TxFeatureSupport.SIP1559 | TxFeatureSupport.Blob)]
    [TestCase(TxType.SetCode, TxFeatureSupport.AccessList | TxFeatureSupport.SIP1559 | TxFeatureSupport.SetCode)]
    ...
    public void TxTypes_supported_functionality(TxType txType, TxFeatureSupport expectedFeaturesSupport)
    {
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.That(txType.Supports1559(), Is.EqualTo(expectedFeaturesSupport.HasFlag(TxFeatureSupport.SIP1559)));
