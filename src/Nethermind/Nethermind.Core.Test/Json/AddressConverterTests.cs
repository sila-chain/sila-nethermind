...
public class AddressConverterTests : ConverterTestBase<Address>
{
    ...
    public void Address_dictionary_roundtrips_with_global_options()
    {
        ...
        string json = JsonSerializer.Serialize(dictionary, SilaJsonSerializer.JsonOptions);
        Dictionary<Address, int>? result = JsonSerializer.Deserialize<Dictionary<Address, int>>(json, SilaJsonSerializer.JsonOptions);
    ...
    public void AddressAsKey_dictionary_roundtrips_with_global_options()
    {
        ...
        string json = JsonSerializer.Serialize(dictionary, SilaJsonSerializer.JsonOptions);
        Dictionary<AddressAsKey, int>? result = JsonSerializer.Deserialize<Dictionary<AddressAsKey, int>>(json, SilaJsonSerializer.JsonOptions);
