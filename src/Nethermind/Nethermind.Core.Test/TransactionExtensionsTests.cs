...
public class TransactionExtensionsTests
{
        ...
        TransactionPotentialCostsAndEffectiveGasPrice test)
    {
        ...
        UInt256 actualResult = transaction.CalculateTransactionPotentialCost(test.IsSip1559Enabled, test.BaseFee);
        UInt256 effectiveGasPrice = transaction.CalculateEffectiveGasPrice(test.IsSip1559Enabled, test.BaseFee);
