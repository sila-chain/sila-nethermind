...
public class DiscoveryModule(IInitConfig initConfig, INetworkConfig networkConfig) : Module
{
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder
            ...
            .AddSingleton<EnrDiscovery, ISilaEcdsa, IForkInfo, ILogManager>((silaEcdsa, forkInfo, logManager) =>
                CreateEnrDiscovery(silaEcdsa, forkInfo, logManager))
    ...
    private EnrDiscovery CreateEnrDiscovery(ISilaEcdsa silaEcdsa, IForkInfo forkInfo, ILogManager logManager)
    {
        NodeRecordSigner nodeRecordSigner = new(silaEcdsa, new PrivateKeyGenerator().Generate());
