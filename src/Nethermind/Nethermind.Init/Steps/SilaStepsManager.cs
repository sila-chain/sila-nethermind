...
{
    public class SilaStepsManager
    {
        private readonly ILogger _logger;

        private readonly IComponentContext _ctx;
        private readonly ISilaStepsLoader _loader;

        public SilaStepsManager(
            ISilaStepsLoader loader,
            ...
            ILogManager logManager)
        {
            ...
            _logger = logManager?.GetClassLogger<SilaStepsManager>()
        ...
        private List<Task> CreateAndExecuteSteps(CancellationToken cancellationToken)
        {
            ...
            if (_logger.IsDebug) _logger.Debug($"Sila steps dependency tree:\n{BuildStepDependencyTree(stepInfoMap)}");
