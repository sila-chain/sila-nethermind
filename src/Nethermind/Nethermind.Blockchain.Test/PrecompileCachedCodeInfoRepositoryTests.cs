...
public class PrecompileCachedCodeInfoRepositoryTests
{
    ...
    public void Run_AtGivenCachingSupport_ComputesOncePerUniqueInput(bool supportsCaching, int expectedRuns, int expectedEntries)
    {
        ...
        byte[] input = [1, 2, 3];
        Result<byte[]> first = resolved.Run(input, SilaPrague.Instance);
        Result<byte[]> second = resolved.Run(input, SilaPrague.Instance);
    ...
    public void Run_ForDifferentInputs_CreatesSeparateEntries()
    {
        ...
        resolved.Run(new byte[] { 1, 2, 3 }, SilaPrague.Instance);
        resolved.Run(new byte[] { 4, 5, 6 }, SilaPrague.Instance);
        resolved.Run(new byte[] { 1, 2, 3 }, SilaPrague.Instance);
        resolved.Run(new byte[] { 4, 5, 6 }, SilaPrague.Instance);
    ...
    public void Run_WithNormalizedOversizedInputs_DeduplicatesToOneEntry()
    {
        ...
        Result<byte[]> first = resolved.Run(new byte[] { 1, 2, 3, 4, 0xAA, 0xBB }, SilaPrague.Instance);
        Result<byte[]> second = resolved.Run(new byte[] { 1, 2, 3, 4, 0xCC, 0xDD, 0xEE }, SilaPrague.Instance);
    ...
    public void Run_ForInvalidLengthResults_DoesNotCache()
    {
        ...
        Result<byte[]> first = resolved.Run(new byte[] { 1, 2, 3 }, SilaPrague.Instance);
        Result<byte[]> repeat = resolved.Run(new byte[] { 1, 2, 3 }, SilaPrague.Instance);
    ...
    public void Run_ForDifferentSpecs_CreatesSeparateCacheEntries()
    {
        ...
        byte[] input = [1, 2, 3];
        resolved.Run(input, SilaPrague.Instance);
        resolved.Run(input, SilaOsaka.Instance);
        resolved.Run(input, SilaPrague.Instance);
        resolved.Run(input, SilaOsaka.Instance);
    ...
    public void Run_AtSurvivingTierCapacity_EvictsInsteadOfGrowing()
    {
        ...
        resolved.Run(new byte[] { 1 }, SilaPrague.Instance);
        resolved.Run(new byte[] { 2 }, SilaPrague.Instance);
        resolved.Run(new byte[] { 3 }, SilaPrague.Instance);
    ...
    public void Run_WithOversizedEntry_DoesNotSurviveTheBlock()
    {
        ...
        resolved.Run(oversizedInput, SilaPrague.Instance);
        resolved.Run(oversizedInput, SilaPrague.Instance);
