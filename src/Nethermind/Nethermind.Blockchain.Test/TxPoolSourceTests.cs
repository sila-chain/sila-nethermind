...
public class TxPoolSourceTests
{
    ...
    {
        TestSingleReleaseSpecProvider specProvider = new(SilaCancun.Instance);
        ...
        Assert.That(blobsCount, Is.LessThanOrEqualTo((ulong)SilaCancun.Instance.MaxProductionBlobCount(customBlobLimit)));
    }
    ...
    {
        yield return ([1, 2, 4], Sip4844Constants.GasPerBlob * 6);
        yield return ([1, 2, 6], Sip4844Constants.GasPerBlob * 6);
        yield return ([1, 6], Sip4844Constants.GasPerBlob * 6);
        yield return ([6, 1, 5], Sip4844Constants.GasPerBlob * 6);
        yield return ([1, 2], Sip4844Constants.GasPerBlob * 2);
        yield return ([1, 1], Sip4844Constants.GasPerBlob * 2);
        yield return ([2, 1], Sip4844Constants.GasPerBlob * 2);
        yield return ([2, 2], Sip4844Constants.GasPerBlob * 2);
        yield return ([3], Sip4844Constants.GasPerBlob * 2);
    }
    ...
    {
        yield return new TestCaseData(SilaCancun.Instance, null).Returns(SilaCancun.Instance.MaxBlobCount);
        yield return new TestCaseData(SilaPrague.Instance, null).Returns(SilaPrague.Instance.MaxBlobCount);
        ...
        yield return new TestCaseData(SilaPrague.Instance, -1).Returns(SilaPrague.Instance.MaxBlobCount);
        yield return new TestCaseData(SilaPrague.Instance, 0).Returns(0ul);
