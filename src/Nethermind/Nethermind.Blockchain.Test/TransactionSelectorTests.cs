...
namespace Nethermind.Blockchain.Test
{
    ...
    public class TransactionSelectorTests
    {
        ...
        public static IEnumerable Sip1559LegacyTransactionTestCases
        {
            get
            {
                ProperTransactionsSelectedTestCase allTransactionsSelected = ProperTransactionsSelectedTestCase.Sip1559DefaultLegacyTransactions;
                ...
                ProperTransactionsSelectedTestCase baseFeeLowerThanGasPrice = ProperTransactionsSelectedTestCase.Sip1559DefaultLegacyTransactions;
                ...
                ProperTransactionsSelectedTestCase baseFeeGreaterThanGasPrice = ProperTransactionsSelectedTestCase.Sip1559DefaultLegacyTransactions;
        ...
        public static IEnumerable Sip1559TestCases
        {
            get
            {
                ProperTransactionsSelectedTestCase allTransactionsSelected = ProperTransactionsSelectedTestCase.Sip1559Default;
                allTransactionsSelected.BaseFee = 0;
                allTransactionsSelected.ExpectedSelectedTransactions.AddRange(
                    allTransactionsSelected.Transactions.OrderBy(t => t.Nonce));
                yield return new TestCaseData(allTransactionsSelected).SetName("SIP1559 transactions: All transactions selected - 0 BaseFee");

                ProperTransactionsSelectedTestCase baseFeeLowerThanGasPrice = ProperTransactionsSelectedTestCase.Sip1559Default;
                baseFeeLowerThanGasPrice.BaseFee = 5;
                baseFeeLowerThanGasPrice.ExpectedSelectedTransactions.AddRange(
                    baseFeeLowerThanGasPrice.Transactions.OrderBy(t => t.Nonce));
                yield return new TestCaseData(baseFeeLowerThanGasPrice).SetName("SIP1559 transactions: All transactions selected - BaseFee lower than gas price");

                ProperTransactionsSelectedTestCase baseFeeGreaterThanGasPrice = ProperTransactionsSelectedTestCase.Sip1559Default;
                baseFeeGreaterThanGasPrice.BaseFee = 1.GWei;
                yield return new TestCaseData(baseFeeGreaterThanGasPrice).SetName("SIP1559 transactions: None transactions selected - BaseFee greater than gas price");
                ...
                ProperTransactionsSelectedTestCase balanceCheckWithTxValue = new()
                {
                    ...
                    Transactions =
                    {
                        Build.A.Transaction.WithSenderAddress(TestItem.AddressA).WithType(TxType.SIP1559).WithNonce(2)
                            .WithMaxFeePerGas(4).WithGasLimit(10).SignedAndResolved(TestItem.PrivateKeyA).TestObject,
                        Build.A.Transaction.WithSenderAddress(TestItem.AddressA).WithType(TxType.SIP1559).WithNonce(1)
                ...
                balanceCheckWithTxValue.ExpectedSelectedTransactions.AddRange(
                    new[] { 1 }.Select(i => balanceCheckWithTxValue.Transactions[i]));
                yield return new TestCaseData(balanceCheckWithTxValue).SetName("SIP1559 transactions: one transaction selected because of account balance");
                ...
                ProperTransactionsSelectedTestCase balanceCheckWithGasPremium = new()
                {
                    ...
                    Transactions =
                    {
                        ...
                        Build.A.Transaction.WithSenderAddress(TestItem.AddressA).WithNonce(1)
                            .WithMaxFeePerGas(30).WithMaxPriorityFeePerGas(25).WithGasLimit(10).WithType(TxType.SIP1559).WithValue(60).SignedAndResolved(TestItem.PrivateKeyA).TestObject,
                    },
                    GasLimit = 10000000
                };
                balanceCheckWithGasPremium.ExpectedSelectedTransactions.AddRange(
                    new[] { 1 }.Select(i => balanceCheckWithGasPremium.Transactions[i]));
                yield return new TestCaseData(balanceCheckWithGasPremium).SetName("SIP1559 transactions: one transaction selected because of account balance and miner tip");
            }
        }
        ...
        public static IEnumerable EnoughShardBlobTransactionsSelectedTestCases
        {
            get
            {
                ProperTransactionsSelectedTestCase maxTransactionsSelected = ProperTransactionsSelectedTestCase.Sip1559Default;
                maxTransactionsSelected.ReleaseSpec = SilaCancun.Instance;
                ...
                ProperTransactionsSelectedTestCase enoughTransactionsSelected =
                    ProperTransactionsSelectedTestCase.Sip1559Default;
                enoughTransactionsSelected.ReleaseSpec = SilaCancun.Instance;
                ...
                ProperTransactionsSelectedTestCase higherPriorityTransactionsSelected = ProperTransactionsSelectedTestCase.Sip1559Default;
                ...
                higherPriorityTransactionsSelected.ReleaseSpec = SilaCancun.Instance;
        ...
        [TestCaseSource(nameof(Sip1559LegacyTransactionTestCases))]
        [TestCaseSource(nameof(Sip1559TestCases))]
        ...
        public class ProperTransactionsSelectedTestCase
        {
            ...
            public static ProperTransactionsSelectedTestCase Sip1559DefaultLegacyTransactions =>
                new()
                {
                    ReleaseSpec = London.Instance,
                    BaseFee = 1.GWei,
            ...
            public static ProperTransactionsSelectedTestCase Sip1559Default =>
                new()
                {
                    ReleaseSpec = London.Instance,
                    BaseFee = 1.GWei,
                    ...
                    Transactions =
                    {
                        Build.A.Transaction.WithSenderAddress(TestItem.AddressA).WithType(TxType.SIP1559).WithNonce(3).WithValue(1)
                            .WithMaxFeePerGas(10).WithGasLimit(10).SignedAndResolved(TestItem.PrivateKeyA).TestObject,
                        Build.A.Transaction.WithSenderAddress(TestItem.AddressA).WithType(TxType.SIP1559).WithNonce(1).WithValue(10)
                            .WithMaxFeePerGas(10).WithGasLimit(10).SignedAndResolved(TestItem.PrivateKeyA).TestObject,
                        Build.A.Transaction.WithSenderAddress(TestItem.AddressA).WithType(TxType.SIP1559).WithNonce(2).WithValue(10)
                            .WithMaxFeePerGas(10).WithGasLimit(10).SignedAndResolved(TestItem.PrivateKeyA).TestObject
                    },
                    GasLimit = 10000000
                };
