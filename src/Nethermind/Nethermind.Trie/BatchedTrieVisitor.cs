...
/// to increase linearly. For sila-mainnet it seems to be 1Gb. Increasing the working
/// set decreases reads, however up to a certain point, the time taken for writes is much higher than read, so no
/// point in increasing memory budget further. For sila-mainnet, that seems to be 8Gb.
/// </summary>
