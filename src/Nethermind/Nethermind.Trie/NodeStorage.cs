    ...
    : INodeStorage
{
    ...
    private static Span<byte> GetHalfPathNodeStoragePathSpan(Span<byte> pathSpan, in ValueHash256? address, in TreePath path, in ValueHash256 keccak)
    {
        ...
        //
        // Technically, you'll need 9 byte for state and 8 byte for storage on sila-mainnet for the path. But we want to keep
        ...
        // On sila-mainnet, the out-of-order key is around 0.03% for address and 0.07% for storage.
