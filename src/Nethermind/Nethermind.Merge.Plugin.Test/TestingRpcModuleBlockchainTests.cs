...
/// <summary>
/// Regression tests for https://github.com/sila-chain/sila-nethermind/issues/11979:
...
public class TestingRpcModuleBlockchainTests : BaseEngineModuleTests
{
    ...
    {
        using MergeTestBlockchain chain = await CreateBlockchain(releaseSpec: SilaOsaka.Instance);
