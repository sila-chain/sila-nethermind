...
{
    /// <summary>
    /// SIP-1186 style proof collector.
    ...
    public class AccountProofCollector : ITreeVisitor<TreePathContextWithStorage>
    {
        ...
        {
            // SIP-1186 distinguishes a non-existent account from an empty existing account by
        ...
        private void AddProofItem(TrieNode node, in TreePathContextWithStorage ctx)
        {
            ...
            // RLP, so SIP-1186 / go-sila convention is to omit them from the proof entries.
