...
public class TracedAccessWorldState(IWorldState state, bool parallel) : WorldStateDecorator(state), IBlockAccessListSource
{
    ...
    // the returned span is consumed by the SAVM stack push before another GetInternal runs.
    ...
    private bool? AccountExistsCurrent(Address address)
    {
        ...
        // SIP-7928: code-only modifications (e.g. SIP-7702 SetCode) also imply existence at this index.
