...
using Nethermind.Savm.Test.Tracing;
...
public class VirtualMachineTests : VirtualMachineTestsBase
{
    ...
    private static void AssertFirstPushTrace(GethLikeTxTrace trace)
    {
        ...
        using JsonDocument doc = JsonDocument.Parse(new SilaJsonSerializer().Serialize(trace));
    ...
    public void Sload()
    {
        ...
        Assert.That(receipt.GasSpent, Is.EqualTo(GasCostOf.Transaction + GasCostOf.VeryLow * 1 + GasCostOf.SLoadSip150), "gas");
    }
    ...
    public void Exp_2_160()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            Assert.That(receipt.GasSpent, Is.EqualTo(GasCostOf.Transaction + GasCostOf.VeryLow * 3 + GasCostOf.SSet + GasCostOf.Exp + GasCostOf.ExpByteSip160), "gas");
    ...
    public void Exp_0_160()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            Assert.That(receipt.GasSpent, Is.EqualTo(GasCostOf.Transaction + GasCostOf.VeryLow * 3 + GasCostOf.Exp + GasCostOf.ExpByteSip160 + GasCostOf.SReset), "gas");
    ...
    public void Exp_1_160()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            Assert.That(receipt.GasSpent, Is.EqualTo(GasCostOf.Transaction + GasCostOf.VeryLow * 3 + GasCostOf.Exp + GasCostOf.ExpByteSip160 + GasCostOf.SSet), "gas");
            Assert.That(TestState.Get(new StorageCell(Recipient, 0)).ToArray(), Is.EqualTo(BigInteger.One.ToBigEndianByteArray()), "storage");
        }
    }
    ...
    public void Revert()
    {
        // See: https://sips.sila.org/SIPS/sip-140
        ...
        using (Assert.EnterMultipleScope())
        {
            Assert.That(receipt.Error, Is.EqualTo(Nethermind.Savm.TransactionSubstate.Revert));
