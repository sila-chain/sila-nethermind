...
public class KzgPointEvaluationPrecompileTests
{
    ...
    {
        (ReadOnlyMemory<byte> output, bool success) = KzgPointEvaluationPrecompile.Instance.Run(input, SilaCancun.Instance);
    ...
    public void Test_PointEvaluationPrecompile_Has_Specific_Constant_Gas_Cost(byte[] input)
    {
        ...
        ulong gasSpent = KzgPointEvaluationPrecompile.Instance.DataGasCost(input, SilaCancun.Instance) +
                        KzgPointEvaluationPrecompile.Instance.BaseGasCost(SilaCancun.Instance);
