...
namespace Nethermind.Savm.Test
{
    ...
    public class Sip2565Tests
    {
        ...
        public void Simple_routine([Random(int.MinValue, int.MaxValue, 100)] int seed)
        {
            ...
            Prepare input = Prepare.SavmCode.FromCode(randomInput);
        ...
        {
            Prepare input = Prepare.SavmCode.FromCode("");
        ...
        {
            Prepare input = Prepare.SavmCode.FromCode(inputStr);
        ...
        public void ModExp_return_expected_values(string inputHex, string expectedResult, bool isError = false)
        {
            ...
            Result<byte[]> result = ModExpPrecompile.Instance.Run(input, SilaOsaka.Instance);
