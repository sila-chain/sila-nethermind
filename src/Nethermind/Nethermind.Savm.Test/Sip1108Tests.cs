...
public class Sip1108Tests : VirtualMachineTestsBase
{
    ...
    public void Test_add(long blockAdjustment, ulong expectedPrecompileGas)
    {
        ...
        AssertGas(result, 21000 + 4 * 12 + 7 * 3 + GasCostOf.CallSip150 + expectedPrecompileGas);
    }
    ...
    public void Test_pairing(long blockAdjustment, ulong expectedPrecompileGas)
    {
        ...
        Assert.That(result.StatusCode, Is.EqualTo(StatusCode.Success));
        AssertGas(result, 21000 + 6 * 12 + 7 * 3 + GasCostOf.CallSip150 + expectedPrecompileGas);
    }
}
