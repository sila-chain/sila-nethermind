...
public class CodeInfoRepositoryTests
{
    ...
    public static IEnumerable<TestCaseData> NotDelegationCodeCases()
    {
        ...
        byte[] code = [.. Sip7702Constants.DelegationHeader, .. rndAddress];
        ...
        code = [.. Sip7702Constants.DelegationHeader, .. rndAddress];
        ...
        code = [.. Sip7702Constants.DelegationHeader, .. new byte[21]];
        yield return new TestCaseData(code).SetName("Address too long (21 bytes)");
        code = [.. Sip7702Constants.DelegationHeader, .. new byte[19]];
    ...
    public void TryGetDelegation_CodeIsNotDelegation_ReturnsFalse(byte[] code)
    {
        ...
        SilaCodeInfoRepository sut = new(stateProvider);
    ...
    public void TryGetDelegation_AccountWithoutCode_DoesNotLoadCodeInfo(bool createAccount)
    {
        ...
        CodeInfoRepository sut = new(stateProvider, new SilaPrecompileProvider(), (_, _, _) =>
        {
    ...
    public static IEnumerable<TestCaseData> DelegationCodeCases()
    {
        ...
        byte[] code = [.. Sip7702Constants.DelegationHeader, .. address];
        ...
        code = [.. Sip7702Constants.DelegationHeader, .. address];
