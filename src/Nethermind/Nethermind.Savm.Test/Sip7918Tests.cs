...
[TestFixture]
public class Sip7918Tests : VirtualMachineTestsBase
{
    [Test]
    ...
    {
        IReleaseSpec[] specs = [SilaOsaka.Instance];
        ...
        ExcessBlobGasTestCaseSource(IReleaseSpec spec)
    {
        ...
        ulong blobGasUsed = (ulong)blobsUsed * Sip4844Constants.GasPerBlob;
        yield return (
            1000,
            blobsUsed,
            1_000_000_000,
        ...
        UInt256 baseFeePerGas = targetCost / Sip7918Constants.BlobBaseCost;
