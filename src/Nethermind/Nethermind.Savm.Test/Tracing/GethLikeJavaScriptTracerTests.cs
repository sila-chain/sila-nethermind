...
public class GethLikeJavaScriptTracerTests : VirtualMachineTestsBase
{
    ...
    private GethLikeBlockJavaScriptTracer GetTracer(string userTracer) => new(TestState, SilaShanghai.Instance, GethTraceOptions.Default with { EnableMemory = true, Tracer = userTracer });
    ...
    private static byte[] MStore() => Prepare.SavmCode
    ...
    private static byte[] SStore_double() => Prepare.SavmCode
            .PushData(SampleHexData1.PadLeft(64, '0'))
            .PushData(0)
    ...
    private static byte[] SStore() => Prepare.SavmCode
            .PushData(SampleHexData2.PadLeft(64, '0'))
            .PushData(SampleHexData1.PadLeft(64, '0'))
    ...
    public void complex_tracer()
    {
        ...
        TestContext.Out.WriteLine(GetSilaJsonSerializer().Serialize(traces.CustomTracerResult));
    }
    ...
    private static SilaJsonSerializer GetSilaJsonSerializer() => new();
