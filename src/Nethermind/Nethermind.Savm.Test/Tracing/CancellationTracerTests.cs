...
namespace Nethermind.Savm.Test.Tracing
{
    ...
    public class CancellationTracerTests
    {
        ...
        public void Throws_operation_canceled_when_token_is_cancelled()
        {
            ...
            Assert.Throws<OperationCanceledException>(() => tracer.ReportActionError(SavmExceptionType.None));
        }
        ...
        public async Task Does_not_throw_if_cancellation_token_is_default()
        {
            ...
            Assert.DoesNotThrow(() => tracer.ReportActionError(SavmExceptionType.None));
        }
