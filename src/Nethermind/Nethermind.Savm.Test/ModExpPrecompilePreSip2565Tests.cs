...
#pragma warning disable CS0618 // ModExpPrecompilePreSip2565 is Obsolete
public class ModExpPrecompilePreSip2565Tests : PrecompileTests<ModExpPrecompilePreSip2565, ModExpPrecompilePreSip2565Tests>, IPrecompileTests
{
    ...
    public void NormalizedInput_SameOutput(string input, string trailing) =>
        RunEffectiveInputTest(ModExpPrecompilePreSip2565.Instance, input, trailing, Byzantium.Instance);
