...
namespace Nethermind.Savm.Test
{
    public class TestAllTracerWithOutput : TxTracer
    {
        ...
        public List<SavmExceptionType> ReportedActionErrors { get; set; } = [];
        ...
        public override void ReportActionError(SavmExceptionType exceptionType) => ReportedActionErrors.Add(exceptionType);
