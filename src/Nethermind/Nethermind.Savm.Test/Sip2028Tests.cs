...
{
    [TestFixture]
    public class Sip2028Tests : VirtualMachineTestsBase
    {
        ...
        [TestCase(true, GasCostOf.TxDataNonZeroSip2028, Description = "After Istanbul non-zero cost is 16")]
        ...
        public void Non_zero_transaction_data_cost(bool isIstanbul, ulong expectedNonZeroCost)
        {
            ...
            Assert.That(cost, Is.EqualTo(new SilaIntrinsicGas(Standard: GasCostOf.Transaction + expectedNonZeroCost,
                FloorGas: 0)));
        }
