...
public class Sip1052Tests : VirtualMachineTestsBase
{
    ...
    public void Non_existing_account_returns_0()
    {
        ...
        TestAllTracerWithOutput result = Execute(code);
        AssertGas(result,
            21000 + GasCostOf.VeryLow * 2 + GasCostOf.SStoreNetMeteredSip1283 + GasCostOf.ExtCodeHash);
    ...
    {
        byte[] callAndRevertCode = Prepare.SavmCode
    ...
    {
        TestState.CreateAccount(TestItem.AddressC, 0.Sila);
    ...
    public void Newly_created_empty_account_returns_empty_data_hash()
    {
        ...
        // todo: so far SIP does not define whether it should be zero or empty data
