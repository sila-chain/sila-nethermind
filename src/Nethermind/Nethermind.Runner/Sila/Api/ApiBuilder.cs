...
namespace Nethermind.Runner.Sila.Api;

public class ApiBuilder
{
    private readonly IConfigProvider _configProvider;
    private readonly SilaJsonSerializer _jsonSerializer;
    ...
    public ApiBuilder(IProcessExitSource processExitSource, IConfigProvider configProvider, ILogManager logManager)
    {
        ...
        SilaJsonSerializer.StrictHexFormat = jsonRpcConfig.StrictHexFormat;
        _jsonSerializer = new SilaJsonSerializer(jsonRpcConfig.JsonSerializationMaxDepth);
        ChainSpec = LoadChainSpec(_jsonSerializer);
    }

    public SilaRunner CreateSilaRunner(IEnumerable<INethermindPlugin> plugins)
    {
        ...
        return container.Resolve<SilaRunner>();
    }

    private ChainSpec LoadChainSpec(SilaJsonSerializer silaJsonSerializer)
    {
        ...
        ChainSpecFileLoader loader = new(silaJsonSerializer, _logManager);
