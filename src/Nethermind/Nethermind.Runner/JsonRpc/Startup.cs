...
public class Startup : IStartup
{
    ...
    private SilaJsonSerializer _jsonSerializer = null!;
    ...
    internal Startup(
        ...
        SilaJsonSerializer jsonSerializer,
    ...
    public void Configure(IApplicationBuilder app)
    {
        ...
        Configure(
            ...
            services.GetRequiredService<SilaJsonSerializer>(),
            services.GetRequiredService<ApplicationLifetime>());
    }

    public void Configure(IApplicationBuilder app, IWebHostEnvironment env, JsonRpcProcessor jsonRpcProcessor, JsonRpcService jsonRpcService, IJsonRpcLocalStats jsonRpcLocalStats, SilaJsonSerializer jsonSerializer, ApplicationLifetime lifetime)
    {
        SilaJsonSerializer.AddTypeInfoResolver(FacadeJsonContext.Default, JsonTypeInfoResolverPriority.Facade);
        SilaJsonSerializer.AddTypeInfoResolver(SilRpcJsonContext.Default, JsonTypeInfoResolverPriority.SilRpc);
        SilaJsonSerializer.AddTypeInfoResolver(JsonRpcResponseJsonContext.Default, JsonTypeInfoResolverPriority.JsonRpcResponse);

        SilaJsonSerializer.WarmupSerializer(
