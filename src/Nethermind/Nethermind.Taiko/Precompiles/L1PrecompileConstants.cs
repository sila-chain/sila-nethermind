...
public static class L1PrecompileConstants
{
    ...
    /// Matches the SAVM <c>BLOCKHASH</c> opcode window and bounds the state roots the prover must verify.
    /// </summary>
    public const long MaxBlockLookback = 256;

    /// <summary>
    /// Timeout for L1 RPC calls (sil_call, sil_getStorageAt).
    /// </summary>
    ...
    /// <summary>
    /// Per-byte calldata cost matching SAVM CALLDATACOPY (16 gas/byte, SIP-2028).
    /// </summary>
    public const ulong L1StaticCallPerByteCalldataCost = 16UL;
    /// <summary>
    /// Maximum return data size (24 KB, matches MAX_CODE_SIZE per SIP-170).
    /// </summary>
