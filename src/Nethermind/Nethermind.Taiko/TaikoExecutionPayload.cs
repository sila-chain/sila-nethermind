...
{
    /// <summary>
    /// Taiko always uses V2 payloads regardless of the SAVM spec (SilaCancun/SilaPrague/SilaOsaka).
    /// The base ValidateFork would reject V2 payloads when SIP-4844 is active.
    /// </summary>
    ...
    /// IsSip4844Enabled, demanding V3. Skip that check entirely for Taiko.
    /// </summary>
    ...
    /// determine which SIPs are active at the block's timestamp so header fields that V2 payloads
    ...
    /// SIPs at the block's timestamp.  Must be called before <see cref="TryGetBlock"/> is
    ...
    /// Also copies the SIP-4844 header fields (<see cref="Block.BlobGasUsed"/> and
    ...
    /// SIP-4788 / SIP-4844 / SIP-7685 timestamps also matches alethia-reth. The spec provider is
