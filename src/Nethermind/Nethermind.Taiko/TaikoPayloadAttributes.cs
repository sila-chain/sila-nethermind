...
public class TaikoPayloadAttributes : PayloadAttributes
{
        ...
        [NotNullWhen(false)] out string? error)
    {
        ...
        // Taiko always uses V2 engine API payloads regardless of the active SAVM fork
        // (SilaCancun/SilaPrague/SilaOsaka). Skip the base fork-version check which would reject
        // V2 attributes once SIP-4844 is active and demand V3.
        error = null;
