...
/// <summary>
/// Taiko-specific decorator for <see cref="ISilSyncingInfo"/> that accounts for
/// beacon-sync headers when computing the <c>sil_syncing</c> response.
/// </summary>
/// <remarks>
...
/// <c>max(BestSuggestedHeader, BestSuggestedBeaconHeader)</c> so <c>sil_syncing</c>
...
/// <paramref name="inner"/>, because <see cref="SilSyncingInfo.UpdateAndGetSyncTime"/>
/// keys off the inner's beacon-unaware <see cref="SilSyncingInfo.IsSyncing"/>, which
    ...
    ISilSyncingInfo inner) : ISilSyncingInfo
{
    ...
    public SyncingResult GetFullInfo()
    {
        ...
        bool isSyncing = bestSuggestedNumber == 0 || bestSuggestedNumber > headNumberOrZero + SilSyncingInfo.MaxDistanceForSynced;
