...
/// </summary>
/// <remarks>
/// The precompile providers are stored in static fields that the SAVM reads during transaction/block
/// execution, so they must be configured before the earliest possible SAVM execution. That earliest
