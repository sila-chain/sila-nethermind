...
public class TaikoChainSpecEngineParameters : IChainSpecEngineParameters
{
    ...
    public void AddTransitions(SortedSet<ulong> blockNumbers, SortedSet<ulong> timestamps)
    {
        ...
        // SIP-2124 excludes pre-genesis activations from the fork-id walk. Folding a 0-timestamp
        ...
        // into the SIP-2124 fork-id walk. The SortedSet dedups a schedule that activates exactly at
