    ...
    FrozenDictionary<AddressAsKey, ushort>? precompileMultipliers = null)
{
    ...
    /// <summary>Charges the flat per-transaction intrinsic ZK gas before SAVM execution begins.</summary>
    ...
    /// so canonical SAVM precompiles and Taiko-extended precompiles can coexist without colliding
    ...
    /// updated. The opcode has already executed inside the SAVM (the tracer charges after
