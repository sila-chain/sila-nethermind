                ...
                logManager), ITaikoEngineRpcModule
{
    ...
    /// networks with no last-Pacaya threshold (Devnet, Masaya, unknown). On SilaMainnet and Hoodi,
    ...
    public Task<ResultWrapper<PayloadStatusV1>> engine_newPayloadV1(TaikoExecutionPayload executionPayload)
    {
        ...
        // carry: ParentBeaconBlockRoot (SIP-4788, [JsonIgnore]) and RequestsHash (SIP-7685, not a payload field).
