...
public class WarmupBenchmark
{
    ...
    private Transaction _sip1559Tx = null!;
    ...
    public void GlobalSetup()
    {
        ...
        _stateProvider.CreateAccount(TestItem.AddressA, 1_000_000_000.Sila);
        ...
        _processor.Warmup(_sip1559Tx, NullTxTracer.Instance);
    ...
    /// <summary>Warmup: simple SIL transfer — baseline for warmup path.</summary>
    ...
    /// <summary>Warmup: SIP-2930 access-list transaction.</summary>
    ...
    /// <summary>Warmup: SIP-1559 type-2 transaction.</summary>
    [Benchmark(OperationsPerInvoke = N)]
    public TransactionResult Warmup_Sip1559Tx()
    {
        TransactionResult result = default;
        for (int i = 0; i < N; i++)
            result = _processor.Warmup(_sip1559Tx, NullTxTracer.Instance);
        return result;
    }
    ...
    /// <summary>CallAndRestore: simple SIL transfer — reference comparison.</summary>
    [Benchmark(OperationsPerInvoke = N)]
