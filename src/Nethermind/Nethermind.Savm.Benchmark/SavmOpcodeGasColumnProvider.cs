...
public sealed class SavmOpcodeGasColumnProvider : IColumnProvider
{
    ...
    private abstract class BaseOpcodeGasColumn : IColumn
    {
            ...
            out Statistics stats)
        {
            ...
            if (benchmarkCase.Descriptor.Type != typeof(SavmOpcodesBenchmark))
            {
                return false;
            }

            object opcodeValue = benchmarkCase.Parameters.Items
                .FirstOrDefault(p => p.Name == nameof(SavmOpcodesBenchmark.Opcode))
                ?.Value;
            ...
            long? estimatedGas = GasByOpcode.GetOrAdd(
                opcode,
                static op => SavmOpcodesBenchmark.TryEstimateOpcodeGas(op, out long measuredGas) ? measuredGas : null);
        ...
        public bool IsAvailable(Summary summary) =>
            summary.BenchmarksCases.Any(static c => c.Descriptor.Type == typeof(SavmOpcodesBenchmark));
    }
    ...
    private sealed class OpcodeThresholdColumn : IColumn
    {
        ...
        public string GetValue(Summary summary, BenchmarkCase benchmarkCase)
        {
            ...
            return SavmOpcodesBenchmark.GetThresholdPercent(opcode)
