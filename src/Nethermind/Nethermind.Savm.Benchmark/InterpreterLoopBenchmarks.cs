...
namespace Nethermind.Savm.Benchmark
{
    ...
    public class InterpreterLoopBenchmarks
    {
        ...
        public void GlobalSetup()
        {
            ...
            _stateProvider.CreateAccount(_calleeAddress, 1.Sila);
            ...
            _virtualMachine = new SilaVirtualMachine(new TestBlockhashProvider(), MainnetSpecProvider.Instance, new OneLoggerLogManager(NullLogger.Instance));
        ...
        private void Execute(CodeInfo codeInfo, ulong gasLimit)
        {
            ...
            using (VmState<SilaGasPolicy> vmState = VmState<SilaGasPolicy>.RentTopLevel(
                SilaGasPolicy.FromULong(gasLimit),
        ...
        private static byte[] BuildCalleeCode() => Prepare.SavmCode
            .PushData(42)
            .PushData(0)
