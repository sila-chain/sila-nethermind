    ...
    public partial class BlockProcessor
    {
            ...
            : IBlockProductionTransactionPicker
        {
            ...
            public virtual AddingTxEventArgs CanAddTransaction(Block block, Transaction currentTx, IReadOnlySet<Transaction> transactionsInBlock, IReadOnlyStateProvider stateProvider)
            {
                ...
                if (!ignoreSip3607 && stateProvider.IsInvalidContractSender(spec, currentTx.SenderAddress))
                {
            ...
            {
                bool sip1559Enabled = releaseSpec.IsSip1559Enabled;
                UInt256 transactionPotentialCost = transaction.CalculateTransactionPotentialCost(sip1559Enabled, block.BaseFeePerGas);
                ...
                if (!transaction.IsServiceTransaction && sip1559Enabled)
                {
