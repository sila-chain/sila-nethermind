...
namespace Nethermind.Consensus.Processing
{
    ...
    public enum ProcessingOptions
    {
        ...
        /// <summary>
        /// SAVM tracing needs to process blocks without storing the data on chain.
        /// </summary>
        Trace = ForceProcessing | ReadOnlyChain | LoadNonceFromState | NoValidation,

        /// <summary>
        /// SAVM tracing needs to process one or more transactions on top of the specified block (instead of the previous one)
        ...
        /// </summary>
        SilaMerge = MarkAsProcessed | DoNotUpdateHead | IgnoreParentNotOnMainChain
    }
