...
namespace Nethermind.Consensus.Processing
{
    ...
    public class ProcessingStats : IProcessingStats
    {
        ...
        /// the slow-block JSON so cross-client consumers can normalise SAVM/state counter values
        ...
        private long _startSip7702DelegationsSet;
        private long _startSip7702DelegationsCleared;
        ...
        {
            // SAVM counters — always captured (used by normal console reporting).
            ...
            _startSLoadOps = Savm.Metrics.MainThreadSLoadOpcode;
            _startSStoreOps = Savm.Metrics.MainThreadSStoreOpcode;
            _startCallOps = Savm.Metrics.MainThreadCalls;
            _startEmptyCalls = Savm.Metrics.MainThreadEmptyCalls;
            _startCachedContractsUsed = Savm.Metrics.MainThreadCodeDbCache;
            _startContractsAnalyzed = Savm.Metrics.MainThreadContractsAnalysed;
            _startCreateOps = Savm.Metrics.MainThreadCreates;
            _startSelfDestructOps = Savm.Metrics.MainThreadSelfDestructs;
            _startOpCodes = Savm.Metrics.MainThreadOpCodes;
            ...
            _startCodeBytesRead = Savm.Metrics.MainThreadCodeBytesRead;
            _startAccountWrites = Savm.Metrics.MainThreadAccountWrites;
            _startAccountDeleted = Savm.Metrics.MainThreadAccountDeleted;
            _startStorageWrites = Savm.Metrics.MainThreadStorageWrites;
            _startStorageDeleted = Savm.Metrics.MainThreadStorageDeleted;
            _startCodeWrites = Savm.Metrics.MainThreadCodeWrites;
            _startCodeBytesWritten = Savm.Metrics.MainThreadCodeBytesWritten;
            _startStateHashTime = Savm.Metrics.MainThreadStateHashTime;
            _startCommitTime = Savm.Metrics.MainThreadCommitTime;
            ...
            _startCodeCacheHits = Savm.Metrics.MainThreadCodeDbCache;
            _startCodeCacheMisses = Savm.Metrics.MainThreadCodeReads;
            _startSip7702DelegationsSet = Savm.Metrics.MainThreadSip7702DelegationsSet;
            _startSip7702DelegationsCleared = Savm.Metrics.MainThreadSip7702DelegationsCleared;
            _startStorageMerkleTime = Savm.Metrics.MainThreadStorageMerkleTime;
            _startStateRootTime = Savm.Metrics.MainThreadStateRootTime;
            _startBloomsTime = Savm.Metrics.MainThreadBloomsTime;
            _startReceiptsRootTime = Savm.Metrics.MainThreadReceiptsRootTime;
        }
        ...
        public void UpdateStats(IReadOnlyList<Block> blocks, BlockHeader? baseBlock, long blockProcessingTimeInMicros)
        {
            ...
            blockData.CurrentOpCodes = Savm.Metrics.MainThreadOpCodes;
            blockData.CurrentSLoadOps = Savm.Metrics.MainThreadSLoadOpcode;
            blockData.CurrentSStoreOps = Savm.Metrics.MainThreadSStoreOpcode;
            blockData.CurrentCallOps = Savm.Metrics.MainThreadCalls;
            blockData.CurrentEmptyCalls = Savm.Metrics.MainThreadEmptyCalls;
            blockData.CurrentCachedContractsUsed = Savm.Metrics.MainThreadCodeDbCache;
            blockData.CurrentContractsAnalyzed = Savm.Metrics.MainThreadContractsAnalysed;
            blockData.CurrentCreatesOps = Savm.Metrics.MainThreadCreates;
            blockData.CurrentSelfDestructOps = Savm.Metrics.MainThreadSelfDestructs;
            ...
            {
                blockData.DeltaAccountWrites = Savm.Metrics.MainThreadAccountWrites - _startAccountWrites;
                blockData.DeltaAccountDeleted = Savm.Metrics.MainThreadAccountDeleted - _startAccountDeleted;
                blockData.DeltaStorageWrites = Savm.Metrics.MainThreadStorageWrites - _startStorageWrites;
                blockData.DeltaStorageDeleted = Savm.Metrics.MainThreadStorageDeleted - _startStorageDeleted;
                blockData.DeltaCodeWrites = Savm.Metrics.MainThreadCodeWrites - _startCodeWrites;
                blockData.DeltaCodeBytesWritten = Savm.Metrics.MainThreadCodeBytesWritten - _startCodeBytesWritten;
                blockData.DeltaStateHashTime = Savm.Metrics.MainThreadStateHashTime - _startStateHashTime;
                blockData.DeltaCommitTime = Savm.Metrics.MainThreadCommitTime - _startCommitTime;
                ...
                blockData.DeltaCodeCacheHits = Savm.Metrics.MainThreadCodeDbCache - _startCodeCacheHits;
                blockData.DeltaCodeCacheMisses = Savm.Metrics.MainThreadCodeReads - _startCodeCacheMisses;
                ...
                blockData.DeltaCodeBytesRead = Savm.Metrics.MainThreadCodeBytesRead - _startCodeBytesRead;
                blockData.DeltaSip7702DelegationsSet = Savm.Metrics.MainThreadSip7702DelegationsSet - _startSip7702DelegationsSet;
                blockData.DeltaSip7702DelegationsCleared = Savm.Metrics.MainThreadSip7702DelegationsCleared - _startSip7702DelegationsCleared;
                blockData.DeltaStorageMerkleTime = Savm.Metrics.MainThreadStorageMerkleTime - _startStorageMerkleTime;
                blockData.DeltaStateRootTime = Savm.Metrics.MainThreadStateRootTime - _startStateRootTime;
                blockData.DeltaBloomsTime = Savm.Metrics.MainThreadBloomsTime - _startBloomsTime;
                blockData.DeltaReceiptsRootTime = Savm.Metrics.MainThreadReceiptsRootTime - _startReceiptsRootTime;
        ...
        protected virtual void GenerateReport(BlockData data)
        {
            ...
            if (Savm.Metrics.GasPriceMax != 0f)
            {
                float minGas = Savm.Metrics.GasPriceMin;
                float medianGas = Math.Max(minGas, Savm.Metrics.GasPriceMedian);
                float aveGas = Savm.Metrics.GasPriceAve;
                float maxGas = Savm.Metrics.GasPriceMax;
            ...
            NewProcessingStatistics?.Invoke(this, new BlockStatistics()
            {
                ...
                MinGas = Savm.Metrics.GasPriceMin,
                MedianGas = Math.Max(Savm.Metrics.GasPriceMin, Savm.Metrics.GasPriceMedian),
                AveGas = Savm.Metrics.GasPriceAve,
                MaxGas = Savm.Metrics.GasPriceMax,
            ...
            if (_logger.IsInfo)
            {
                ...
                // null pre-SilaAmsterdam, so a parallel-configured node correctly shows sequential pre-fork.
        ...
        /// so <c>savm.*</c> and <c>state_reads/writes.*</c> counters sum across all workers (not
        ...
        private void LogSlowBlock(Block block, BlockData data, double mgasPerSec)
        {
            ...
            try
            {
                ...
                // savm_ms: pure SAVM execution (excludes blooms + receipts root as well)
                double savmMs = totalMs - stateHashMs - commitMs - bloomsMs - receiptsRootMs;
                if (savmMs < 0)
                {
                    if (_logger.IsDebug) _logger.Debug($"Slow block {block.Number}: savmMs clamped to executionMs ({executionMs:F3}ms): stateHashMs={stateHashMs:F3} commitMs={commitMs:F3} bloomsMs={bloomsMs:F3} receiptsRootMs={receiptsRootMs:F3}");
                    savmMs = executionMs;
                }
                ...
                using (Utf8JsonWriter writer = new(buffer))
                {
                    ...
                    // Top-level flag so cross-client analysers can normalise SAVM/state counters,
                    ...
                    writer.WriteNumber("savm_ms", Math.Round(savmMs, 3));
                    ...
                    writer.WriteNumber("sip7702_delegations_set", data.DeltaSip7702DelegationsSet);
                    writer.WriteNumber("sip7702_delegations_cleared", data.DeltaSip7702DelegationsCleared);
                    writer.WriteEndObject();
        ...
        private class BlockDataPolicy() : IPooledObjectPolicy<BlockData>
        {
            ...
            public bool Return(BlockData data)
            {
                ...
                data.DeltaSip7702DelegationsSet = 0;
                data.DeltaSip7702DelegationsCleared = 0;
        ...
        protected class BlockData
        {
            ...
            public long DeltaSip7702DelegationsSet;
            public long DeltaSip7702DelegationsCleared;
