...
namespace Nethermind.Consensus.Comparers
{
    ...
    {
        public static int Compare(Transaction? x, Transaction? y, in UInt256 baseFee, bool isSip1559Enabled)
        {
            ...
            // SIP1559 changed the way we're sorting transactions. The transaction with a higher miner tip should go first
            if (isSip1559Enabled)
            {
