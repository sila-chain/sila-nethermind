...
namespace Nethermind.Consensus.Validators
{
        ...
        : IHeaderValidator
    {
        ...
        // Sila protocol hard-caps block gas limit at 2^63-1 to prevent overflow and ensure
        ...
        protected virtual bool ValidateGasLimitRange(BlockHeader header, BlockHeader parent, IReleaseSpec spec, ref string? error)
        {
            ...
            ulong adjustedParentGasLimit = Sip1559GasLimitAdjuster.AdjustGasLimit(spec, parent.GasLimit, header.Number);
