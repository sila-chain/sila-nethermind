    ...
    public void ProcessWithdrawals(Block block, IReleaseSpec spec)
    {
        ...
        if (block.Withdrawals is not null)
        {
            ...
            for (int i = 0; i < blockWithdrawals.Length; i++)
            {
                ...
                // Consensus clients are using Gwei for withdrawals amount. We need to convert it to Wei before applying state changes https://github.com/sila-chain/execution-apis/pull/354
