...
{
    /// <summary>
    /// Precomputed lookup table for valid SAVM opcodes. Avoids Enum.IsDefined overhead in tight loops.
    /// </summary>
    ...
    private void AnalyzeTransactionOpcodes(Transaction transaction)
    {
        ...
        // We'll scan the bytecode looking for valid SAVM opcodes
        ...
        for (int i = 0; i < data.Length; i++)
        {
            ...
            // Check if this byte is a valid SAVM opcode using precomputed lookup table
