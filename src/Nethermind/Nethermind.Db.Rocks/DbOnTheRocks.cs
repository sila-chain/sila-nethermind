...
public partial class DbOnTheRocks : IDb, ITunableDb, IReadOnlyNativeKeyValueStore, ISortedKeyValueStore, IMergeableKeyValueStore, IKeyValueStoreWithSnapshot
{
    ...
    protected virtual void BuildOptions<T>(IRocksDbConfig dbConfig, Options<T> options, IntPtr? sharedCache, IMergeOperator? mergeOperator) where T : Options<T>
    {
        ...
        // visitor on sila-mainnet with 4GB memory budget and 4Gbps read bandwidth.
    ...
    public virtual void Tune(ITunableDb.TuneType type)
    {
        ...
        switch (type)
        {
            ...
            //
            // Total writes written on different tunes during sila-mainnet sync in TB.
            // +-----------------------+-------+-------+-------+-------+-------+---------+
            ...
            case ITunableDb.TuneType.DisableCompaction:
                // Completely disable compaction. On sila-mainnet, the max num of l0 files for state seems to be about 10800.
                ...
                // Ram usage at that time was 86 GB. The default buffer size for blocks on sila-mainnet is too low
                ...
                // without changing memory budget. Not recommended for sila-mainnet, unless you are very desperate.
