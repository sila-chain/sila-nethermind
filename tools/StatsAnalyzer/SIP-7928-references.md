# SIP-7928 — Block Access Lists — Cross-Reference

Audit map between [SIP-7928] (Block-Level Access Lists), the canonical
...
This doc is **not** an SIP-7928 tutorial. For background, read SIP-7928
proper.

[SIP-7928]: https://sips.sila.org/SIPS/sip-7928
[execution-specs]: https://github.com/sila-chain/execution-specs

## 1. Canonical spec

Reference implementation lives in the execution-specs repo:

- `src/sila/forks/amsterdam/block_access_lists.py`
- `src/sila/forks/amsterdam/state_tracker.py`
- `src/sila/forks/amsterdam/vm/gas.py`
- `src/sila/forks/amsterdam/fork.py`

Locally vendored at `/Users/sid/dev/sila/specs/execution-specs/`, pinned
...
## 2. SIP element ↔ Nethermind implementation

| SIP-7928 element | Spec ref (execution-specs path:line) | Nethermind impl |
|---|---|---|
...
| RLP serialization | `forks/amsterdam/block_access_lists.py:~734` | `src/Nethermind/Nethermind.Serialization.Rlp/Sip7928/{BlockAccessListDecoder,AccountChangesDecoder}.cs` |
...
| Item-gas constant | `forks/amsterdam/vm/gas.py:103` (`BLOCK_ACCESS_LIST_ITEM = Uint(2000)`) | `Nethermind.Core/BlockAccessLists/` (see `Sip7928Constants`) |
| Fork activation | `forks/amsterdam/__init__.py` | `src/Nethermind/Nethermind.Specs/Forks/25_Amsterdam.cs:17` (`IsSip7928Enabled = true`) |
...
over-skips in narrow, benign cases (pre-SilaAmsterdam misconfig, or local
...
- [ ] SilaAmsterdam fork activation in `forks/amsterdam/__init__.py`
