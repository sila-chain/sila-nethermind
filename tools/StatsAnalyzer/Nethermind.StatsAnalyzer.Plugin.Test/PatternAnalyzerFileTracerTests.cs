...
public class PatternAnalyzerFileTracerTests : VirtualMachineTestsBase
{
    ...
    private static IEnumerable<TestCaseData> GetIgnoreSetCases()
    {
        yield return new TestCaseData(
            new[]
            {
                Prepare.SavmCode.JUMPDEST().PushData(6).JUMP().JUMPDEST().JUMPDEST().JUMPDEST().JUMPDEST().JUMPDEST()
        ...
        yield return new TestCaseData(
            new[]
            {
                Prepare.SavmCode.JUMPDEST().PushData(6).JUMP().PushData(6).JUMPDEST().PushData(0).PushData(0).STOP()
                    .Done
            },
            """{"initialBlockNumber":15537396,"currentBlockNumber":15537396,"errorPerItem":0.006,"confidence":0.9375,"stats":[{"pattern":"PUSH1 PUSH1","bytes":[96,96],"count":2},{"pattern":"PUSH1 PUSH1 PUSH1","bytes":[96,96,96],"count":1}]}"""
        );
        yield return new TestCaseData(
            new[]
            {
                Prepare.SavmCode.JUMPDEST().PushData(0).JUMPDEST().PushData(6).JUMPDEST().PushData(0).Done
            },
            """{"initialBlockNumber":15537396,"currentBlockNumber":15537396,"errorPerItem":0.006,"confidence":0.9375,"stats":[{"pattern":"PUSH1 PUSH1","bytes":[96,96],"count":2},{"pattern":"PUSH1 PUSH1 PUSH1","bytes":[96,96,96],"count":1}]}"""
        );
        yield return new TestCaseData(
            new[]
            {
                Prepare.SavmCode.PushData(0).PushData(6).JUMPDEST().PushData(0).Done
            },
            """{"initialBlockNumber":15537396,"currentBlockNumber":15537396,"errorPerItem":0.006,"confidence":0.9375,"stats":[{"pattern":"PUSH1 PUSH1","bytes":[96,96],"count":2},{"pattern":"PUSH1 PUSH1 PUSH1","bytes":[96,96,96],"count":1}]}"""
        );
    }
    ...
    private static IEnumerable<TestCaseData> GetTraceCases()
    {
        yield return new TestCaseData(
            new[]
            {
                Prepare.SavmCode.PushData(10).Done
            },
        ...
        yield return new TestCaseData(
            new[]
            {
                Prepare.SavmCode.PUSHx([1, 2, 3, 4, 5]).Done
            },
            """{"initialBlockNumber":15537396,"currentBlockNumber":15537396,"errorPerItem":0,"confidence":0.9375,"stats":[]}"""
        );
        yield return new TestCaseData(
            new[]
            {
                Prepare.SavmCode.PushData(10).PushData(12).Done
            },
        ...
        yield return new TestCaseData(
            new[]
            {
                Prepare.SavmCode.PUSHx([1, 2, 3, 4, 5]).PUSHx([3, 4]).Done
            },
        ...
        yield return new TestCaseData(
            new[]
            {
                Prepare.SavmCode.PushData(0).PushData(0).PushData(0).Done
            },
            """{"initialBlockNumber":15537396,"currentBlockNumber":15537396,"errorPerItem":0.006,"confidence":0.9375,"stats":[{"pattern":"PUSH1 PUSH1","bytes":[96,96],"count":2},{"pattern":"PUSH1 PUSH1 PUSH1","bytes":[96,96,96],"count":1}]}"""
        );
        yield return new TestCaseData(
            ...
            {
                Prepare.SavmCode.PushData(0).PushData(0).PushData(0).Done,
                Prepare.SavmCode.PushData(0).Done
            },
            """{"initialBlockNumber":15537396,"currentBlockNumber":15537396,"errorPerItem":0.006,"confidence":0.9375,"stats":[{"pattern":"PUSH1 PUSH1","bytes":[96,96],"count":2},{"pattern":"PUSH1 PUSH1 PUSH1","bytes":[96,96,96],"count":1}]}"""
        );
        yield return new TestCaseData(
        ...
        yield return new TestCaseData(
            new[]
            {
                Prepare.SavmCode.PushData(0).PushData(0).PushData(0).PushData(0).PushData(0).PushData(0).Done
            },
