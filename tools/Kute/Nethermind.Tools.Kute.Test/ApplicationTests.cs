...
using Nethermind.Tools.Kute.JsonRpcValidator.Sil;
...
public class ApplicationTests
{
    ...
    {"method": "engine_newPayloadV3"}
    {"method": "engine_exchangeCapabilities"}
    [{"method": "sil_getBlockByNumber"}, {"method": "sil_getLogs"}, {"method": "sil_syncing"}, {"method": "engine_forkchoiceUpdatedV2"}, {"method": "engine_exchangeTransitionConfigurationV1"}, {"method": "sil_chainId"}, {"method": "engine_newPayloadV3"}, {"method": "engine_exchangeCapabilities"}]
    [{"method": "sil_getBlockByNumber"}, {"method": "sil_getLogs"}, {"method": "sil_syncing"}, {"method": "engine_forkchoiceUpdatedV2"}, {"method": "engine_exchangeTransitionConfigurationV1"}, {"method": "sil_chainId"}, {"method": "engine_newPayloadV3"}, {"method": "engine_exchangeCapabilities"}]
    [{"method": "sil_getBlockByNumber"}, {"method": "sil_getLogs"}, {"method": "sil_syncing"}, {"method": "engine_forkchoiceUpdatedV2"}, {"method": "engine_exchangeTransitionConfigurationV1"}, {"method": "sil_chainId"}, {"method": "engine_newPayloadV3"}, {"method": "engine_exchangeCapabilities"}]
    [{"method": "sil_getBlockByNumber"}, {"method": "sil_getLogs"}, {"method": "sil_syncing"}, {"method": "engine_forkchoiceUpdatedV2"}, {"method": "engine_exchangeTransitionConfigurationV1"}, {"method": "sil_chainId"}, {"method": "engine_newPayloadV3"}, {"method": "engine_exchangeCapabilities"}]
    """;
    ...
    public async Task WithFiltering_InvalidResponses(IAsyncProcessor processor)
    {
        ...
        {"method": "engine_exchangeTransitionConfigurationV1"}
        {"method": "sil_chainId"}
        [{"method": "sil_getBlockByNumber"}, {"method": "engine_exchangeCapabilities"}]
        """;
        ...
        IResponseTracer responseTracer = Substitute.For<IResponseTracer>();
        IMetricsReporter reporter = Substitute.For<IMetricsReporter>();
        ComposedJsonRpcMethodFilter filter = new([new PatternJsonRpcMethodFilter("sil_.*")]);
