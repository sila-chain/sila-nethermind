...
public class JsonRpcValidatorTests
{
    ...
    public void IsInvalid_When_ResponseHasError()
    {
        ...
        bool result = _validator.IsValid(CreateSingleRequest("sil_getBlockByNumber"), response);
    ...
    public void IsInvalid_When_BatchHasMissingResponses()
    {
        ...
        bool result = _validator.IsValid(
            CreateBatchRequest(CreateSingleRequest("engine_newPayload", 1), CreateSingleRequest("sil_logs", 2)), response);
