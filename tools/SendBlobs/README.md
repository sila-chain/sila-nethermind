...
The default fork for now is SilaOsaka, which means blobs will be sent with V1 proofs. Use `--fork SilaPrague` option to change it to V0. The default behavior may change post SilaOsaka.
