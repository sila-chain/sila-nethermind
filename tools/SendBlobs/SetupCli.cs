...
internal static class SetupCli
{
    public static void SetupExecute(RootCommand command)
    {
        ...
        Option<string> forkOption = new("--fork") { Description = "Specify fork for MaxBlobCount, TargetBlobCount, SilaOsaka by default" };
        ...
        command.SetAction((parseResult, cancellationToken) =>
        {
            return ExecuteWithRpcHandling(() =>
            {
                ...
                IReleaseSpec spec = fork is null ? SilaOsaka.Instance : SpecNameParser.Parse(fork);
    ...
    public static void SetupSendFileCommand(Command root)
    {
        ...
        Option<bool> waitOption = new("--wait") { Description = "Wait for tx inclusion" };
        Option<string> forkOption = new("--fork") { Description = "Specify fork for max blob count, target blob count, proof type. SilaOsaka by default" };
